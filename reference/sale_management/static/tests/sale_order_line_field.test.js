...
test("drag and drop regular line inside optional section resets some fields", async () => {
    ...
    onRpc("web_save", ({args}) => {
        ...
        expect(
            args[1].order_line.find((commands) => commands[1] === 13)[2].product_uom_qty
        ).toEqual(
            // Sec4-r1
            0,
            {
        ...
        expect(
            args[1].order_line.find((commands) => commands[1] === 11)[2].product_uom_qty
        ).toEqual(
            // Sec3-sub2-r1
            1,
            {
        ...
        expect(
            args[1].order_line.find((commands) => commands[1] === 9)?.[2]
                .product_uom_qty
        ).toEqual(
            // Sec3-sub1-r1
            undefined,
...
test("Moving Optional Sections to include some lines should set quantity to 0", async () => {
    ...
    onRpc("web_save", ({args}) => {
        ...
        expect(
            args[1].order_line.find((commands) => commands[1] === 7)[2].product_uom_qty
        ).toEqual(
            // Sec3-r2
            0,
            {
        ...
        expect(
            args[1].order_line.find((commands) => commands[1] === 9)[2].product_uom_qty
        ).toEqual(
            // Sec3-sub1-r1
            0,
            {
        ...
        expect(
            args[1].order_line.find((commands) => commands[1] === 13)?.[2]
                .product_uom_qty
        ).toEqual(
            // Sec4-r1
            undefined,
...
test("Moving Optional Sections to exclude some lines should set quantity to 1", async () => {
    ...
    onRpc("web_save", ({args}) => {
        ...
        expect(
            args[1].order_line.find((command) => command[1] === 6)[2].product_uom_qty
        ).toEqual(
            // Sec3-r1
            1,
            {
        ...
        expect(
            args[1].order_line.find((command) => command[1] === 7)?.[2].product_uom_qty
        ).toEqual(
            // Sec3-r2
            undefined,
            {
        ...
        expect(
            args[1].order_line.find((command) => command[1] === 9)[2].product_uom_qty
        ).toEqual(
            // Sec3-sub1-r1
            1,
            {
        ...
        expect(
            args[1].order_line.find((command) => command[1] === 11)?.[2].product_uom_qty
        ).toEqual(
            // Sec3-sub2-r1
            undefined,
            {
