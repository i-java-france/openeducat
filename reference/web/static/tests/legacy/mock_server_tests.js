...
QUnit.module("MockServer", (hooks) => {
    ...
    QUnit.test(
        "performRPC: search_read with active_test=false",
    ...
    QUnit.test(
        "performRPC: search_read with active_test=true",
        async function (assert) {
            const server = new MockServer(data, {});
            const result = await server.performRPC("", {
                model: "partner",
    ...
    QUnit.test(
        "performRPC: search_count with domain matching no record",
        async function (assert) {
            const server = new MockServer(data, {});
            const result = await server.performRPC("", {
                model: "partner",
    ...
    QUnit.test(
        "performRPC: search_count with archived records",
        async function (assert) {
            const server = new MockServer(data, {});
            const result = await server.performRPC("", {
                model: "partner",
    ...
    QUnit.test(
        "performRPC: formatted_read_group, group by char",
        async function (assert) {
            const server = new MockServer(data, {});
            const result = await server.performRPC("", {
                model: "bar",
    ...
    QUnit.test(
        "performRPC: formatted_read_group, group by boolean",
        async function (assert) {
            const server = new MockServer(data, {});
            const result = await server.performRPC("", {
                model: "bar",
    ...
    QUnit.test(
        "performRPC: formatted_read_group, group by date",
        async function (assert) {
            const server = new MockServer(data, {});
    ...
    QUnit.test(
        "performRPC: formatted_read_group datetime:day_of_week",
        async function (assert) {
    ...
    QUnit.test(
        "performRPC: formatted_read_group date:day_of_week",
        async function (assert) {
            data.models.bar.records = [
    ...
    QUnit.test(
        "performRPC: formatted_read_group, group by datetime",
        async function (assert) {
            const server = new MockServer(data, {});
            let result = await server.performRPC("", {
                model: "bar",
    ...
    QUnit.test(
        "performRPC: formatted_read_group, group by m2m",
        async function (assert) {
            const server = new MockServer(data, {});
            const result = await server.performRPC("", {
                model: "bar",
    ...
    QUnit.test(
        "performRPC: formatted_read_group, group by m2o",
        async function (assert) {
    ...
    QUnit.test(
        "performRPC: formatted_read_group, group by integer",
        async function (assert) {
            const server = new MockServer(data, {});
            const result = await server.performRPC("", {
                model: "bar",
    ...
    QUnit.test(
        "performRPC: formatted_read_group, group by selection",
        async function (assert) {
            const server = new MockServer(data, {});
            const result = await server.performRPC("", {
                model: "bar",
    ...
    QUnit.test(
        "performRPC: formatted_read_group, group by two levels",
        async function (assert) {
            const server = new MockServer(data, {});
            const result = await server.performRPC("", {
                model: "bar",
    ...
    QUnit.test(
        "performRPC: formatted_read_group with array_agg",
        async function (assert) {
            const server = new MockServer(data, {});
    ...
    QUnit.test(
        "performRPC: formatted_read_group with array_agg on id",
        async function (assert) {
            const server = new MockServer(data, {});
            const result2 = await server.performRPC("", {
                model: "bar",
    ...
    QUnit.test(
        "performRPC: formatted_read_group with count_distinct",
        async function (assert) {
            const server = new MockServer(data, {});
            const result2 = await server.performRPC("", {
                model: "bar",
    ...
    QUnit.test(
        "many2one_ref update should update inverse field",
        async function (assert) {
            data.models.bar.records = [{id: 1}];
            data.models.foo.records = [
                {
    ...
    QUnit.test("webRead sub-fields of a many2one field", async function (assert) {
        ...
        data.models.partner.records = [
            {id: 1, test_name: "Jean-Michel", test_number: 5},
        ];
