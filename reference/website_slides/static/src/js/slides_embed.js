...
$(function () {
    ...
    if ($("#PDFViewer") && $("#PDFViewerCanvas")) {
        ...
        var EmbeddedViewer = function ($viewer) {
            ...
            this.defaultpage = parseInt(
                $viewer.find("#PDFSlideViewer").data("defaultpage")
            );
            ...
            this.hasSuggestions = Boolean(this.$(".oe_slides_suggestion_media").length);
        ...
        EmbeddedViewer.prototype.__proto__ = {
            ...
            navUpdate: function (pageNum) {
                ...
                this.$("#zoomout").toggleClass(
                    "disabled",
                    this.pdf_viewer.pdf_zoom <= MIN_ZOOM
                );
                this.$("#zoomin").toggleClass(
                    "disabled",
