...
registry.category("web_tour.tours").add("test_website_page_manager", {
    ...
    steps: () => [
        // Part 1: check that the website filter is working
        {
            ...
            trigger:
                ".o_list_table .o_data_row .o_data_cell[name=name]:contains('Test Multi Model Website 1') " +
        ...
        {
            content:
                "Click on the 'Select all records' checkbox again to unselect all records and see the search bar",
            trigger: "thead .o_list_record_selector",
            run: "click",
        },
        {
        ...
        },
        {
            ...
            trigger:
                ".o_list_table .o_data_row .o_data_cell[name=name]:contains('Test Model Multi Website 2') " +
