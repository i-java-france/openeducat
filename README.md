...
This guide explains how to build and run your Odoo 19 instance using the provided Docker files.
...
4. **Add Custom Addons**:
   Place your custom Odoo modules in `/home/abdelhadi-eddiraa/Desktop/Openeducat/edu-system/my-generated-modules`. They are mounted to `/mnt/extra-addons` inside the container.
