...
class OpArea(models.Model):
    ...
    _inherit = ['op.area', 'mail.thread', 'rating.mixin', 'website.published.mixin']
    _description = 'OpenEduCat Area'
    ...
    # Record Rules:
    #   Area multi-company: ['|',('company_id','=',False),'&',('company_id','in',company_ids),'|',('company_id','child_of',[user.company_id.id]),('company_id','in',user.company_ids.ids)]
