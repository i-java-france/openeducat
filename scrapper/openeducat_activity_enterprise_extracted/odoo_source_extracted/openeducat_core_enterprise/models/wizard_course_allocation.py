...
class WizardCourseAllocation(models.TransientModel):
    """Create course allocation for selected Student(s)
    ...
    _name = 'wizard.course.allocation'
    _description = 'Create course allocation for selected Student(s)'
