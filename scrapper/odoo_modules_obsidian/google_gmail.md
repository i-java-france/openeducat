...
> **Module:** `google_gmail` | **Version:** `19.0.1.2` **Category:** Technical |
...
- `* INHERIT fetchmail.server.view.form.inherit.gmail (form)`
- `* INHERIT ir.mail_server.view.form.inherit.gmail (form)`
- `* INHERIT res.config.settings.view.form.inherit.google_gmail (form)`
- `google_gmail_oauth_error (qweb)`
...
### 🗃️ `google.gmail.mixin` — Google Gmail Mixin
