...
> **Module:** `website_sale_mass_mailing` | **Version:** `19.0.1.0` **Category:**
...
Allows anonymous shoppers of your eCommerce to sign up for a newsletter during the
checkout process.
...
- `* INHERIT Newsletter (qweb)`
- `* INHERIT res.config.settings.view.form.inherit.website.sale.mass.mailing (form)`
