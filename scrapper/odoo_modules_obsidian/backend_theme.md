...
> **Module:** `backend_theme` | **Version:** `19.0.0.1` **Category:** Tools |
...
- `* INHERIT Chatter Position (qweb)`
- `* INHERIT Custom Layout (qweb)`
- `* INHERIT res.config.settings.form (form)`
- `* INHERIT webclient_bootstrap_community (qweb)`
- `backend_theme.menu_launcher (qweb)`
- `backend_theme.menu_link (qweb)`
- `backend_theme.menu_secondary (qweb)`
- `backend_theme.menu_secondary_submenu (qweb)`
...
### 🗃️ `res.user.bookmark` — User Bookmark
...
| Name                     | Group       | Perms     |
| ------------------------ | ----------- | --------- |
| access_res_user_bookmark | Role / User | `R/W/C/D` |
