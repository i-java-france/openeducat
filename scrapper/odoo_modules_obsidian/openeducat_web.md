---
title: "OpenEduCat Web"
module: "openeducat_web"
state: "installed"
version: "19.0.1.0"
...
> **Module:** `openeducat_web` | **Version:** `19.0.1.0` **Category:** Education |
...
- `* INHERIT Portal Layout Inherit (qweb)`
- `* INHERIT portal_docs_entry_inherit_openeducat (qweb)`
- `* INHERIT res.company.instance.view.form.inherit (form)`
- `* INHERIT res.config.settings.view.form.inherit.instance (form)`
- `Register Database (qweb)`
