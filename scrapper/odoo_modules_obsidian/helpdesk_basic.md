...
> **Module:** `helpdesk_basic` | **Version:** `19.0.1.0` **Category:** Human Resources |
> **License:** `Other proprietary` **Author:** OpenEduCat Inc **Website:**
> https://www.openeducat.org

## 🔗 Dependencies

[[base_setup]] [[mail]] [[utm]] [[rating]] [[web_tour]] [[resource]] [[portal]]
[[digest]] [[portal_rating]]
...
- `Helpdesk/Configuration/Issue Type`
...
- `Helpdesk/Reporting/Helpdesk Report`
- `Helpdesk/Tickets`
- `Helpdesk/Tickets/All Tickets`
- `Helpdesk/Tickets/My Tickets`

### Views

- `* INHERIT Feedback and Rating (qweb)`
- `* INHERIT Helpdesk.res.partner.form (form)`
- `* INHERIT res.config.settings.view.inherit.helpdesk (form)`
- `Helpdesk Form (form)`
- `Helpdesk List View (list)`
- `Helpdesk Search (search)`
- `Helpdesk Stages Form (form)`
- `Helpdesk Stages List View (list)`
- `Helpdesk Tags Form (form)`
- `Helpdesk Tags List View (list)`
- `Helpdesk Team Form (form)`
- `Helpdesk Team Search (search)`
- `Issue Type Form (form)`
- `Issue Type List (list)`
- `Issue Type Search (search)`
- `Rating Page Done (qweb)`
- `Rating Page Submit (qweb)`
- `helpdesk.dashboard.kanban.view (kanban)`
- `helpdesk.pivot (pivot)`
- `helpdesk.pivot (pivot)`
- `helpdesk.report.graph (graph)`
- `helpdesk.report.list (list)`
- `helpdesk.team.kanban.view (kanban)`
- `helpdesk.team.list (list)`
- `helpdesk.ticket.kanban (kanban)`
- `issue.type.dashboard.kanban.view (kanban)`
- `ticket.create.form (form)`
...
| `assignment_method`              | Assignment Method                   | `selection` |     | ✅    |                   |
| `color`                          | Color Index                         | `integer`   |     | ✅    |                   |
| `company_id`                     | Company                             | `many2one`  | ✅  | ✅    | res.company       |
| `create_date`                    | Created on                          | `datetime`  |     | ✅    |                   |
| `create_uid`                     | Created by                          | `many2one`  |     | ✅    | res.users         |
| `description`                    | About Team                          | `text`      |     | ✅    |                   |
| `display_name`                   | Display Name                        | `char`      |     |       |                   |
| `has_message`                    | Has Message                         | `boolean`   |     |       |                   |
| `helpdesk_count`                 | Total Helpdesk                      | `integer`   |     |       |                   |
| `id`                             | ID                                  | `integer`   |     | ✅    |                   |
| `is_rating`                      | Ratings On Tickets                  | `boolean`   |     | ✅    |                   |
| `issue_type_ids`                 | Issue Type                          | `many2many` |     | ✅    | issue.type        |
| `kanban_dashboard_graph`         | Kanban Dashboard Graph              | `text`      |     |       |                   |
| `mail_close_tmpl_id`             | Confirm Mail Template               | `many2one`  |     | ✅    | mail.template     |
| `mail_template_id`               | Create Mail Template                | `many2one`  | ✅  | ✅    | mail.template     |
| `member_ids`                     | Members                             | `many2many` |     | ✅    | res.users         |
| `message_attachment_count`       | Attachment Count                    | `integer`   |     |       |                   |
| `message_follower_ids`           | Followers                           | `one2many`  |     | ✅    | mail.followers    |
| `message_has_error`              | Message Delivery error              | `boolean`   |     |       |                   |
| `message_has_error_counter`      | Number of errors                    | `integer`   |     |       |                   |
...
| `solved_helpdesk_count`          | Open Helpdesk                       | `integer`   |     |       |                   |
| `stage_ids`                      | Stages                              | `many2many` |     | ✅    | helpdesk.stage    |
| `unassigned_issues`              | Unassigned Issues                   | `integer`   |     |       |                   |
| `visibility_member_ids`          | Team Visibility                     | `many2many` |     | ✅    | res.users         |
| `website_message_ids`            | Website Messages                    | `one2many`  |     | ✅    | mail.message      |
| `write_date`                     | Last Updated on                     | `datetime`  |     | ✅    |                   |
| `write_uid`                      | Last Updated by                     | `many2one`  |     | ✅    | res.users         |
...
| Name                         | Group              | Perms     |
| ---------------------------- | ------------------ | --------- |
| access_helpdesk_team_manager | Category / Manager | `R/W/C/D` |
| access_helpdesk_team_portal  | Role / Portal      | `R`       |
| access_helpdesk_team_user    | User               | `R`       |

**Record Rules:**

- **See All Team** (48) `R/W/C/D`
  - Domain: `[(1, '=', 1)]`

### 🗃️ `helpdesk.ticket` — Helpdesk Ticket
...
| `activity_type_id`               | Next Activity Type            | `many2one`  |     |       | mail.activity.type |
| `activity_user_id`               | Responsible User              | `many2one`  |     |       | res.users          |
| `assigned_date`                  | Date Of Assignment            | `datetime`  |     | ✅    |                    |
| `assigned_hours`                 | Assignment hours              | `integer`   |     | ✅    |                    |
| `attachment_ids`                 | Main Attachments              | `one2many`  |     |       | ir.attachment      |
| `attachments_count`              | Add Attachments               | `integer`   |     |       |                    |
...
| `end_date`                       | Ticket Close Date             | `datetime`  |     | ✅    |                    |
| `feedback`                       | Comment                       | `text`      |     | ✅    |                    |
| `has_message`                    | Has Message                   | `boolean`   |     |       |                    |
| `help_description`               | Help Description              | `text`      |     | ✅    |                    |
| `id`                             | ID                            | `integer`   |     | ✅    |                    |
| `in_progress_mail`               | In Progress Mail              | `boolean`   |     | ✅    |                    |
| `is_accessible`                  | Is Accessible                 | `boolean`   |     |       |                    |
| `is_assigned`                    | Is Asigned                    | `boolean`   |     |       |                    |
| `is_rating`                      | Is Rating                     | `boolean`   |     | ✅    |                    |
| `is_rotting`                     | Rotting                       | `boolean`   |     |       |                    |
| `issue_name`                     | Subject                       | `char`      | ✅  | ✅    |                    |
| `issue_type_id`                  | Issue Type                    | `many2one`  |     | ✅    | issue.type         |
| `last_updated_date`              | Last Updated Date             | `date`      |     | ✅    |                    |
...
| `message_partner_ids`            | Followers (Partners)          | `many2many` |     |       | res.partner        |
| `my_activity_date_deadline`      | My Activity Deadline          | `date`      |     |       |                    |
| `partner_email`                  | Customer Email                | `char`      |     |       |                    |
| `partner_id`                     | Customer                      | `many2one`  |     | ✅    | res.partner        |
| `partner_name`                   | Customer Name                 | `char`      |     | ✅    |                    |
...
| `stage_id`                       | Stage                         | `many2one`  |     | ✅    | helpdesk.stage     |
| `stage_ids`                      | Stages                        | `many2many` |     |       | helpdesk.stage     |
| `start_date`                     | Ticket Created Date           | `datetime`  |     | ✅    |                    |
| `tag_ids`                        | Tags                          | `many2many` |     | ✅    | helpdesk.tag       |
| `team_id`                        | Helpdesk Team                 | `many2one`  |     | ✅    | helpdesk.team      |
| `ticket_seq`                     | Ticket No                     | `char`      |     | ✅    |                    |
| `time_close`                     | Time to close                 | `integer`   |     | ✅    |                    |
| `uid`                            | Uid                           | `many2one`  |     | ✅    | res.users          |
...
| Name                    | Group              | Perms     |
| ----------------------- | ------------------ | --------- |
| access_helpdesk_manager | Category / Manager | `R/W/C/D` |
| access_helpdesk_portal  | Role / Portal      | `R`       |
| access_helpdesk_user    | User               | `R/W/C`   |

**Record Rules:**

- **Portal See Own Issues** (10) `R/W/C/D`
  - Domain:
    `         ['|', ('user_id','=',user.id), ('partner_id', '=', user.partner_id.id)]     `
- **See Own Issues** (47) `R/W/C/D`
  - Domain:
    `         ['|', ('user_id','=',user.id), ('partner_id', '=',         user.partner_id.id)]     `
- **Create Own Issues** (47) `R/W/C/D`
  - Domain: `         [('user_id','=',user.id)]     `
- **See All Issues** (48) `R/W/C/D`
  - Domain: `[(1, '=', 1)]`
...
### 🗃️ `helpdesk.report` — Helpdesk Report
...
| Field               | Label           | Type        | Req | Store | Relation       |
| ------------------- | --------------- | ----------- | --- | ----- | -------------- |
| `assigned_hours`    | Assigned Time   | `integer`   |     | ✅    |                |
| `create_date`       | Created On      | `datetime`  |     | ✅    |                |
| `description`       | Description     | `text`      |     | ✅    |                |
| `display_name`      | Display Name    | `char`      |     |       |                |
| `end_date`          | End Date        | `datetime`  |     | ✅    |                |
| `id`                | ID              | `integer`   |     | ✅    |                |
| `is_solved`         | Solved          | `integer`   |     | ✅    |                |
| `issue_type_id`     | Issue Type      | `many2one`  |     | ✅    | issue.type     |
| `partner_id`        | Related Partner | `many2one`  |     | ✅    | res.partner    |
| `priority`          | Priority        | `selection` |     | ✅    |                |
| `rating_last_value` | Rating          | `float`     |     | ✅    |                |
| `stage_id`          | Stage           | `many2one`  |     | ✅    | helpdesk.stage |
| `start_date`        | Start Date      | `datetime`  |     | ✅    |                |
| `team_id`           | Team            | `many2one`  |     | ✅    | helpdesk.team  |
| `ticket_seq`        | Sequence        | `char`      |     | ✅    |                |
| `time_close`        | Time to close   | `integer`   |     | ✅    |                |
| `user_id`           | Created By      | `many2one`  |     | ✅    | res.users      |

**Access Rights:**

| Name                   | Group              | Perms |
| ---------------------- | ------------------ | ----- |
| access_helpdesk_report | Category / Manager | `R`   |

### 🗃️ `helpdesk.stage` — Helpdesk Stage
...
| `id`             | ID                 | `integer`   |     | ✅    |               |
| `is_close`       | Closing Stage      | `boolean`   |     | ✅    |               |
...
| `sequence`       | Sequence           | `integer`   |     | ✅    |               |
| `stage_type`     | Stage Type         | `selection` | ✅  | ✅    |               |
| `team_ids`       | Team               | `many2many` |     | ✅    | helpdesk.team |
...
| Name                  | Group              | Perms     |
| --------------------- | ------------------ | --------- |
| access_helpdesk_stage | Category / Manager | `R/W/C/D` |
| access_helpdesk_stage | User               | `R/W/C`   |

### 🗃️ `helpdesk.tag` — Helpdesk Tags
...
| Name               | Group              | Perms     |
| ------------------ | ------------------ | --------- |
| access_tag_manager | Category / Manager | `R/W/C/D` |
| access_tag_portal  | Role / Portal      | `R`       |
| access_tag_user    | User               | `R`       |

### 🗃️ `issue.type` — Issue Type
...
| `kanban_dashboard_graph` | Kanban Dashboard Graph | `text`     |     |       |           |
| `name`                   | Name                   | `char`     | ✅  | ✅    |           |
| `reporting_template`     | Reporting Template     | `text`     |     | ✅    |           |
| `stages`                 | Stages                 | `char`     |     |       |           |
| `write_date`             | Last Updated on        | `datetime` |     | ✅    |           |
| `write_uid`              | Last Updated by        | `many2one` |     | ✅    | res.users |
...
| Name                      | Group              | Perms     |
| ------------------------- | ------------------ | --------- |
| access_issue_type_manager | Category / Manager | `R/W/C/D` |
| access_issue_type_portal  | Role / Portal      | `R`       |
| access_issue_type_user    | User               | `R`       |
| access_issue_type_any     | Everyone           | `R`       |
