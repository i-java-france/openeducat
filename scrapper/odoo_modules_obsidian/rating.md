...
> **Module:** `rating` | **Version:** `19.0.1.1` **Category:** Productivity |
...
- `Settings/Technical/Discuss/Ratings`

### Views

- `* INHERIT mail.message.view.form.inherit.rating (form)`
- `* INHERIT rating.rating.view.form.text (form)`
- `Not allows to rating (qweb)`
...
- `rating.rating.list (list)`
- `rating.rating.pivot (pivot)`
- `rating.rating.search (search)`
- `rating.rating.view.kanban.stars (kanban)`
...
### 🗃️ `rating.parent.mixin` — Rating Parent Mixin
