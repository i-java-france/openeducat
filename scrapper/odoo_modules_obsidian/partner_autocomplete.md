...
> **Module:** `partner_autocomplete` | **Version:** `19.0.1.1` **Category:** Tools |
...
- `* INHERIT res.company.form.inherit.web.partner.autocomplete (form)`
...
### 🗃️ `iap.autocomplete.api` — IAP Partner Autocomplete API
