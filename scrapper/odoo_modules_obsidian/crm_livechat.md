...
> **Module:** `crm_livechat` | **Version:** `19.0.1.0` **Category:** CRM | **License:**
...
- `* INHERIT chatbot.script.step.view.form.inherit.crm.livechat (form)`
- `* INHERIT chatbot.script.view.form.inherit.crm.livechat (form)`
- `* INHERIT crm.lead.view.form.inherit.crm.livechat (form)`
- `* INHERIT discuss.channel.view.form.inherit.crm.livechat (form)`
