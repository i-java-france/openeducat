---
title: "Online Tools Integration"
module: "online_tools_intg"
state: "installed"
version: "19.0.1.0"
...
> **Module:** `online_tools_intg` | **Version:** `19.0.1.0` **Category:** Education |
...
- `* INHERIT portal_home_inherit_online_tools (qweb)`
- `* INHERIT res.config.settings.view.form.online.meeting (form)`
- `Online Meetings (qweb)`
- `openeducat_online_meeting_portal_data (qweb)`
