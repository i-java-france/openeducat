...
> **Module:** `privacy_lookup` | **Version:** `19.0.1.0` **Category:** Technical |
...
- `Settings/Technical/Privacy`
- `Settings/Technical/Privacy/Privacy Logs`

### Views

- `privacy.log.view.form (form)`
- `privacy.log.view.list (list)`
- `privacy.lookup.wizard.line.view.list (list)`
- `privacy.lookup.wizard.line.view.search (search)`
- `privacy.lookup.wizard.view.form (form)`
...
| `anonymized_email`    | Anonymized Email  | `char`     | ✅  | ✅    |           |
| `anonymized_name`     | Anonymized Name   | `char`     | ✅  | ✅    |           |
| `create_date`         | Created on        | `datetime` |     | ✅    |           |
| `create_uid`          | Created by        | `many2one` |     | ✅    | res.users |
| `date`                | Date              | `datetime` | ✅  | ✅    |           |
| `display_name`        | Display Name      | `char`     |     |       |           |
| `execution_details`   | Execution Details | `text`     |     | ✅    |           |
| `id`                  | ID                | `integer`  |     | ✅    |           |
| `records_description` | Found Records     | `text`     |     | ✅    |           |
| `user_id`             | Handled By        | `many2one` | ✅  | ✅    | res.users |
| `write_date`          | Last Updated on   | `datetime` |     | ✅    |           |
| `write_uid`           | Last Updated by   | `many2one` |     | ✅    | res.users |
...
| Name               | Group                | Perms     |
| ------------------ | -------------------- | --------- |
| access_privacy_log | Role / Administrator | `R/W/C/D` |

### 🗃️ `privacy.lookup.wizard` — Privacy Lookup Wizard
...
| `execution_details`   | Execution Details   | `text`     |     | ✅    |                            |
| `id`                  | ID                  | `integer`  |     | ✅    |                            |
| `line_count`          | Line Count          | `integer`  |     |       |                            |
| `line_ids`            | Line                | `one2many` |     | ✅    | privacy.lookup.wizard.line |
| `log_id`              | Log                 | `many2one` |     | ✅    | privacy.log                |
| `name`                | Name                | `char`     | ✅  | ✅    |                            |
| `records_description` | Records Description | `text`     |     |       |                            |
| `write_date`          | Last Updated on     | `datetime` |     | ✅    |                            |
| `write_uid`           | Last Updated by     | `many2one` |     | ✅    | res.users                  |
...
| Name                         | Group                | Perms     |
| ---------------------------- | -------------------- | --------- |
| access_privacy_lookup_wizard | Role / Administrator | `R/W/C/D` |

### 🗃️ `privacy.lookup.wizard.line` — Privacy Lookup Wizard Line
...
| `create_uid`        | Created by             | `many2one`  |     | ✅    | res.users             |
| `display_name`      | Display Name           | `char`      |     |       |                       |
| `execution_details` | Execution Details      | `char`      |     | ✅    |                       |
| `has_active`        | Has Active             | `boolean`   |     | ✅    |                       |
| `id`                | ID                     | `integer`   |     | ✅    |                       |
...
| `wizard_id`         | Wizard                 | `many2one`  |     | ✅    | privacy.lookup.wizard |
| `write_date`        | Last Updated on        | `datetime`  |     | ✅    |                       |
| `write_uid`         | Last Updated by        | `many2one`  |     | ✅    | res.users             |
...
| Name                              | Group                | Perms   |
| --------------------------------- | -------------------- | ------- |
| access_privacy_lookup_wizard_line | Role / Administrator | `R/W/C` |
