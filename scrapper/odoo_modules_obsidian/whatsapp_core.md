---
title: "Whatsapp API Module"
module: "whatsapp_core"
state: "installed"
version: "19.0.1.0"
...
> **Module:** `whatsapp_core` | **Version:** `19.0.1.0` **Category:** Category |
> **License:** `LGPL-3` **Author:** OpenEduCat Inc **Website:** _N/A_

## 🔗 Dependencies

[[web]] [[website]] [[crm]] [[sale]]
...
- `Whatsapp`
- `Whatsapp/Campaign`
- `Whatsapp/Campaign/Campaign`
- `Whatsapp/Campaign/Participants`
- `Whatsapp/Campaign/Trace`
- `Whatsapp/Chat`
- `Whatsapp/Configuration`
- `Whatsapp/Configuration/Bussiness`
- `Whatsapp/Configuration/Server Action`
- `Whatsapp/Configuration/Tags`
- `Whatsapp/Configuration/Team Assignment`
- `Whatsapp/Configuration/Templates`
- `Whatsapp/Configuration/Templates Library`
- `Whatsapp/Contacts`

### Views

- `* INHERIT res.config.settings.whatsapp.view.form.inherit.crm (form)`
- `* INHERIT whatsapp.ir.attachment.form.inherit (form)`
- `All Users (qweb)`
- `All Users (qweb)`
- `All Users (qweb)`
- `All Users (qweb)`
- `Template Preview (qweb)`
- `conversation_last_msg (qweb)`
- `whatsapp.activate.library.template.form (form)`
- `whatsapp.activity.trace.view.graph (graph)`
- `whatsapp.activity.trace.view.tree (list)`
- `whatsapp.activity.view.form (form)`
- `whatsapp.activity.view.pivot (pivot)`
- `whatsapp.campaign.view.kanban (kanban)`
- `whatsapp.chatter.view (form)`
- `whatsapp.preview.view (form)`
- `whatsapp.variable.form (form)`
- `whatsapp.variable.form (form)`
- `whatsapp_business_form_view (form)`
- `whatsapp_business_list_view (list)`
- `whatsapp_buttons_form_view (form)`
- `whatsapp_buttons_type_list_view (list)`
- `whatsapp_campaign_activity_form_view (form)`
- `whatsapp_campaign_activity_list_view (list)`
- `whatsapp_campaign_form_view (form)`
- `whatsapp_campaign_list_view (list)`
- `whatsapp_campaign_participants_form_view (form)`
- `whatsapp_campaign_participants_list_view (list)`
- `whatsapp_chat_form_view (form)`
- `whatsapp_chat_list_view (list)`
- `whatsapp_contact_form_view (form)`
- `whatsapp_contact_list_view (list)`
- `whatsapp_contact_pivot_view (pivot)`
- `whatsapp_media_form_view (form)`
- `whatsapp_media_list_view (list)`
- `whatsapp_msg_button_type_form_view (form)`
- `whatsapp_msg_button_type_list_view (list)`
- `whatsapp_note_form_view (form)`
- `whatsapp_note_list_view (list)`
- `whatsapp_sections_form_view (form)`
- `whatsapp_sections_list_view (list)`
- `whatsapp_sections_rows_form_view (form)`
- `whatsapp_sections_rows_list_view (list)`
- `whatsapp_server_action_form_view (form)`
- `whatsapp_server_action_list_view (list)`
- `whatsapp_server_map_form_view (form)`
- `whatsapp_server_map_list_view (list)`
- `whatsapp_starred_message_data (qweb)`
- `whatsapp_tag_form_view (form)`
- `whatsapp_tag_list_view (list)`
- `whatsapp_team_assignment_form_view (form)`
- `whatsapp_team_assignment_list_view (list)`
- `whatsapp_team_members_form_view (form)`
- `whatsapp_team_members_list_view (list)`
- `whatsapp_template_form_view (form)`
- `whatsapp_template_library_form_view (form)`
- `whatsapp_template_library_list_view (list)`
- `whatsapp_template_list_view (list)`
- `whatsapp_text_form_view (form)`
- `whatsapp_text_type_list_view (list)`
...
**38 model(s) defined by this module:**
...
### 🗃️ `whatsapp.business` — Whatsapp business
...
| `app_id`                               | App ID                               | `char`      | ✅  | ✅    |                                 |
| `approximate_charges`                  | Approximate Charges                  | `char`      |     | ✅    |                                 |
| `app_secret_key`                       | App Secret Key                       | `char`      | ✅  | ✅    |                                 |
| `business_phone_id`                    | Phone Number ID                      | `char`      | ✅  | ✅    |                                 |
| `create_date`                          | Created on                           | `datetime`  |     | ✅    |                                 |
| `create_uid`                           | Created by                           | `many2one`  |     | ✅    | res.users                       |
| `current_limit`                        | Current Limit                        | `char`      |     | ✅    |                                 |
| `default_chat_assign`                  | Default Chat Assign To               | `many2one`  |     | ✅    | res.users                       |
| `display_name`                         | Display Name                         | `char`      |     |       |                                 |
| `has_message`                          | Has Message                          | `boolean`   |     |       |                                 |
| `id`                                   | ID                                   | `integer`   |     | ✅    |                                 |
| `image`                                | Business Profile Picture             | `binary`    |     | ✅    |                                 |
| `is_out_of_office`                     | Is Out of Office                     | `boolean`   |     | ✅    |                                 |
| `is_welcome`                           | Is Welcome                           | `boolean`   |     | ✅    |                                 |
| `last_update_datetime`                 | Last Updated Datetime                | `datetime`  |     | ✅    |                                 |
| `message_attachment_count`             | Attachment Count                     | `integer`   |     |       |                                 |
| `message_follower_ids`                 | Followers                            | `one2many`  |     | ✅    | mail.followers                  |
| `message_has_error`                    | Message Delivery error               | `boolean`   |     |       |                                 |
| `message_has_error_counter`            | Number of errors                     | `integer`   |     |       |                                 |
...
| `message_needaction_counter`           | Number of Actions                    | `integer`   |     |       |                                 |
| `message_partner_ids`                  | Followers (Partners)                 | `many2many` |     |       | res.partner                     |
| `name`                                 | Business Name                        | `char`      | ✅  | ✅    |                                 |
| `out_of_office_body_text`              | Office Out Message                   | `text`      |     | ✅    |                                 |
| `out_of_office_copy_body_text`         | Office Out Copy Message              | `char`      |     | ✅    |                                 |
| `pin_chat`                             | User Pin Data                        | `char`      |     | ✅    |                                 |
| `rating_ids`                           | Ratings                              | `one2many`  |     | ✅    | rating.rating                   |
| `state`                                | Status                               | `selection` |     | ✅    |                                 |
| `team_assignment_id`                   | Team Assignment                      | `many2one`  |     | ✅    | whatsapp.team.assignment        |
| `wa_business_id`                       | WhatsApp Business Account ID         | `char`      | ✅  | ✅    |                                 |
| `webhook_verify_token`                 | Webhook Verification Token           | `char`      |     | ✅    |                                 |
| `website_message_ids`                  | Website Messages                     | `one2many`  |     | ✅    | mail.message                    |
| `welcome_body_text`                    | Welcome Message                      | `text`      |     | ✅    |                                 |
| `welcome_copy_body_text`               | Welcome copy Message                 | `char`      |     | ✅    |                                 |
| `whatsapp_contact_line`                | Whatsapp Contact Line                | `one2many`  |     | ✅    | whatsapp.contact                |
| `whatsapp_conversation_analytics_line` | Conversation Analytics               | `one2many`  |     | ✅    | whatsapp.conversation.analytics |
| `whatsapp_out_of_office_variable_line` | Whatsapp Out Of Office Variable Line | `one2many`  |     | ✅    | whatsapp.body.variable          |
| `whatsapp_template_line`               | Whatsapp Template Line               | `one2many`  |     | ✅    | whatsapp.template               |
| `whatsapp_welcome_variable_line`       | Whatsapp Welcome Variable Line       | `one2many`  |     | ✅    | whatsapp.header.variable        |
| `working_hours_id`                     | Working Hours                        | `many2one`  |     | ✅    | resource.calendar               |
| `write_date`                           | Last Updated on                      | `datetime`  |     | ✅    |                                 |
| `write_uid`                            | Last Updated by                      | `many2one`  |     | ✅    | res.users                       |
...
| Name                                | Group        | Perms     |
| ----------------------------------- | ------------ | --------- |
| access_whatsapp_business_chat_agent | / Chat Agent | `R`       |
| access_whatsapp_business_manager    | / Manager    | `R/W/C/D` |

### 🗃️ `whatsapp.chat` — Whatsapp Chat
...
| Field                               | Label                  | Type        | Req | Store | Relation                       |
| ----------------------------------- | ---------------------- | ----------- | --- | ----- | ------------------------------ |
| `api_data`                          | Message API Data       | `char`      |     | ✅    |                                |
| `assign_by`                         | Assign By              | `many2one`  |     | ✅    | res.users                      |
| `assign_from`                       | Assign From            | `many2one`  |     | ✅    | res.users                      |
| `assign_to`                         | Assign To              | `many2one`  |     | ✅    | res.users                      |
| `attachment_ids`                    | whatsapp Media         | `many2many` |     | ✅    | ir.attachment                  |
| `billable`                          | Billable               | `boolean`   |     | ✅    |                                |
| `body`                              | Body                   | `text`      |     | ✅    |                                |
| `button_text`                       | Button text            | `char`      |     | ✅    |                                |
| `caption`                           | Caption                | `char`      |     | ✅    |                                |
| `chat_activity`                     | Chat Activity          | `selection` |     | ✅    |                                |
| `chat_open_close_by`                | Chat Open Close By     | `many2one`  |     | ✅    | res.users                      |
| `chat_stage`                        | Chat Stage             | `selection` |     | ✅    |                                |
| `chat_type`                         | Chat Type              | `selection` |     | ✅    |                                |
| `code`                              | Code                   | `char`      |     | ✅    |                                |
| `contact_details`                   | Contact Details        | `text`      |     | ✅    |                                |
| `conversation_id`                   | Conversation ID        | `char`      |     | ✅    |                                |
| `conversation_type`                 | Conversation type      | `char`      |     | ✅    |                                |
| `create_date`                       | Created on             | `datetime`  |     | ✅    |                                |
| `create_uid`                        | Created by             | `many2one`  |     | ✅    | res.users                      |
| `date`                              | Date                   | `datetime`  |     | ✅    |                                |
| `details`                           | Details                | `char`      |     | ✅    |                                |
| `display_name`                      | Display Name           | `char`      |     |       |                                |
| `expiration_timestamp`              | Expiration Timestamp   | `char`      |     | ✅    |                                |
| `from_message_id`                   | From Message Id        | `char`      |     | ✅    |                                |
| `from_phone_number_id`              | From Phone Number Id   | `char`      |     | ✅    |                                |
| `has_message`                       | Has Message            | `boolean`   |     |       |                                |
| `header`                            | Header                 | `selection` |     |       |                                |
| `id`                                | ID                     | `integer`   |     | ✅    |                                |
| `is_close`                          | Message Close          | `boolean`   |     | ✅    |                                |
| `latitude`                          | Latitude               | `char`      |     | ✅    |                                |
| `location_address`                  | Location Address       | `char`      |     | ✅    |                                |
| `location_name`                     | Location_name          | `char`      |     | ✅    |                                |
| `location_url`                      | Location URL           | `char`      |     | ✅    |                                |
| `log_Conversation_type`             | Log Conversation Type  | `selection` |     | ✅    |                                |
| `log_type`                          | Log Type               | `selection` |     | ✅    |                                |
| `longitude`                         | Longitude              | `char`      |     | ✅    |                                |
| `media_generate_id`                 | whatsapp Media Id      | `char`      |     | ✅    |                                |
| `message_attachment_count`          | Attachment Count       | `integer`   |     |       |                                |
| `message_body_data`                 | Message Body Content   | `text`      |     | ✅    |                                |
| `message_follower_ids`              | Followers              | `one2many`  |     | ✅    | mail.followers                 |
| `message_has_error`                 | Message Delivery error | `boolean`   |     |       |                                |
| `message_has_error_counter`         | Number of errors       | `integer`   |     |       |                                |
| `message_has_sms_error`             | SMS Delivery error     | `boolean`   |     |       |                                |
...
| `message_needaction_counter`        | Number of Actions      | `integer`   |     |       |                                |
| `message_partner_ids`               | Followers (Partners)   | `many2many` |     |       | res.partner                    |
| `message_reaction`                  | Message Reaction       | `char`      |     | ✅    |                                |
| `message_receive_type`              | Receive Type           | `selection` |     | ✅    |                                |
| `message_type`                      | Send Type              | `selection` |     | ✅    |                                |
| `model`                             | Related Document Model | `char`      |     | ✅    |                                |
| `msg_status`                        | Response Status        | `text`      |     | ✅    |                                |
| `msg_status_code`                   | Status Code            | `char`      |     | ✅    |                                |
| `name`                              | Name                   | `char`      |     | ✅    |                                |
| `other_api_data`                    | Other API Data         | `char`      |     | ✅    |                                |
| `payload`                           | Payload                | `char`      |     | ✅    |                                |
| `pricing_model`                     | Pricing Model          | `char`      |     | ✅    |                                |
| `rating_ids`                        | Ratings                | `one2many`  |     | ✅    | rating.rating                  |
| `res_id`                            | Response Document Id   | `integer`   |     | ✅    |                                |
| `send_chat_by`                      | Send Chat By           | `many2one`  |     | ✅    | res.users                      |
| `sha256_key`                        | Sha256 Key             | `char`      |     | ✅    |                                |
| `star_message`                      | Star Message           | `boolean`   |     | ✅    |                                |
| `state`                             | Status                 | `selection` |     | ✅    |                                |
| `timestamp`                         | Timestamp Id           | `char`      |     | ✅    |                                |
| `title`                             | Title                  | `char`      |     | ✅    |                                |
| `website_message_ids`               | Website Messages       | `one2many`  |     | ✅    | mail.message                   |
| `whatsapp_activity_trace_id`        | Activity Trace Id      | `many2one`  |     | ✅    | whatsapp.activity.trace        |
| `whatsapp_body_variable_line`       | Body Variables         | `one2many`  |     |       | whatsapp.body.variable         |
| `whatsapp_business_id`              | Business Account       | `many2one`  |     |       | whatsapp.business              |
| `whatsapp_button_line`              | Whatsapp Button Line   | `many2many` |     | ✅    | whatsapp.buttons               |
| `whatsapp_campaign_activity_id`     | Campaign Activity      | `many2one`  |     | ✅    | whatsapp.campaign.activity     |
| `whatsapp_campaign_id`              | Whatsapp Campaign      | `many2one`  |     | ✅    | whatsapp.campaign              |
| `whatsapp_campaign_participants_id` | Campaign Participants  | `many2one`  |     | ✅    | whatsapp.campaign.participants |
| `whatsapp_contact_id`               | whatsapp Contact       | `many2one`  |     | ✅    | whatsapp.contact               |
| `whatsapp_header_variable_line`     | Header Variables       | `one2many`  |     |       | whatsapp.header.variable       |
| `whatsapp_sections_rows_id`         | Whatsapp Sections Rows | `many2one`  |     | ✅    | whatsapp.sections.rows         |
| `whatsapp_template_id`              | Use whatsapp Template  | `many2one`  |     | ✅    | whatsapp.template              |
| `write_date`                        | Last Updated on        | `datetime`  |     | ✅    |                                |
| `write_uid`                         | Last Updated by        | `many2one`  |     | ✅    | res.users                      |
...
| Name                            | Group        | Perms     |
| ------------------------------- | ------------ | --------- |
| access_whatsapp_chat_chat_agent | / Chat Agent | `R/W/C/D` |
| access_whatsapp_chat_manager    | / Manager    | `R/W/C/D` |

### 🗃️ `whatsapp.contact` — Whatsapp Contact
...
| `active`                     | Active                 | `boolean`            |     | ✅    |                          |
| `assign_to`                  | Assign To              | `many2one`           |     | ✅    | res.users                |
| `campaign_ids`               | Campaign Ids           | `many2many`          |     | ✅    | whatsapp.campaign        |
| `chat_activity_datetime`     | Last Chat Activity     | `datetime`           |     | ✅    |                          |
| `chat_stage`                 | Chat Stage             | `selection`          |     | ✅    |                          |
| `country_id`                 | Country                | `many2one`           |     | ✅    | res.country              |
| `create_date`                | Created on             | `datetime`           |     | ✅    |                          |
| `create_uid`                 | Created by             | `many2one`           |     | ✅    | res.users                |
...
| `has_message`                | Has Message            | `boolean`            |     |       |                          |
| `id`                         | ID                     | `integer`            |     | ✅    |                          |
| `image_1920`                 | Profile                | `binary`             |     | ✅    |                          |
| `is_close`                   | Message Close          | `boolean`            |     | ✅    |                          |
| `last_chat_date`             | Last Chat Date         | `datetime`           |     | ✅    |                          |
| `marketing_opt`              | Message Opt            | `boolean`            |     | ✅    |                          |
| `message_attachment_count`   | Attachment Count       | `integer`            |     |       |                          |
| `message_body_data`          | Message Body Content   | `html`               |     | ✅    |                          |
| `message_follower_ids`       | Followers              | `one2many`           |     | ✅    | mail.followers           |
| `message_has_error`          | Message Delivery error | `boolean`            |     |       |                          |
| `message_has_error_counter`  | Number of errors       | `integer`            |     |       |                          |
| `message_has_sms_error`      | SMS Delivery error     | `boolean`            |     |       |                          |
...
| `name`                       | Name                   | `char`               |     | ✅    |                          |
| `phone`                      | Phone                  | `char`               | ✅  | ✅    |                          |
| `phone1`                     | User Phone             | `char`               |     | ✅    |                          |
| `pin_chat`                   | Pin Chat               | `many2many`          |     | ✅    | res.users                |
| `rating_ids`                 | Ratings                | `one2many`           |     | ✅    | rating.rating            |
| `reference`                  | Reference              | `char`               |     |       |                          |
| `res_id`                     | Record ID              | `many2one_reference` |     | ✅    |                          |
| `sequence`                   | Sequence               | `integer`            |     | ✅    |                          |
| `state`                      | Status                 | `selection`          |     | ✅    |                          |
| `team_id`                    | Team                   | `many2one`           |     | ✅    | whatsapp.team.assignment |
| `unread_message`             | Unread Message         | `integer`            |     | ✅    |                          |
| `website_message_ids`        | Website Messages       | `one2many`           |     | ✅    | mail.message             |
| `whatsapp_business_id`       | Business Account       | `many2one`           | ✅  | ✅    | whatsapp.business        |
| `whatsapp_chat_line`         | Whatsapp Chat Line     | `one2many`           |     | ✅    | whatsapp.chat            |
| `whatsapp_note_line`         | Whatsapp Note Line     | `one2many`           |     | ✅    | whatsapp.note            |
| `whatsapp_tag_line`          | Tags                   | `many2many`          |     | ✅    | whatsapp.tag             |
| `write_date`                 | Last Updated on        | `datetime`           |     | ✅    |                          |
| `write_uid`                  | Last Updated by        | `many2one`           |     | ✅    | res.users                |
...
| Name                               | Group        | Perms     |
| ---------------------------------- | ------------ | --------- |
| access_whatsapp_contact_chat_agent | / Chat Agent | `R`       |
| access_whatsapp_contact_manager    | / Manager    | `R/W/C/D` |

### 🗃️ `whatsapp.media` — Whatsapp Media
...
| `display_name`               | Display Name           | `char`      |     |       |                   |
| `has_message`                | Has Message            | `boolean`   |     |       |                   |
| `header_handle`              | Header handle          | `char`      |     | ✅    |                   |
| `id`                         | ID                     | `integer`   |     | ✅    |                   |
| `media_id`                   | Media ID               | `char`      |     | ✅    |                   |
| `media_link`                 | Media Link             | `char`      |     | ✅    |                   |
| `media_type`                 | Media Type             | `selection` |     | ✅    |                   |
| `message_attachment_count`   | Attachment Count       | `integer`   |     |       |                   |
| `message_follower_ids`       | Followers              | `one2many`  |     | ✅    | mail.followers    |
| `message_has_error`          | Message Delivery error | `boolean`   |     |       |                   |
| `message_has_error_counter`  | Number of errors       | `integer`   |     |       |                   |
...
| `name`                       | Name                   | `char`      | ✅  | ✅    |                   |
| `rating_ids`                 | Ratings                | `one2many`  |     | ✅    | rating.rating     |
| `session_id`                 | Session ID             | `char`      |     | ✅    |                   |
| `website_message_ids`        | Website Messages       | `one2many`  |     | ✅    | mail.message      |
| `whatsapp_business_id`       | Whatsapp Business      | `many2one`  |     | ✅    | whatsapp.business |
| `write_date`                 | Last Updated on        | `datetime`  |     | ✅    |                   |
| `write_uid`                  | Last Updated by        | `many2one`  |     | ✅    | res.users         |
...
| Name                             | Group        | Perms     |
| -------------------------------- | ------------ | --------- |
| access_whatsapp_media_chat_agent | / Chat Agent | `R/W/C/D` |
| access_whatsapp_media_manager    | / Manager    | `R/W/C/D` |

### 🗃️ `whatsapp.msg.button.type` — Whatsapp Msg Button Type
...
| ------------------------------ | ------------------------- | ----------- | --- | ----- | ------------------------- |
| `button_text`                  | Button Text               | `char`      | ✅  | ✅    |                           |
| `country_calling_code`         | Calling Code              | `integer`   |     | ✅    |                           |
| `country_id`                   | Country                   | `many2one`  |     | ✅    | res.country               |
| `create_date`                  | Created on                | `datetime`  |     | ✅    |                           |
| `create_uid`                   | Created by                | `many2one`  |     | ✅    | res.users                 |
| `display_name`                 | Display Name              | `char`      |     |       |                           |
...
| `message_needaction_counter`   | Number of Actions         | `integer`   |     |       |                           |
| `message_partner_ids`          | Followers (Partners)      | `many2many` |     |       | res.partner               |
| `msg_button`                   | Button Type               | `selection` | ✅  | ✅    |                           |
| `phone_number`                 | Phone Number              | `char`      |     | ✅    |                           |
| `rating_ids`                   | Ratings                   | `one2many`  |     | ✅    | rating.rating             |
| `website_message_ids`          | Website Messages          | `one2many`  |     | ✅    | mail.message              |
| `website_type`                 | Website Type              | `selection` |     | ✅    |                           |
| `website_url`                  | Website URL               | `char`      |     | ✅    |                           |
| `whatsapp_template_id`         | Whatsapp Template         | `many2one`  |     | ✅    | whatsapp.template         |
| `whatsapp_template_library_id` | Whatsapp Template Library | `many2one`  |     | ✅    | whatsapp.template.library |
| `write_date`                   | Last Updated on           | `datetime`  |     | ✅    |                           |
| `write_uid`                    | Last Updated by           | `many2one`  |     | ✅    | res.users                 |
...
| Name                                       | Group        | Perms     |
| ------------------------------------------ | ------------ | --------- |
| access_whatsapp_msg_button_type_chat_agent | / Chat Agent | `R/W/C/D` |
| access_whatsapp_msg_button_type_manager    | / Manager    | `R/W/C/D` |

### 🗃️ `whatsapp.note` — Whatsapp Notes
...
| `rating_ids`                 | Ratings                | `one2many`  |     | ✅    | rating.rating    |
| `website_message_ids`        | Website Messages       | `one2many`  |     | ✅    | mail.message     |
| `whatsapp_contact_id`        | Whatsapp Messages      | `many2one`  |     | ✅    | whatsapp.contact |
| `write_date`                 | Last Updated on        | `datetime`  |     | ✅    |                  |
| `write_uid`                  | Last Updated by        | `many2one`  |     | ✅    | res.users        |
...
| Name                            | Group        | Perms     |
| ------------------------------- | ------------ | --------- |
| access_whatsapp_note_chat_agent | / Chat Agent | `R/W/C/D` |
| access_whatsapp_note_manager    | / Manager    | `R/W/C/D` |

### 🗃️ `whatsapp.tag` — Whatsapp Tag
...
| `website_message_ids`        | Website Messages       | `one2many`  |     | ✅    | mail.message      |
| `whatsapp_business_id`       | Business Account       | `many2one`  | ✅  | ✅    | whatsapp.business |
| `whatsapp_contact_line`      | Contacts               | `many2many` |     | ✅    | whatsapp.contact  |
| `write_date`                 | Last Updated on        | `datetime`  |     | ✅    |                   |
| `write_uid`                  | Last Updated by        | `many2one`  |     | ✅    | res.users         |
...
| Name                           | Group        | Perms     |
| ------------------------------ | ------------ | --------- |
| access_whatsapp_tag_chat_agent | / Chat Agent | `R/W`     |
| access_whatsapp_tag_manager    | / Manager    | `R/W/C/D` |

### 🗃️ `whatsapp.team.assignment` — Whatsapp Team Assignment
...
| `name`                       | Team Name              | `char`      | ✅  | ✅    |                       |
| `rating_ids`                 | Ratings                | `one2many`  |     | ✅    | rating.rating         |
| `team_members_ids`           | Team Members           | `one2many`  |     | ✅    | whatsapp.team.members |
| `website_message_ids`        | Website Messages       | `one2many`  |     | ✅    | mail.message          |
| `write_date`                 | Last Updated on        | `datetime`  |     | ✅    |                       |
| `write_uid`                  | Last Updated by        | `many2one`  |     | ✅    | res.users             |
...
| Name                                       | Group        | Perms     |
| ------------------------------------------ | ------------ | --------- |
| access_whatsapp_team_assignment_chat_agent | / Chat Agent | `R`       |
| access_whatsapp_team_assignment_manager    | / Manager    | `R/W/C/D` |

### 🗃️ `whatsapp.team.members` — Whatsapp Team Members
...
| Field                         | Label                  | Type        | Req | Store | Relation                 |
| ----------------------------- | ---------------------- | ----------- | --- | ----- | ------------------------ |
| `assign_chat_count`           | Assign Chat Count      | `char`      |     | ✅    |                          |
| `create_date`                 | Created on             | `datetime`  |     | ✅    |                          |
| `create_uid`                  | Created by             | `many2one`  |     | ✅    | res.users                |
| `display_name`                | Display Name           | `char`      |     |       |                          |
| `has_message`                 | Has Message            | `boolean`   |     |       |                          |
...
| `website_message_ids`         | Website Messages       | `one2many`  |     | ✅    | mail.message             |
| `whatsapp_team_assignment_id` | Team Id                | `many2one`  |     | ✅    | whatsapp.team.assignment |
| `write_date`                  | Last Updated on        | `datetime`  |     | ✅    |                          |
| `write_uid`                   | Last Updated by        | `many2one`  |     | ✅    | res.users                |
...
| Name                                    | Group        | Perms     |
| --------------------------------------- | ------------ | --------- |
| access_whatsapp_team_members_chat_agent | / Chat Agent | `R`       |
| access_whatsapp_team_members_manager    | / Manager    | `R/W/C/D` |

### 🗃️ `whatsapp.template` — Whatsapp Templates
...
| Field                                 | Label                               | Type        | Req | Store | Relation                       |
| ------------------------------------- | ----------------------------------- | ----------- | --- | ----- | ------------------------------ |
| `action_type`                         | Action Type                         | `selection` |     | ✅    |                                |
| `active`                              | Active                              | `boolean`   |     | ✅    |                                |
| `attachment_ids`                      | Media                               | `many2many` |     | ✅    | ir.attachment                  |
| `category_types`                      | Category Type                       | `selection` |     | ✅    |                                |
| `components`                          | Msg Content                         | `html`      |     | ✅    |                                |
| `copy_value`                          | Copy Value                          | `char`      |     | ✅    |                                |
| `create_date`                         | Created on                          | `datetime`  |     | ✅    |                                |
| `create_uid`                          | Created by                          | `many2one`  |     | ✅    | res.users                      |
| `description`                         | Description                         | `char`      |     | ✅    |                                |
| `disable_date`                        | Disable Date                        | `char`      |     | ✅    |                                |
| `display_name`                        | Display Name                        | `char`      |     |       |                                |
| `has_message`                         | Has Message                         | `boolean`   |     |       |                                |
| `header`                              | Header                              | `selection` |     | ✅    |                                |
| `header_copy_text`                    | whatsapp Copy Header                | `text`      |     | ✅    |                                |
| `header_handle`                       | Header handle                       | `char`      |     | ✅    |                                |
| `header_media`                        | Header Media                        | `selection` |     | ✅    |                                |
| `header_text`                         | Heading Text                        | `text`      |     | ✅    |                                |
| `id`                                  | ID                                  | `integer`   |     | ✅    |                                |
| `image_field`                         | Image Field                         | `char`      |     | ✅    |                                |
| `interactive_body`                    | Interective Body                    | `text`      |     | ✅    |                                |
| `interactive_footer`                  | Interective Footer                  | `char`      |     | ✅    |                                |
| `interactive_header_text`             | Interective Header                  | `char`      |     | ✅    |                                |
| `interactive_message_type`            | interactive Message Type            | `selection` |     | ✅    |                                |
| `is_footer`                           | Footer                              | `boolean`   |     | ✅    |                                |
| `lang`                                | Language                            | `many2one`  |     | ✅    | res.lang                       |
| `last_update_datetime`                | Last Updated Datetime               | `datetime`  |     | ✅    |                                |
| `latitude`                            | latitude                            | `char`      |     | ✅    |                                |
| `list_button`                         | Button Text                         | `char`      |     | ✅    |                                |
| `location_address`                    | Location Address                    | `char`      |     | ✅    |                                |
| `location_name`                       | Location Name                       | `char`      |     | ✅    |                                |
| `longitude`                           | longitude                           | `char`      |     | ✅    |                                |
| `media_variable`                      | Media Variable                      | `text`      |     | ✅    |                                |
| `message_attachment_count`            | Attachment Count                    | `integer`   |     |       |                                |
| `message_follower_ids`                | Followers                           | `one2many`  |     | ✅    | mail.followers                 |
| `message_has_error`                   | Message Delivery error              | `boolean`   |     |       |                                |
| `message_has_error_counter`           | Number of errors                    | `integer`   |     |       |                                |
...
| `message_needaction_counter`          | Number of Actions                   | `integer`   |     |       |                                |
| `message_partner_ids`                 | Followers (Partners)                | `many2many` |     |       | res.partner                    |
| `message_structure_type`              | Message Structure                   | `selection` |     | ✅    |                                |
| `model_id`                            | Model                               | `many2one`  |     | ✅    | ir.model                       |
| `model_name`                          | Apply On                            | `char`      |     | ✅    |                                |
| `msg_body`                            | Message Body                        | `char`      |     | ✅    |                                |
| `msg_copy_body`                       | whatsapp Copy Body                  | `char`      |     | ✅    |                                |
| `msg_footer`                          | Footer Text                         | `char`      |     | ✅    |                                |
| `msg_template_id`                     | Template ID                         | `char`      |     | ✅    |                                |
| `name`                                | Name                                | `char`      | ✅  | ✅    |                                |
| `name_field`                          | Name Field                          | `char`      |     | ✅    |                                |
| `new_quality_score`                   | New Quality Score                   | `char`      |     | ✅    |                                |
| `phone_field`                         | Phone Field                         | `char`      |     | ✅    |                                |
| `previous_quality_score`              | Previous Quality Score              | `char`      |     | ✅    |                                |
| `rating_ids`                          | Ratings                             | `one2many`  |     | ✅    | rating.rating                  |
| `reason`                              | Reason                              | `char`      |     | ✅    |                                |
| `render_model`                        | Rendering Model                     | `char`      |     |       |                                |
| `report_id`                           | Optional Report to Add              | `many2one`  |     | ✅    | ir.actions.report              |
| `server_action_id`                    | Server Action                       | `many2one`  |     | ✅    | ir.actions.server              |
| `session_id`                          | Session ID                          | `char`      |     | ✅    |                                |
| `state`                               | Status                              | `selection` |     | ✅    |                                |
| `status`                              | Template Status                     | `char`      |     | ✅    |                                |
| `template_name`                       | Template Name                       | `char`      |     | ✅    |                                |
| `template_rejection`                  | Rejection Reason                    | `char`      |     | ✅    |                                |
| `template_response`                   | Template Response                   | `char`      |     | ✅    |                                |
| `title`                               | Title                               | `char`      |     | ✅    |                                |
| `website_message_ids`                 | Website Messages                    | `one2many`  |     | ✅    | mail.message                   |
| `whatsapp_body_variable_line`         | Whatsapp Body Variable Line         | `one2many`  |     | ✅    | whatsapp.body.variable         |
| `whatsapp_business_id`                | Whatsapp Business                   | `many2one`  | ✅  | ✅    | whatsapp.business              |
| `whatsapp_button_line`                | Whatsapp Button Line                | `many2many` |     | ✅    | whatsapp.buttons               |
| `whatsapp_header_media_variable_line` | Whatsapp Header Media Variable Line | `one2many`  |     | ✅    | whatsapp.header.media.variable |
| `whatsapp_header_variable_line`       | Whatsapp Header Variable Line       | `one2many`  |     | ✅    | whatsapp.header.variable       |
| `whatsapp_list_section_line`          | Whatsapp List Section Line          | `one2many`  |     | ✅    | whatsapp.list.sections         |
| `whatsapp_msg_button_type_line`       | Whatsapp Msg Button Type Line       | `one2many`  |     | ✅    | whatsapp.msg.button.type       |
| `whatsapp_template_library_id`        | Whatsapp Template Library           | `many2one`  |     | ✅    | whatsapp.template.library      |
| `whatsapp_text_line`                  | Whatsapp Text Line                  | `one2many`  |     | ✅    | whatsapp.text                  |
| `write_date`                          | Last Updated on                     | `datetime`  |     | ✅    |                                |
| `write_uid`                           | Last Updated by                     | `many2one`  |     | ✅    | res.users                      |
...
| Name                                | Group        | Perms     |
| ----------------------------------- | ------------ | --------- |
| access_whatsapp_template_chat_agent | / Chat Agent | `R`       |
| access_whatsapp_template_manager    | / Manager    | `R/W/C/D` |

### 🗃️ `whatsapp.template.library` — Whatsapp Templates Library
...
| `name_field`                    | Name Field                    | `char`      |     | ✅    |                          |
| `phone_field`                   | Phone Field                   | `char`      |     | ✅    |                          |
| `product_ids`                   | Products                      | `many2many` |     | ✅    | product.product          |
| `rating_ids`                    | Ratings                       | `one2many`  |     | ✅    | rating.rating            |
| `render_model`                  | Rendering Model               | `char`      |     |       |                          |
| `report_id`                     | Optional Report to Add        | `many2one`  |     | ✅    | ir.actions.report        |
| `template_data`                 | Template Json Data.           | `char`      |     | ✅    |                          |
| `website_message_ids`           | Website Messages              | `one2many`  |     | ✅    | mail.message             |
| `whatsapp_button_line`          | Whatsapp Button Line          | `many2many` |     | ✅    | whatsapp.buttons         |
| `whatsapp_msg_button_type_line` | Whatsapp Msg Button Type Line | `one2many`  |     | ✅    | whatsapp.msg.button.type |
| `whatsapp_text_line`            | Whatsapp Text Line            | `one2many`  |     | ✅    | whatsapp.text            |
...
| Name                                        | Group        | Perms     |
| ------------------------------------------- | ------------ | --------- |
| access_whatsapp_template_library_chat_agent | / Chat Agent | `R`       |
| access_whatsapp_template_library_manager    | / Manager    | `R/W/C/D` |

### 🗃️ `whatsapp.text` — Whatsapp Text
...
| `message_partner_ids`          | Followers (Partners)      | `many2many` |     |       | res.partner               |
| `rating_ids`                   | Ratings                   | `one2many`  |     | ✅    | rating.rating             |
| `text_data`                    | Button Text               | `char`      |     | ✅    |                           |
| `website_message_ids`          | Website Messages          | `one2many`  |     | ✅    | mail.message              |
| `whatsapp_template_library_id` | Whatsapp Template Library | `many2one`  |     | ✅    | whatsapp.template.library |
| `whatsapp_text_id`             | Whatsapp Text             | `many2one`  |     | ✅    | whatsapp.template         |
| `write_date`                   | Last Updated on           | `datetime`  |     | ✅    |                           |
| `write_uid`                    | Last Updated by           | `many2one`  |     | ✅    | res.users                 |
...
| Name                            | Group        | Perms     |
| ------------------------------- | ------------ | --------- |
| access_whatsapp_text_chat_agent | / Chat Agent | `R/W/C/D` |
| access_whatsapp_text_manager    | / Manager    | `R/W/C/D` |

### 🗃️ `whatsapp.activity.trace` — Activity Trace
...
| Field                | Label               | Type        | Req | Store | Relation                       |
| -------------------- | ------------------- | ----------- | --- | ----- | ------------------------------ |
| `activity_id`        | Activity            | `many2one`  | ✅  | ✅    | whatsapp.campaign.activity     |
| `campaign_id`        | Campaign            | `many2one`  |     | ✅    | whatsapp.campaign              |
| `child_ids`          | Direct child traces | `one2many`  |     | ✅    | whatsapp.activity.trace        |
| `create_date`        | Created on          | `datetime`  |     | ✅    |                                |
| `create_uid`         | Created by          | `many2one`  |     | ✅    | res.users                      |
| `delivered`          | Delivered           | `datetime`  |     | ✅    |                                |
| `display_name`       | Display Name        | `char`      |     |       |                                |
| `failed`             | Failed              | `datetime`  |     | ✅    |                                |
| `id`                 | ID                  | `integer`   |     | ✅    |                                |
| `is_replied`         | Is Replied          | `boolean`   |     | ✅    |                                |
| `message_state`      | Message State       | `selection` |     | ✅    |                                |
| `parent_id`          | Parent              | `many2one`  |     | ✅    | whatsapp.activity.trace        |
| `participant_id`     | Participant         | `many2one`  | ✅  | ✅    | whatsapp.campaign.participants |
| `replied`            | Replied             | `datetime`  |     | ✅    |                                |
...
| Name                                      | Group        | Perms     |
| ----------------------------------------- | ------------ | --------- |
| access_whatsapp_activity_trace_chat_agent | / Chat Agent | `R/W/C/D` |
| access_whatsapp_activity_trace_manager    | / Manager    | `R/W/C/D` |
...
### 🗃️ `whatsapp.activate.template` — Whatsapp Activate Template
...
| `display_name`         | Display Name      | `char`      |     |       |                           |
| `id`                   | ID                | `integer`   |     | ✅    |                           |
| `is_apply_approve`     | Apply for Approve | `boolean`   |     | ✅    |                           |
| `is_context_action`    | Context Action    | `boolean`   |     | ✅    |                           |
| `name`                 | Name              | `char`      |     | ✅    |                           |
| `template_ids`         | Library Templates | `many2many` |     | ✅    | whatsapp.template.library |
| `whatsapp_business_id` | Whatsapp Business | `many2one`  |     | ✅    | whatsapp.business         |
| `write_date`           | Last Updated on   | `datetime`  |     | ✅    |                           |
| `write_uid`            | Last Updated by   | `many2one`  |     | ✅    | res.users                 |
...
| Name                                         | Group        | Perms     |
| -------------------------------------------- | ------------ | --------- |
| access_whatsapp_activate_template_chat_agent | / Chat Agent | `R/W/C/D` |
| access_whatsapp_activate_template_manager    | / Manager    | `R/W/C/D` |

### 🗃️ `whatsapp.variable` — Whatsapp Add Variable
...
| Field                    | Label                  | Type       | Req | Store | Relation        |
| ------------------------ | ---------------------- | ---------- | --- | ----- | --------------- |
| `copyvalue`              | Placeholder Expression | `char`     |     | ✅    |                 |
| `create_date`            | Created on             | `datetime` |     | ✅    |                 |
| `create_uid`             | Created by             | `many2one` |     | ✅    | res.users       |
| `display_name`           | Display Name           | `char`     |     |       |                 |
| `id`                     | ID                     | `integer`  |     | ✅    |                 |
| `model_id`               | Model                  | `many2one` |     | ✅    | ir.model        |
| `model_object_field`     | Field                  | `many2one` |     | ✅    | ir.model.fields |
| `name`                   | Test Field             | `char`     |     | ✅    |                 |
| `null_value`             | Default Value          | `char`     |     |       |                 |
| `sub_model_object_field` | Sub-field              | `many2one` |     |       | ir.model.fields |
| `sub_object`             | Sub-model              | `many2one` |     |       | ir.model        |
| `write_date`             | Last Updated on        | `datetime` |     | ✅    |                 |
| `write_uid`              | Last Updated by        | `many2one` |     | ✅    | res.users       |
...
| Name                                | Group        | Perms     |
| ----------------------------------- | ------------ | --------- |
| access_whatsapp_variable_chat_agent | / Chat Agent | `R/W/C/D` |
| access_whatsapp_variable_manager    | / Manager    | `R/W/C/D` |

### 🗃️ `whatsapp.body.variable` — Whatsapp body variable
...
| Field                         | Label                  | Type       | Req | Store | Relation          |
| ----------------------------- | ---------------------- | ---------- | --- | ----- | ----------------- |
| `body_fallback_value`         | Fallback Value         | `char`     |     | ✅    |                   |
| `create_date`                 | Created on             | `datetime` |     | ✅    |                   |
| `create_uid`                  | Created by             | `many2one` |     | ✅    | res.users         |
| `display_name`                | Display Name           | `char`     |     |       |                   |
| `id`                          | ID                     | `integer`  |     | ✅    |                   |
| `index`                       | Index                  | `char`     |     | ✅    |                   |
| `js_value`                    | Js Value               | `char`     |     | ✅    |                   |
| `name`                        | Variable Name          | `char`     |     | ✅    |                   |
| `whatsapp_body_variable_name` | Whatsapp Variable Name | `char`     |     | ✅    |                   |
| `whatsapp_business_id`        | Whatsapp Business Id   | `many2one` |     | ✅    | whatsapp.business |
| `whatsapp_template_id`        | whatsapp Template      | `many2one` |     | ✅    | whatsapp.template |
| `write_date`                  | Last Updated on        | `datetime` |     | ✅    |                   |
| `write_uid`                   | Last Updated by        | `many2one` |     | ✅    | res.users         |
...
| Name                                     | Group        | Perms     |
| ---------------------------------------- | ------------ | --------- |
| access_whatsapp_body_variable_chat_agent | / Chat Agent | `R/W/C/D` |
| access_whatsapp_body_variable_manager    | / Manager    | `R/W/C/D` |

### 🗃️ `whatsapp.buttons` — Whatsapp Buttons
...
| `whatsapp_chat_id`             | Whatsapp Chat             | `many2many` |     | ✅    | whatsapp.chat     |
| `whatsapp_template_id`         | Whatsapp Template         | `many2one`  |     | ✅    | whatsapp.template |
| `whatsapp_template_library_id` | Whatsapp Template Library | `many2one`  |     | ✅    | whatsapp.template |
| `write_date`                   | Last Updated on           | `datetime`  |     | ✅    |                   |
| `write_uid`                    | Last Updated by           | `many2one`  |     | ✅    | res.users         |
...
| Name                               | Group        | Perms     |
| ---------------------------------- | ------------ | --------- |
| access_whatsapp_buttons_chat_agent | / Chat Agent | `R/W/C/D` |
| access_whatsapp_buttons_manager    | / Manager    | `R/W/C/D` |

### 🗃️ `whatsapp.campaign` — Whatsapp Campaign
...
| `model_name`                      | Model Name                             | `char`      |     | ✅    |                                |
| `name`                            | Name                                   | `char`      | ✅  | ✅    |                                |
| `participant_ids`                 | Participants                           | `one2many`  |     | ✅    | whatsapp.campaign.participants |
| `running_participant_count`       | active participants                    | `integer`   |     |       |                                |
| `state`                           | State                                  | `selection` |     | ✅    |                                |
| `total_participant_count`         | active and completed participants      | `integer`   |     |       |                                |
| `total_whatsapp_contact_count`    | # of active and completed participants | `integer`   |     |       |                                |
| `unique_field_id`                 | Unique Field                           | `many2one`  |     | ✅    | ir.model.fields                |
| `whatsapp_business_id`            | Business Account                       | `many2one`  | ✅  | ✅    | whatsapp.business              |
| `whatsapp_campaign_activity_line` | Campaign Activity                      | `one2many`  |     | ✅    | whatsapp.campaign.activity     |
| `whatsapp_chat_line`              | Whatsapp Chat Line                     | `one2many`  |     | ✅    | whatsapp.chat                  |
| `whatsapp_contact_ids`            | Whatsapp Contacts                      | `many2many` |     | ✅    | whatsapp.contact               |
| `write_date`                      | Last Updated on                        | `datetime`  |     | ✅    |                                |
| `write_uid`                       | Last Updated by                        | `many2one`  |     | ✅    | res.users                      |
...
| Name                                | Group        | Perms     |
| ----------------------------------- | ------------ | --------- |
| access_whatsapp_campaign_chat_agent | / Chat Agent | `R/W/C/D` |
| access_whatsapp_campaign_manager    | / Manager    | `R/W/C/D` |

### 🗃️ `whatsapp.campaign.activity` — Whatsapp Campaign Activity
...
| `activity_state`                     | Activity State                 | `selection` |     | ✅    |                                |
| `allowed_parent_ids`                 | Allowed parents                | `many2many` |     |       | whatsapp.campaign.activity     |
| `attachment_ids`                     | whatsapp Media                 | `many2many` |     | ✅    | ir.attachment                  |
| `campaign_id`                        | Campaign                       | `many2one`  | ✅  | ✅    | whatsapp.campaign              |
| `child_ids`                          | Child Activities               | `one2many`  |     | ✅    | whatsapp.campaign.activity     |
| `create_date`                        | Created on                     | `datetime`  |     | ✅    |                                |
| `create_uid`                         | Created by                     | `many2one`  |     | ✅    | res.users                      |
| `display_name`                       | Display Name                   | `char`      |     |       |                                |
...
| `model_name`                         | Model Name                     | `char`      |     |       |                                |
| `name`                               | Name                           | `char`      | ✅  | ✅    |                                |
| `parent_id`                          | Activity                       | `many2one`  |     | ✅    | whatsapp.campaign.activity     |
| `processed`                          | Processed                      | `integer`   |     |       |                                |
| `rejected`                           | Rejected                       | `integer`   |     |       |                                |
| `schedule_time`                      | Schedule Time                  | `datetime`  |     | ✅    |                                |
| `statistics_graph_data`              | Statistics Graph Data          | `char`      |     |       |                                |
| `total_delivered`                    | Total Delivered                | `integer`   |     |       |                                |
| `total_read`                         | Total Read                     | `integer`   |     |       |                                |
| `total_replied`                      | Total Replied                  | `integer`   |     |       |                                |
| `total_sent`                         | Total Sent                     | `integer`   |     |       |                                |
| `trace_ids`                          | Traces                         | `one2many`  |     | ✅    | whatsapp.activity.trace        |
| `trigger_type`                       | Trigger Type                   | `selection` | ✅  | ✅    |                                |
...
| `whatsapp_business_id`               | Business Account               | `many2one`  |     |       | whatsapp.business              |
| `whatsapp_campaign_participants_ids` | Whatsapp Campaign Participants | `many2many` |     | ✅    | whatsapp.campaign.participants |
| `whatsapp_chat_line`                 | Whatsapp Chat Line             | `one2many`  |     | ✅    | whatsapp.chat                  |
| `whatsapp_template_id`               | Use Template                   | `many2one`  | ✅  | ✅    | whatsapp.template              |
| `write_date`                         | Last Updated on                | `datetime`  |     | ✅    |                                |
| `write_uid`                          | Last Updated by                | `many2one`  |     | ✅    | res.users                      |
...
| Name                                         | Group        | Perms     |
| -------------------------------------------- | ------------ | --------- |
| access_whatsapp_campaign_activity_chat_agent | / Chat Agent | `R/W/C/D` |
| access_whatsapp_campaign_activity_manager    | / Manager    | `R/W/C/D` |

### 🗃️ `whatsapp.campaign.participants` — Whatsapp Campaign Participants
...
| `resource_ref`        | Record             | `reference` |     |       |                         |
| `state`               | State              | `selection` |     | ✅    |                         |
| `trace_ids`           | Actions            | `one2many`  |     | ✅    | whatsapp.activity.trace |
| `whatsapp_chat_line`  | Whatsapp Chat Line | `one2many`  |     | ✅    | whatsapp.chat           |
| `whatsapp_contact_id` | Whatsapp Contact   | `many2one`  |     | ✅    | whatsapp.contact        |
| `write_date`          | Last Updated on    | `datetime`  |     | ✅    |                         |
| `write_uid`           | Last Updated by    | `many2one`  |     | ✅    | res.users               |
...
| Name                                             | Group        | Perms     |
| ------------------------------------------------ | ------------ | --------- |
| access_whatsapp_campaign_participants_chat_agent | / Chat Agent | `R/W/C/D` |
| access_whatsapp_campaign_participants_manager    | / Manager    | `R/W/C/D` |

### 🗃️ `whatsapp.chat.create` — WHATSAPP Chat Create
...
| `country_id`           | Country                      | `many2one` | ✅  | ✅    | res.country       |
| `create_date`          | Created on                   | `datetime` |     | ✅    |                   |
| `create_partner`       | Want to create partner too ? | `boolean`  |     | ✅    |                   |
| `create_uid`           | Created by                   | `many2one` |     | ✅    | res.users         |
| `display_name`         | Display Name                 | `char`     |     |       |                   |
| `email`                | Email                        | `char`     |     | ✅    |                   |
| `id`                   | ID                           | `integer`  |     | ✅    |                   |
...
| Name                        | Group       | Perms     |
| --------------------------- | ----------- | --------- |
| access_whatsapp_chat_create | Role / User | `R/W/C/D` |

### 🗃️ `whatsapp.conversation.analytics` — Whatsapp Conversation Analytics
...
| Field                   | Label                 | Type        | Req | Store | Relation          |
| ----------------------- | --------------------- | ----------- | --- | ----- | ----------------- |
| `conversation`          | Conversation          | `char`      |     | ✅    |                   |
| `conversation_category` | Conversation Category | `selection` |     | ✅    |                   |
| `conversation_id`       | Conversation Id       | `char`      |     | ✅    |                   |
| `conversation_type`     | Conversation Type     | `selection` |     | ✅    |                   |
| `cost`                  | Cost                  | `char`      |     | ✅    |                   |
| `country_id`            | Country               | `many2one`  |     | ✅    | res.country       |
| `create_date`           | Created on            | `datetime`  |     | ✅    |                   |
| `create_uid`            | Created by            | `many2one`  |     | ✅    | res.users         |
...
| Name                                   | Group       | Perms     |
| -------------------------------------- | ----------- | --------- |
| access_whatsapp_conversation_analytics | Role / User | `R/W/C/D` |

### 🗃️ `whatsapp.description.widget` — whatsapp description widget
...
| `null_value`              | Default Value           | `char`     |     |       |                 |
| `sub_model_object_field`  | Sub-field               | `many2one` |     |       | ir.model.fields |
| `sub_model_object_string` | Sub Model Object String | `char`     |     | ✅    |                 |
| `sub_object`              | Sub-model               | `many2one` |     |       | ir.model        |
| `write_date`              | Last Updated on         | `datetime` |     | ✅    |                 |
| `write_uid`               | Last Updated by         | `many2one` |     | ✅    | res.users       |
...
| Name                                                | Group        | Perms     |
| --------------------------------------------------- | ------------ | --------- |
| access_whatsapp_description_widget_chat_agent       | / Chat Agent | `R/W/C/D` |
| access_whatsapp_description_widget_whatsapp_manager | / Manager    | `R/W/C/D` |

### 🗃️ `whatsapp.header.media.variable` — Whatsapp header media variable
...
| `id`                                  | ID                     | `integer`  |     | ✅    |                   |
| `name`                                | Variable Name          | `char`     |     | ✅    |                   |
| `whatsapp_header_media_variable_name` | Whatsapp Variable Name | `char`     |     | ✅    |                   |
| `whatsapp_template_id`                | whatsapp Template      | `many2one` |     | ✅    | whatsapp.template |
| `write_date`                          | Last Updated on        | `datetime` |     | ✅    |                   |
| `write_uid`                           | Last Updated by        | `many2one` |     | ✅    | res.users         |
...
| Name                                  | Group        | Perms     |
| ------------------------------------- | ------------ | --------- |
| access_whatsapp_header_media_variable | / Chat Agent | `R/W/C/D` |
| access_whatsapp_header_media_variable | / Manager    | `R/W/C/D` |

### 🗃️ `whatsapp.header.variable` — Whatsapp header variable
...
| `create_uid`                    | Created by             | `many2one` |     | ✅    | res.users         |
| `display_name`                  | Display Name           | `char`     |     |       |                   |
| `header_fallback_value`         | Fallback Value         | `char`     |     | ✅    |                   |
| `id`                            | ID                     | `integer`  |     | ✅    |                   |
| `index`                         | Index                  | `char`     |     | ✅    |                   |
| `js_value`                      | Js Value               | `char`     |     | ✅    |                   |
| `name`                          | Variable Name          | `char`     |     | ✅    |                   |
| `whatsapp_business_id`          | Whatsapp Business Id   | `many2one` |     | ✅    | whatsapp.business |
| `whatsapp_header_variable_name` | Whatsapp Variable Name | `char`     |     | ✅    |                   |
| `whatsapp_template_id`          | whatsapp Template      | `many2one` |     | ✅    | whatsapp.template |
| `write_date`                    | Last Updated on        | `datetime` |     | ✅    |                   |
| `write_uid`                     | Last Updated by        | `many2one` |     | ✅    | res.users         |
...
| Name                                       | Group        | Perms     |
| ------------------------------------------ | ------------ | --------- |
| access_whatsapp_header_variable_chat_agent | / Chat Agent | `R/W/C/D` |
| access_whatsapp_header_variable_manager    | / Manager    | `R/W/C/D` |

### 🗃️ `whatsapp.interective` — Whatsapp Interective
...
| Name                        | Group       | Perms     |
| --------------------------- | ----------- | --------- |
| access_whatsapp_interective | Role / User | `R/W/C/D` |

### 🗃️ `whatsapp.list.sections` — Whatsapp List Sections
...
| `display_name`               | Display Name               | `char`     |     |       |                        |
| `id`                         | ID                         | `integer`  |     | ✅    |                        |
| `title`                      | Section Title              | `char`     |     | ✅    |                        |
| `whatsapp_sections_row_line` | Whatsapp Sections Row Line | `one2many` |     | ✅    | whatsapp.sections.rows |
| `whatsapp_template_id`       | Whatsapp Template          | `many2one` |     | ✅    | whatsapp.template      |
| `write_date`                 | Last Updated on            | `datetime` |     | ✅    |                        |
| `write_uid`                  | Last Updated by            | `many2one` |     | ✅    | res.users              |
...
| Name                                     | Group        | Perms     |
| ---------------------------------------- | ------------ | --------- |
| access_whatsapp_list_sections_chat_agent | / Chat Agent | `R/W/C/D` |
| access_whatsapp_list_sections_manager    | / Manager    | `R/W/C/D` |

### 🗃️ `whatsapp.preview` — Whatsapp preview
...
| Name                            | Group        | Perms     |
| ------------------------------- | ------------ | --------- |
| access_whatsapp_preview_agent   | / Chat Agent | `R/W/C/D` |
| access_whatsapp_preview_manager | / Manager    | `R/W/C/D` |

### 🗃️ `whatsapp.chatter` — Whatsapp preview
...
| `partner_id`           | Partner           | `many2one` |     | ✅    | res.partner       |
| `preview`              | Preview           | `html`     |     | ✅    |                   |
| `record_id`            | Record            | `integer`  |     | ✅    |                   |
| `template_id`          | Template          | `many2one` |     | ✅    | whatsapp.template |
| `whatsapp_business_id` | Whatsapp Business | `many2one` |     | ✅    | whatsapp.business |
| `whatsapp_contact_id`  | Whatsapp Contact  | `many2one` |     | ✅    | whatsapp.contact  |
| `write_date`           | Last Updated on   | `datetime` |     | ✅    |                   |
| `write_uid`            | Last Updated by   | `many2one` |     | ✅    | res.users         |
...
| Name                            | Group        | Perms     |
| ------------------------------- | ------------ | --------- |
| access_whatsapp_chatter_agent   | / Chat Agent | `R/W/C/D` |
| access_whatsapp_chatter_manager | / Manager    | `R/W/C/D` |

### 🗃️ `whatsapp.sections.rows` — Whatsapp Sections Rows
...
| `display_name`              | Display Name           | `char`     |     |       |                        |
| `id`                        | ID                     | `integer`  |     | ✅    |                        |
| `title`                     | Row Title              | `char`     |     | ✅    |                        |
| `whatsapp_list_sections_id` | Whatsapp List Sections | `many2one` |     | ✅    | whatsapp.list.sections |
| `write_date`                | Last Updated on        | `datetime` |     | ✅    |                        |
| `write_uid`                 | Last Updated by        | `many2one` |     | ✅    | res.users              |
...
| Name                                     | Group        | Perms     |
| ---------------------------------------- | ------------ | --------- |
| access_whatsapp_sections_rows_chat_agent | / Chat Agent | `R/W/C/D` |
| access_whatsapp_sections_rows_manager    | / Manager    | `R/W/C/D` |

### 🗃️ `whatsapp.server.action` — Whatsapp Server Action
...
| `icon`                   | Icon                   | `char`     |     | ✅    |                     |
| `id`                     | ID                     | `integer`  |     | ✅    |                     |
| `model_id`               | Apply on               | `many2one` |     | ✅    | ir.model            |
| `name`                   | Name                   | `char`     |     | ✅    |                     |
| `server_action_map_line` | Server Action Map Line | `one2many` |     | ✅    | whatsapp.server.map |
| `whatsapp_business_id`   | Whatsapp Business      | `many2one` |     | ✅    | whatsapp.business   |
| `write_date`             | Last Updated on        | `datetime` |     | ✅    |                     |
| `write_uid`              | Last Updated by        | `many2one` |     | ✅    | res.users           |
...
| Name                          | Group        | Perms     |
| ----------------------------- | ------------ | --------- |
| access_whatsapp_server_action | / Chat Agent | `R/W/C/D` |
| access_whatsapp_server_action | / Manager    | `R/W/C/D` |

### 🗃️ `whatsapp.server.map` — Whatsapp Server Map
...
| `display_name`              | Display Name              | `char`     |     |       |                        |
| `id`                        | ID                        | `integer`  |     | ✅    |                        |
| `model2_id`                 | Model 2                   | `many2one` |     | ✅    | ir.model               |
| `model_id`                  | Model                     | `many2one` |     | ✅    | ir.model               |
| `model_object_field`        | Field                     | `many2one` |     | ✅    | ir.model.fields        |
| `name`                      | Name                      | `char`     |     | ✅    |                        |
| `sub_model_object_field`    | Sub-field                 | `many2one` |     | ✅    | ir.model.fields        |
| `sub_object`                | Sub-model                 | `many2one` |     | ✅    | ir.model               |
| `unique2_field_id`          | Unique Field 2            | `many2one` |     | ✅    | ir.model.fields        |
| `whatsapp_server_action_id` | Whatsapp Server Action Id | `many2one` |     | ✅    | whatsapp.server.action |
| `write_date`                | Last Updated on           | `datetime` |     | ✅    |                        |
| `write_uid`                 | Last Updated by           | `many2one` |     | ✅    | res.users              |
...
| Name                       | Group        | Perms     |
| -------------------------- | ------------ | --------- |
| access_whatsapp_server_map | / Chat Agent | `R/W/C/D` |
| access_whatsapp_server_map | / Manager    | `R/W/C/D` |
