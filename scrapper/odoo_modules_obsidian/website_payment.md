...
> **Module:** `website_payment` | **Version:** `19.0.1.0` **Category:** Website |
> **License:** `LGPL-3` **Author:** Odoo S.A. **Website:** _N/A_

## 🔗 Dependencies

[[website]] [[account_payment]] [[portal]]
...
- `Donation input (qweb)`
- `Donation mail (qweb)`
- `Donation payment (qweb)`
- `Supported Payment Methods (qweb)`
