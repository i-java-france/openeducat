---
title: "OpenEduCat Student Attendance Face Recognition"
module: "openeducat_attendance_face_recognition"
state: "installed"
version: "19.0.1.0"
...
# 🟢 OpenEduCat Student Attendance Face Recognition

> **Module:** `openeducat_attendance_face_recognition` | **Version:** `19.0.1.0`
> **Category:** Tools | **License:** `Other proprietary` **Author:** OpenEduCat Inc
> **Website:** https://www.openeducat.org

## 🔗 Dependencies

[[openeducat_core]] [[openeducat_attendance_enterprise]]
[[openeducat_student_attendance_enterprise]] [[web]]

## 📖 Description

## OpenEduCat Student Attendance Face Recognition

### OpenEduCat Student Attendance Face Recognition provides facility to conduct attendance with Face Recognition.

[![](/openeducat_attendance_face_recognition/static/description/openeducat_logo.png)](https://www.openeducat.org/demo)

Online Demo

This module aims to manage student's attendances.Keeps account of the attendances of the
students .

[Contact Us](https://www.openeducat.org/contactus/)

## Capture Student Photographs on Student Master

User can add face descriptor for a student from student profile under Capture Live Photo
smart button.

![](/openeducat_attendance_face_recognition/static/description/smart_btn.png)
![](/openeducat_attendance_face_recognition/static/description/capture_webcam.png)

## Capture Snapshot

![](/openeducat_attendance_face_recognition/static/description/capture_img.jpg)

User can capture student's snapshot & save image when green tick appears on the webcam
popup.

## Captured Student's Image

Captured Snapshot will be shown under Face Recognition tab in student profile.

![](/openeducat_attendance_face_recognition/static/description/image_cap.png)

## Student's Profile

![](/openeducat_attendance_face_recognition/static/description/cap_snap.png)

User can also generate descriptor of a student's profile image by clicking on image
descriptor.

## Check in

In Attendances menu click on Check In menu to select Sheet.

![](/openeducat_attendance_face_recognition/static/description/check_in.png)

## Attendance using Face Recognition

![](/openeducat_attendance_face_recognition/static/description/sheet.png)

Select an Appropriate Attendance Sheet & Click on Submit button to open the face
recognition window.

## Recognizing Student Face

If a descriptor is found for a particular student then a attendance record will be
created.

![](/openeducat_attendance_face_recognition/static/description/detect_image.jpg)

## Welcome

![](/openeducat_attendance_face_recognition/static/description/welcome.png)

Welcome message if a attendance record created for student.
...
- `Class Attendances/Check In`

### Views

- `* INHERIT op.student.form.face_recognition (form)`
