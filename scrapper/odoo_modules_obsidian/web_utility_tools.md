...
> **Module:** `web_utility_tools` | **Version:** `19.0.1.0` **Category:** Extra Tools |
> **License:** `LGPL-3` **Author:** OpenEduCat Inc **Website:** https://openeducat.org

## 🔗 Dependencies

[[base_setup]] [[base_import]] [[portal]] [[mail]]
...
- `* INHERIT Login Layout (qweb)`
- `* INHERIT app Web layout (qweb)`
- `* INHERIT base.view_ir_config_inherit_form (form)`
- `* INHERIT res.config.settings.view.form.inherit.web.replace (form)`
...
### 🗃️ `web.environment.ribbon.backend` — Web Environment Ribbon Backend
