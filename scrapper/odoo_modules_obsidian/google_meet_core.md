---
title: "Google Meet Core"
module: "google_meet_core"
state: "installed"
version: "19.0.1.0"
...
> **Module:** `google_meet_core` | **Version:** `19.0.1.0` **Category:** Education |
> **License:** `Other proprietary` **Author:** OpenEduCat Inc **Website:**
> https://www.openeducat.org

## 🔗 Dependencies

[[calendar]] [[online_tools_intg]]
...
- `* INHERIT res.config.settings.view.form.google.classroom (form)`
- `* INHERIT res.users.google.inherited.form (form)`
- `Authentication Successful (qweb)`
- `Authentication unsuccessful (qweb)`
- `google.meet.form (form)`
...
### 🗃️ `google.meet` — Google Meet Meetings
...
| `create_uid`       | Created by       | `many2one` |     | ✅    | res.users      |
| `display_name`     | Display Name     | `char`     |     |       |                |
| `end_date`         | End time         | `datetime` | ✅  | ✅    |                |
| `id`               | ID               | `integer`  |     | ✅    |                |
| `invite_via_email` | Invite Via Email | `boolean`  |     | ✅    |                |
| `meeting_id`       | Meeting          | `many2one` |     | ✅    | calendar.event |
| `start_date`       | Start time       | `datetime` | ✅  | ✅    |                |
...
| Name               | Group       | Perms     |
| ------------------ | ----------- | --------- |
| access_google_meet | Role / User | `R/W/C/D` |
