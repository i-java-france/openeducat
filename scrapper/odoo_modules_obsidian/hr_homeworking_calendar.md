---
title: "Remote Work with calendar"
...
> **Module:** `hr_homeworking_calendar` | **Version:** `19.0.1.0` **Category:** Remote
> Work | **License:** `LGPL-3` **Author:** Odoo S.A. **Website:** _N/A_

## 🔗 Dependencies

[[hr_homeworking]] [[calendar]]
...
- `homework.location.wizard.view.form (form)`
...
### 🗃️ `homework.location.wizard` — Set Homework Location Wizard
...
| Name                     | Group       | Perms     |
| ------------------------ | ----------- | --------- |
| homework.location.wizard | Role / User | `R/W/C/D` |

**Record Rules:**

- **homeworking wizard: own** (1) `R/W/C/D`
  - Domain: `[             ('employee_id', '=', user.employee_id.id)         ]`
- **homeworking wizard: admin** (49) `R/W/C/D`
  - Domain: `[(1, '=', 1)]`
