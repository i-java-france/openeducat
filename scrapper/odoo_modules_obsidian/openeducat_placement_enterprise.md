---
title: "OpenEduCat Placement Enterprise"
module: "openeducat_placement_enterprise"
state: "installed"
version: "19.0.1.0"
...
> **Module:** `openeducat_placement_enterprise` | **Version:** `19.0.1.0` **Category:**
> Education | **License:** `Other proprietary` **Author:** OpenEduCat Inc **Website:**
> https://www.openeducat.org

## 🔗 Dependencies

[[base]] [[openeducat_core_enterprise]]
...
[![](/openeducat_placement_enterprise/static/description/openeducat_logo.png)](https://www.openeducat.org/demo)

Online Demo

This module allows you to have details for placements of students.

[Contact Us](https://www.openeducat.org/contactus/)

## Placement

You can keep record of placement offers with offered package and joining date details.

![](/openeducat_placement_enterprise/static/description/placement.png)
...
- `Placements/Configuration/Coordination Teams`
- `Placements/Opportunities`
- `Placements/Opportunities/Placement Offers`

### Views

- `* INHERIT Show Placement (qweb)`
- `* INHERIT op.student.placement.offer.list (list)`
- `* INHERIT placement.smart.buttons (form)`
- `* INHERIT placement_notification_inherit (qweb)`
- `* INHERIT student_portal_placement_offers (qweb)`
- `op.placement.cell.form (form)`
- `op.placement.cell.kanban (kanban)`
- `op.placement.cell.list (list)`
- `op.placement.cell.search (search)`
- `op.placement.offer.form (form)`
- `op.placement.offer.list (list)`
- `op.placement.offer.search (search)`
- `view.op.placement.offer.pivot (pivot)`
...
### 🗃️ `op.placement.cell` — Placement cell team
...
| `member_ids`                 | Channel Members            | `one2many`  |     | ✅    | res.users      |
...
| Name                          | Group               | Perms     |
| ----------------------------- | ------------------- | --------- |
| access_op_placement_cell      | Placement / Manager | `R/W/C/D` |
| access_op_placement_cell_user | Placement / User    | `R/W`     |

**Record Rules:**

- **Placement Cell multi-company** (Global) `R/W/C/D`
  - Domain:
    `         ['|',('company_id','=',False),'&',('company_id','in',company_ids),'|',('company_id','child_of',[user.company_id.id]),('company_id','in',user.company_ids.ids)]     `
- **Placement Cell multi-department** (Global) `R/W/C/D`
  - Domain:
    `         ['|','|',('department_id','=',False),('department_id','child_of',[user.dept_id.id]),('department_id','in',user.department_ids.ids)]     `

### 🗃️ `op.placement.offer` — Placement Offer
...
| `message_needaction_counter` | Number of Actions      | `integer`   |     |       |                |
| `message_partner_ids`        | Followers (Partners)   | `many2many` |     |       | res.partner    |
| `offer_package`              | Offered Package        | `monetary`  |     | ✅    |                |
...
| Name                                      | Group               | Perms     |
| ----------------------------------------- | ------------------- | --------- |
| name_op_placement_offer_back_office_admin | Placement / Manager | `R/W/C/D` |
| name_op_placement_offer_faculty           | Placement / User    | `R/W/C`   |

**Record Rules:**

- **Placement Offer multi-company** (Global) `R/W/C/D`
  - Domain:
    `         ['|',('company_id','=',False),'&',('company_id','in',company_ids),'|',('company_id','child_of',[user.company_id.id]),('company_id','in',user.company_ids.ids)]     `
