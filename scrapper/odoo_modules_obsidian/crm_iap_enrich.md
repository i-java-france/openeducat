...
> **Module:** `crm_iap_enrich` | **Version:** `19.0.1.1` **Category:** CRM |
...
- `* INHERIT crm.lead.view.form.inherit.iap.lead.enrich (form)`
- `* INHERIT res.config.settings.view.form.inherit.crm.iap.enrich (form)`
- `mail_message_lead_enrich_no_email (qweb)`
- `mail_message_lead_enrich_notfound (qweb)`
