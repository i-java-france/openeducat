...
> **Module:** `account_add_gln` | **Version:** `19.0.1.0` **Category:** Accounting |
...
- `* INHERIT res.partner.form.inherit.account_peppol_partner_extra_fields (form)`
