...
> **Module:** `website_mass_mailing` | **Version:** `19.0.1.0` **Category:** Website |
> **License:** `LGPL-3` **Author:** Odoo S.A. **Website:** _N/A_

## 🔗 Dependencies

[[website]] [[mass_mailing]] [[google_recaptcha]]

## 📖 Description

This module brings a new building block with a mailing list widget to drop on any page
of your website. On a simple click, your visitors can subscribe to mailing lists managed
...
- `Newsletter (qweb)`
- `Newsletter Benefits (qweb)`
- `Newsletter Block (qweb)`
- `Newsletter Box (qweb)`
- `Newsletter Centered (qweb)`
- `Newsletter Grid (qweb)`
- `Newsletter Popup (qweb)`
- `s_newsletter_block_default_template (qweb)`
- `s_newsletter_block_form_template (qweb)`
