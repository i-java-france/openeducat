---
title: "OpenEduCat CRM Enterprise"
module: "openeducat_crm_enterprise"
state: "installed"
version: "19.0.1.0"
...
# 🟢 OpenEduCat CRM Enterprise

> **Module:** `openeducat_crm_enterprise` | **Version:** `19.0.1.0` **Category:**
> Education | **License:** `Other proprietary` **Author:** OpenEduCat Inc **Website:**
> https://www.openeducat.org

## 🔗 Dependencies

[[crm]] [[openeducat_admission_enterprise]]

## 📖 Description

## OpenEduCat CRM Enterprise

### Manage Converting CRM Leads To Admission,Directly Student and Merge with existing student

[![](/openeducat_crm_enterprise/static/description/openeducat_logo.png)](https://www.openeducat.org/demo)
...
## Converting Lead To Admission

User can create a Admission directly from the CRM Leads.

![](/openeducat_crm_enterprise/static/description/convert_to_admission.png)

## Converting Lead Directly To Student

![](/openeducat_crm_enterprise/static/description/convert_to_student.png)

User can create a Student directly from the CRM Leads.

## Merging Lead Directly To Existing Student

User can Merge the Lead directly To Existing Student from the CRM Leads

![](/openeducat_crm_enterprise/static/description/merge_in_existing_student.png)
...
- `* INHERIT crm.lead.form.inherit (form)`
- `* INHERIT crm.lead.kanban.inherit (kanban)`
- `* INHERIT crm.lead.tree.inherit (list)`
- `* INHERIT op.student.crm.tree.inherit (list)`
- `* INHERIT op.student.form.inherit (form)`
- `crm.convert.lead.to.student (form)`
...
### 🗃️ `lead.to.student` — Convert Lead To Student
...
| `id`                 | ID                          | `integer`   |     | ✅    |                       |
| `last_name`          | Last Name                   | `char`      |     | ✅    |                       |
| `lead_create_method` | What do you want to create? | `selection` | ✅  | ✅    |                       |
...
| Name                   | Group                | Perms     |
| ---------------------- | -------------------- | --------- |
| access_lead_to_student | OpenEduCat / Manager | `R/W/C/D` |
