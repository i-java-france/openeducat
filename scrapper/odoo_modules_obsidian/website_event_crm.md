...
> **Module:** `website_event_crm` | **Version:** `19.0.1.0` **Category:** Website |
> **License:** `LGPL-3` **Author:** Odoo S.A. **Website:**
> https://www.odoo.com/app/events

## 🔗 Dependencies

[[event_crm]] [[website_event]]

## 📖 Description

Allow per-order lead creation mode
...
- `* INHERIT event.lead.rule.view.form.inherit.website.event.crm (form)`
- `* INHERIT event.lead.rule.view.list.inherit.website.event.crm (list)`
