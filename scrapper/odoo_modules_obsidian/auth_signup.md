...
> **Module:** `auth_signup` | **Version:** `19.0.1.0` **Category:** Tools | **License:**
...
- `* INHERIT Sign up - Reset Password (qweb)`
...
- `* INHERIT res.users.list.inherit (list)`
- `Auth Signup/ResetPassword form fields (qweb)`
- `Reset password (qweb)`
- `Sign up login (qweb)`
- `User Reset Password (qweb)`
