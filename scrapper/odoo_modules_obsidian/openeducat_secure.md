---
title: "OpenEduCat Secure"
module: "openeducat_secure"
state: "installed"
version: "19.0.1.0"
...
> **Module:** `openeducat_secure` | **Version:** `19.0.1.0` **Category:** Uncategorized
> | **License:** `Other proprietary` **Author:** OpenEduCat Inc **Website:**
> https://www.openeducat.org

## 🔗 Dependencies

[[web]] [[base]] [[openeducat_core_enterprise]]
...
First of all, Configure the category of QR Code from Openeducat Configuration

![](/openeducat_secure/static/description/configure_qr.png)

## Qr Code Generation

![](/openeducat_secure/static/description/gradebook_report.png)

For example, QR Code is generated for Gradebook Marksheet
...
- `Failure Code Page (qweb)`
- `QR Code Verification (qweb)`
