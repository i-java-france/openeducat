...
> **Module:** `account_accountant` | **Version:** `19.0.1.0` **Category:** Accounting |
> **License:** `Other proprietary` **Author:** OpenEduCat Inc **Website:**
> https://www.openeducat.org

## 🔗 Dependencies

[[accounting_pdf_reports]] [[account_asset_mgmt]] [[account_budget]]
...
- `Accounting/Accounting/Bank and Cash`
- `Accounting/Accounting/Bank and Cash/Bank Statements`
- `Accounting/Accounting/Bank and Cash/Cash Registers`
- `Accounting/Accounting/Journals`
- `Accounting/Accounting/Journals/Bank and Cash`
- `Accounting/Accounting/Journals/Miscellaneous`
- `Accounting/Accounting/Journals/Purchases`
- `Accounting/Accounting/Journals/Sales`
- `Accounting/Accounting/Lock Dates`
- `Accounting/Configuration/Accounting/Account Groups`
- `Accounting/Configuration/Accounting/Account Tags`
- `Accounting/Configuration/Accounting/Account Types`
- `Accounting/Configuration/Accounting/Fiscal Year`
- `Accounting/Configuration/Online Payments/Payment Methods`
- `Accounting/Configuration/Templates`

### Views

- `* INHERIT account.journal (form)`
- `* INHERIT res.config.settings.view.form.inherit.accountant (form)`
- `* INHERIT res.partner (form)`
- `account.fiscal.year.form (form)`
- `account.fiscal.year.list (list)`
- `account.payment.method (form)`
- `account.payment.method (list)`
- `account.payment.method (search)`
- `change.lock.date.form (form)`
...
### 🗃️ `change.lock.date` — Change Lock Date
...
| `create_uid`           | Created by              | `many2one` |     | ✅    | res.users   |
| `display_name`         | Display Name            | `char`     |     |       |             |
| `fiscalyear_lock_date` | Lock Date for All Users | `date`     |     | ✅    |             |
...
| Name                            | Group                | Perms     |
| ------------------------------- | -------------------- | --------- |
| access.change.lock.date.manager | Accounting / Advisor | `R/W/C/D` |
...
### 🗃️ `account.fiscal.year` — Fiscal Year
...
| Name                               | Group                | Perms     |
| ---------------------------------- | -------------------- | --------- |
| access.account.fiscal.year.manager | Accounting / Advisor | `R/W/C/D` |
| access.account.fiscal.year         | Contact / Accountant | `R/W`     |
