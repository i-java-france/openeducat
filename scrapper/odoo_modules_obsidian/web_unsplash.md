...
> **Module:** `web_unsplash` | **Version:** `19.0.1.1` **Category:** Technical |
> **License:** `LGPL-3` **Author:** Odoo S.A. **Website:** _N/A_

## 🔗 Dependencies

[[base_setup]] [[html_editor]]
...
![](/web_unsplash/static/description/unsplash_interface_bar.png)

### ...to explore [Unsplash.com](https://unsplash.com/) and find images to use in Odoo.

![](/web_unsplash/static/description/unsplash_interface.png)
...
- `* INHERIT res.config.settings.view.form.inherit.web.unsplash (form)`
