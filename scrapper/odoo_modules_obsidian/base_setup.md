...
> **Module:** `base_setup` | **Version:** `19.0.1.0` **Category:** Technical |
...
- `* INHERIT res.config.settings.view.form.inherit.base.setup (form)`
- `* INHERIT res.partner.kanban.inherit (kanban)`
