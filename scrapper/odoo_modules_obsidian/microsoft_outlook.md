...
> **Module:** `microsoft_outlook` | **Version:** `19.0.1.1` **Category:** Technical |
...
- `* INHERIT fetchmail.server.view.form.inherit.outlook (form)`
- `* INHERIT ir.mail_server.view.form.inherit.outlook (form)`
- `* INHERIT res.config.settings.view.form.inherit.microsoft_outlook (form)`
- `microsoft_outlook_oauth_error (qweb)`
...
### 🗃️ `microsoft.outlook.mixin` — Microsoft Outlook Mixin
