---
title: "OpenEduCat Alumni Enterprise"
module: "openeducat_alumni_enterprise"
state: "installed"
version: "19.0.1.0"
...
> **Module:** `openeducat_alumni_enterprise` | **Version:** `19.0.1.0` **Category:**
> Education | **License:** `Other proprietary` **Author:** OpenEduCat Inc **Website:**
> https://www.openeducat.org

## 🔗 Dependencies

[[base]] [[openeducat_core_enterprise]] [[website_profile]] [[website_forum]]
[[product]] [[account]]
...
### Manage details of alumni

[![](/openeducat_alumni_enterprise/static/description/openeducat_logo.png)](https://www.openeducat.org/demo)
...
![](/openeducat_alumni_enterprise/static/description/alumni_group.png)

Can create Alumni group and manage alumni students.

Manage details of alumni such as passing year, current position, current job and much
more.

![](/openeducat_alumni_enterprise/static/description/alumni.png)
...
- `Alumni (qweb)`
- `Alumni Details (qweb)`
- `alumni.group.form.view (form)`
- `alumni.search.view (search)`
- `alumni.tree.view (list)`
- `op.student.list.view (list)`
