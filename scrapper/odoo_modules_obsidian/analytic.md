...
> **Module:** `analytic` | **Version:** `19.0.1.2` **Category:** Accounting |
...
In Odoo, analytic accounts are linked to general accounts but are treated totally
independently. So, you can enter various different analytic operations that have no
counterpart in the general financial accounts.
...
### 🗃️ `analytic.mixin` — Analytic Mixin
...
### 🗃️ `analytic.plan.fields.mixin` — Analytic Plan Fields
...
### 🗃️ `account.analytic.plan` — Analytic Plans
...
| Field                   | Label                       | Type        | Req | Store | Relation                       |
| ----------------------- | --------------------------- | ----------- | --- | ----- | ------------------------------ |
| `account_count`         | Analytic Accounts Count     | `integer`   |     |       |                                |
| `account_ids`           | Accounts                    | `one2many`  |     | ✅    | account.analytic.account       |
| `all_account_count`     | All Analytic Accounts Count | `integer`   |     |       |                                |
| `applicability_ids`     | Applicability               | `one2many`  |     | ✅    | account.analytic.applicability |
| `children_count`        | Children Plans Count        | `integer`   |     |       |                                |
| `children_ids`          | Childrens                   | `one2many`  |     | ✅    | account.analytic.plan          |
| `color`                 | Color                       | `integer`   |     | ✅    |                                |
| `complete_name`         | Complete Name               | `char`      |     | ✅    |                                |
| `create_date`           | Created on                  | `datetime`  |     | ✅    |                                |
| `create_uid`            | Created by                  | `many2one`  |     | ✅    | res.users                      |
| `default_applicability` | Default Applicability       | `selection` |     | ✅    |                                |
| `description`           | Description                 | `text`      |     | ✅    |                                |
| `display_name`          | Display Name                | `char`      |     |       |                                |
| `id`                    | ID                          | `integer`   |     | ✅    |                                |
| `name`                  | Name                        | `char`      | ✅  | ✅    |                                |
| `parent_id`             | Parent                      | `many2one`  |     | ✅    | account.analytic.plan          |
| `parent_path`           | Parent Path                 | `char`      |     | ✅    |                                |
| `root_id`               | Root                        | `many2one`  |     |       | account.analytic.plan          |
| `sequence`              | Sequence                    | `integer`   |     | ✅    |                                |
| `write_date`            | Last Updated on             | `datetime`  |     | ✅    |                                |
| `write_uid`             | Last Updated by             | `many2one`  |     | ✅    | res.users                      |
...
| Name                             | Group                | Perms     |
| -------------------------------- | -------------------- | --------- |
| account.analytic.plan accountant | Contact / Accountant | `R/W/C/D` |
| access_account_analytic_plan     | Analytic Accounting  | `R/W/C/D` |
