---
title: "OpenEduCat Grievance Enterprise"
...
# 🟢 OpenEduCat Grievance Enterprise

> **Module:** `openeducat_grievance_enterprise` | **Version:** `19.0.1.0` **Category:**
> Education | **License:** `Other proprietary` **Author:** OpenEduCat Inc **Website:**
> https://www.openeducat.org

## 🔗 Dependencies

[[base]] [[openeducat_core_enterprise]] [[openeducat_parent_enterprise]] [[account]]

## 📖 Description

## OpenEduCat Grievance Management System

[![](/openeducat_grievance_enterprise/static/description/openeducat_logo.png)](https://www.openeducat.org/demo)

Online Demo

This module allows you to manage the Grievance easily. Admin can assign grievance to the
related teams and take action against the grievance.

[Contact Us](https://www.openeducat.org/contactus/)

## Grievance Category

Admin can make categories from configuration menu.

![](/openeducat_grievance_enterprise/static/description/GrievanceCategory.png)

## Grievance Team

![](/openeducat_grievance_enterprise/static/description/GrievanceTeam.png)

Admin can make Teams from configuration menu.

## Register Grievance

Student, Faculty or Parent can register their grievance.

![](/openeducat_grievance_enterprise/static/description/student_grievance.png)

## Grievance Detail

![](/openeducat_grievance_enterprise/static/description/Grievance_details.png)

Admin can take action against the grievance or reject the grievance.

## Take Action

Action taken against the grievance.

![](/openeducat_grievance_enterprise/static/description/ActionTaken.png)
...
- `SIS/Configuration/Grievances`
- `SIS/Configuration/Grievances/Grievance Category`
- `SIS/Configuration/Grievances/Grievance Teams`
- `SIS/General/Grievances`
- `SIS/General/Grievances/Grievances`

### Views

- `* INHERIT Portal layout : Grievances (qweb)`
- `* INHERIT grievance_notification_inherit (qweb)`
- `* INHERIT portal_home_inherit_grievance (qweb)`
- `Action Taken (form)`
- `All Grievances (qweb)`
- `Grievance Category Form View (form)`
- `Grievance Category List View (list)`
- `Grievance Form View (form)`
- `Grievance List View (list)`
- `Grievance Pivot View (pivot)`
- `Grievance Search View (search)`
- `Grievance Team Form View (form)`
- `Grievance Team Kanban View (kanban)`
- `Grievance Team List View (list)`
- `Grievance Team Search View (search)`
- `edit-grievance (qweb)`
- `gms.lead.kanban.lead (kanban)`
- `grievance access denied (qweb)`
- `grievance details (qweb)`
- `grievance form (qweb)`
- `grievance.activity (activity)`
...
| `grievance_category_id`         | Grievance Category            | `many2one`  | ✅  | ✅    | grievance.category   |
| `grievance_for`                 | Grievance By                  | `selection` | ✅  | ✅    |                      |
| `grievance_parent_id`           | Parent Grievance              | `many2one`  |     | ✅    | grievance            |
| `grievance_team_id`             | Team                          | `many2one`  |     | ✅    | grievance.team       |
| `has_message`                   | Has Message                   | `boolean`   |     |       |                      |
| `id`                            | ID                            | `integer`   |     | ✅    |                      |
| `is_academic`                   | Is Academic                   | `boolean`   |     |       |                      |
| `is_appeal`                     | Is Appeal                     | `boolean`   |     | ✅    |                      |
| `is_published`                  | Is Published                  | `boolean`   |     | ✅    |                      |
| `is_read`                       | Read?                         | `boolean`   |     | ✅    |                      |
| `is_satisfied`                  | Is Satisfied                  | `selection` |     | ✅    |                      |
...
| `root_cause_id`                 | Root Cause                    | `many2one`  |     | ✅    | grievance.root.cause |
| `state`                         | Status                        | `selection` |     | ✅    |                      |
| `student_id`                    | Student                       | `many2one`  |     | ✅    | op.student           |
| `subject`                       | Name/Subject                  | `char`      | ✅  | ✅    |                      |
...
| Name                             | Group               | Perms     |
| -------------------------------- | ------------------- | --------- |
| access_grievance_backofficeadmin | Grievance / Manager | `R/W/C/D` |
| access_grievance_faculty         | Grievance / User    | `R/W/C`   |
| access_grievance_portal          | Role / Portal       | `R/W/C/D` |

**Record Rules:**

- **Grievance multi company** (Global) `R/W/C/D`
  - Domain:
    `         ['|',('grievance_category_id.company_id','=',False),'&',('grievance_category_id.company_id','in',company_ids),'|',('grievance_category_id.company_id','child_of',[user.company_id.id]),('grievance_category_id.company_id','in',user.company_ids.ids)]     `

### 🗃️ `grievance.team` — Grievance Team
...
| `create_uid`                 | Created by             | `many2one`  |     | ✅    | res.users          |
| `display_name`               | Display Name           | `char`      |     |       |                    |
| `grievance_category_id`      | Grievance Category     | `many2many` |     | ✅    | grievance.category |
| `grievance_count`            | Total Grievances       | `integer`   |     |       |                    |
| `has_message`                | Has Message            | `boolean`   |     |       |                    |
| `id`                         | ID                     | `integer`   |     | ✅    |                    |
| `member_ids`                 | Members                | `one2many`  |     | ✅    | res.users          |
| `message_attachment_count`   | Attachment Count       | `integer`   |     |       |                    |
| `message_follower_ids`       | Followers              | `one2many`  |     | ✅    | mail.followers     |
| `message_has_error`          | Message Delivery error | `boolean`   |     |       |                    |
| `message_has_error_counter`  | Number of errors       | `integer`   |     |       |                    |
...
| `name`                       | Name                   | `char`      | ✅  | ✅    |                    |
| `rating_ids`                 | Ratings                | `one2many`  |     | ✅    | rating.rating      |
| `team_leader`                | Team Leader            | `many2one`  | ✅  | ✅    | res.users          |
| `website_message_ids`        | Website Messages       | `one2many`  |     | ✅    | mail.message       |
| `write_date`                 | Last Updated on        | `datetime`  |     | ✅    |                    |
| `write_uid`                  | Last Updated by        | `many2one`  |     | ✅    | res.users          |
...
| Name                                  | Group               | Perms     |
| ------------------------------------- | ------------------- | --------- |
| access_grievance_team_backofficeadmin | Grievance / Manager | `R/W/C/D` |
| access_grievance_team_faculty         | Grievance / User    | `R`       |

**Record Rules:**

- **Grievance Team Multi Company** (Global) `R/W/C/D`
  - Domain:
    `         ['|',('company_id','=',False),'&',('company_id','in',company_ids),'|',('company_id','child_of',[user.company_id.id]),('company_id','in',user.company_ids.ids)]     `

### 🗃️ `wizard.action.taken` — Grievance Action Taken
...
| Name                                       | Group               | Perms     |
| ------------------------------------------ | ------------------- | --------- |
| access_wizard_action_taken_backofficeadmin | Grievance / Manager | `R/W/C/D` |
| access_wizard_action_taken_faculty         | Grievance / User    | `R`       |

### 🗃️ `grievance.category` — Grievance Category
...
| `is_academic`   | Is Academic     | `boolean`  |     | ✅    |                    |
| `name`          | Grievance       | `char`     | ✅  | ✅    |                    |
| `parent_id`     | Parent Category | `many2one` |     | ✅    | grievance.category |
...
| Name                                      | Group               | Perms     |
| ----------------------------------------- | ------------------- | --------- |
| access_grievance_category_backofficeadmin | Grievance / Manager | `R/W/C/D` |
| access_grievance_category_faculty         | Grievance / User    | `R`       |
| access_grievance_category_portal          | Role / Portal       | `R/W/C/D` |

**Record Rules:**

- **Grievance Category multi company** (Global) `R/W/C/D`
  - Domain:
    `         ['|',('company_id','=',False),'&',('company_id','in',company_ids),'|',('company_id','child_of',[user.company_id.id]),('company_id','in',user.company_ids.ids)]     `

### 🗃️ `grievance.root.cause` — Grievance Root Cause
...
| Name                                        | Group               | Perms     |
| ------------------------------------------- | ------------------- | --------- |
| access_grievance_root_cause_backofficeadmin | Grievance / Manager | `R/W/C/D` |
| access_grievance_root_cause_faculty         | Grievance / User    | `R`       |
