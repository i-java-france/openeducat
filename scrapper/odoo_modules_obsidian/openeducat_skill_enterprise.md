---
title: "OpenEduCat Student Skill Assessment"
...
> **Module:** `openeducat_skill_enterprise` | **Version:** `19.0.1.0` **Category:**
...
- `SIS/Configuration/Skill Assessment`
- `SIS/Configuration/Skill Assessment/Skill Assessment Template`
- `SIS/Configuration/Skill Assessment/Skill Levels`
- `SIS/Configuration/Skill Assessment/Skills`
- `SIS/Configuration/Skill Assessment/Skills Category`
- `SIS/Reporting/Skill Assessment`
- `SIS/Reporting/Skill Assessment/Skill Assessment Analysis`

### Views

- `* INHERIT op.student.form (form)`
- `* INHERIT student_portal_skills_information (qweb)`
- `op.skill.category.form (form)`
- `op.skill.category.list (list)`
- `op.skill.category.search (search)`
- `op.student.skill.assessment.form (form)`
- `op.student.skill.assessment.line.form (form)`
- `op.student.skill.assessment.line.list (list)`
- `op.student.skill.assessment.line.pivot (pivot)`
- `op.student.skill.assessment.line.search (search)`
- `op.student.skill.assessment.list (list)`
- `op.student.skill.assessment.pivot (pivot)`
- `op.student.skill.assessment.search (search)`
- `op.student.skill.form (form)`
- `op.student.skill.level.form (form)`
- `op.student.skill.level.list (list)`
- `op.student.skill.level.name.form (form)`
- `op.student.skill.level.name.list (list)`
- `op.student.skill.level.name.search (search)`
- `op.student.skill.level.search (search)`
- `op.student.skill.line.form (form)`
- `op.student.skill.line.list (list)`
- `op.student.skill.line.search (search)`
- `op.student.skill.list (list)`
- `op.student.skill.name.form (form)`
- `op.student.skill.name.list (list)`
- `op.student.skill.name.search (search)`
- `op.student.skill.search (search)`
- `op.student.skill.type.form (form)`
- `op.student.skill.type.list (list)`
- `op.student.skill.type.search (search)`
...
### 🗃️ `op.student.skill.assessment` — Student Skill Assessment
...
| `student_skill_assessment_line` | Skills                 | `one2many`  |     | ✅    | op.student.skill.assessment.line |
| `student_skill_type_id`         | Skill Assessment Type  | `many2one`  | ✅  | ✅    | op.student.skill.type            |
| `user_id`                       | Assessed By            | `many2one`  |     | ✅    | res.users                        |
| `website_message_ids`           | Website Messages       | `one2many`  |     | ✅    | mail.message                     |
| `write_date`                    | Last Updated on        | `datetime`  |     | ✅    |                                  |
| `write_uid`                     | Last Updated by        | `many2one`  |     | ✅    | res.users                        |
...
| Name                                       | Group           | Perms     |
| ------------------------------------------ | --------------- | --------- |
| access_op_student_skill_assessment         | Skill / Manager | `R/W/C/D` |
| access_op_student_skill_assessment_faculty | Skill / User    | `R/W/C`   |

**Record Rules:**

- **Student Skill Assessment multi-company** (Global) `R/W/C/D`
  - Domain:
    `['|',('student_id.company_id','=',False),'&',('student_id.company_id','in',company_ids),'|',('student_id.company_id','child_of',[user.company_id.id]),('student_id.company_id','in',user.company_ids.ids)]`

### 🗃️ `op.skill.category` — Skills Category Creation
...
| Name                             | Group           | Perms     |
| -------------------------------- | --------------- | --------- |
| access_op_skill_category         | Skill / Manager | `R/W/C/D` |
| access_op_skill_category_faculty | Skill / User    | `R/W/C`   |

**Record Rules:**

- **Skill Category multi-company** (Global) `R/W/C/D`
  - Domain:
    `['|',('company_id','=',False),'&',('company_id','in',company_ids),'|',('company_id','child_of',[user.company_id.id]),('company_id','in',user.company_ids.ids)]`

### 🗃️ `op.student.skill` — Student Skill
...
| `display_name`          | Display Name       | `char`     |     |       |                       |
| `id`                    | ID                 | `integer`  |     | ✅    |                       |
| `student_skill_name_id` | Name               | `many2one` | ✅  | ✅    | op.student.skill.name |
| `student_skill_type_id` | Student Skill Type | `many2one` |     | ✅    | op.student.skill.type |
| `write_date`            | Last Updated on    | `datetime` |     | ✅    |                       |
| `write_uid`             | Last Updated by    | `many2one` |     | ✅    | res.users             |
...
| Name                            | Group           | Perms     |
| ------------------------------- | --------------- | --------- |
| access_op_student_skill         | Skill / Manager | `R/W/C/D` |
| access_op_student_skill_faculty | Skill / User    | `R/W/C`   |

### 🗃️ `op.student.skill.assessment.line` — Student Skill Assessment
...
| `student_skill_assessment_id` | Student Skill Assessment | `many2one` |     | ✅    | op.student.skill.assessment |
| `student_skill_id`            | Student Skill            | `many2one` | ✅  | ✅    | op.student.skill            |
| `student_skill_level_id`      | Student Skill Level      | `many2one` |     | ✅    | op.student.skill.level      |
| `student_skill_type_id`       | Skill Assessment Type    | `many2one` |     | ✅    | op.student.skill.type       |
| `write_date`                  | Last Updated on          | `datetime` |     | ✅    |                             |
| `write_uid`                   | Last Updated by          | `many2one` |     | ✅    | res.users                   |
...
| Name                                            | Group           | Perms     |
| ----------------------------------------------- | --------------- | --------- |
| access_op_student_skill_assessment_line         | Skill / Manager | `R/W/C/D` |
| access_op_student_skill_assessment_line_faculty | Skill / User    | `R/W/C`   |

### 🗃️ `op.student.skill.level` — Student Skill Level
...
| `id`                          | ID                 | `integer`  |     | ✅    |                             |
| `progress`                    | Progress           | `integer`  |     |       |                             |
| `student_skill_level_name_id` | Name               | `many2one` |     | ✅    | op.student.skill.level.name |
| `student_skill_type_id`       | Student Skill Type | `many2one` |     | ✅    | op.student.skill.type       |
| `write_date`                  | Last Updated on    | `datetime` |     | ✅    |                             |
| `write_uid`                   | Last Updated by    | `many2one` |     | ✅    | res.users                   |
...
| Name                                  | Group           | Perms     |
| ------------------------------------- | --------------- | --------- |
| access_op_student_skill_level         | Skill / Manager | `R/W/C/D` |
| access_op_student_skill_level_faculty | Skill / User    | `R/W/C`   |

**Record Rules:**

- **Skill Level multi-company** (Global) `R/W/C/D`
  - Domain:
    `['|',('company_id','=',False),'&',('company_id','in',company_ids),'|',('company_id','child_of',[user.company_id.id]),('company_id','in',user.company_ids.ids)]`

### 🗃️ `op.student.skill.level.name` — Student Skill Level Name
...
| Name                                       | Group           | Perms     |
| ------------------------------------------ | --------------- | --------- |
| access_op_student_skill_level_name         | Skill / Manager | `R/W/C/D` |
| access_op_student_skill_level_name_faculty | Skill / User    | `R/W/C`   |

### 🗃️ `op.student.skill.line` — Student Skill Line
...
| `progress`               | Progress        | `integer`  |     |       |                        |
| `student_id`             | Student         | `many2one` |     | ✅    | op.student             |
| `student_skill_level_id` | Skill Level     | `many2one` | ✅  | ✅    | op.student.skill.level |
| `student_skills_id`      | Skills          | `many2one` | ✅  | ✅    | op.student.skill       |
| `student_skill_type_id`  | Skill Type      | `many2one` | ✅  | ✅    | op.student.skill.type  |
| `write_date`             | Last Updated on | `datetime` |     | ✅    |                        |
| `write_uid`              | Last Updated by | `many2one` |     | ✅    | res.users              |
...
| Name                                 | Group           | Perms     |
| ------------------------------------ | --------------- | --------- |
| access_op_student_skill_line         | Skill / Manager | `R/W/C/D` |
| access_op_student_skill_line_faculty | Skill / User    | `R/W/C`   |

### 🗃️ `op.student.skill.name` — Student Skill Name
...
| `id`                     | ID              | `integer`  |     | ✅    |                   |
| `name`                   | Name            | `char`     | ✅  | ✅    |                   |
| `self_assessed`          | Self Assessed   | `boolean`  |     | ✅    |                   |
| `skill_category_type_id` | Skill Type      | `many2one` | ✅  | ✅    | op.skill.category |
| `write_date`             | Last Updated on | `datetime` |     | ✅    |                   |
| `write_uid`              | Last Updated by | `many2one` |     | ✅    | res.users         |
...
| Name                                 | Group           | Perms     |
| ------------------------------------ | --------------- | --------- |
| access_op_student_skill_name         | Skill / Manager | `R/W/C/D` |
| access_op_student_skill_name_faculty | Skill / User    | `R/W/C`   |

**Record Rules:**

- **Student Skill Name multi-company** (Global) `R/W/C/D`
  - Domain:
    `['|',('skill_category_type_id.company_id','=',False),'&',('skill_category_type_id.company_id','in',company_ids),'|',('skill_category_type_id.company_id','child_of',[user.company_id.id]),('skill_category_type_id.company_id','in',user.company_ids.ids)]`

### 🗃️ `op.student.skill.type` — Student Skill Types
...
| `id`                       | ID                  | `integer`  |     | ✅    |                        |
| `name`                     | Name                | `char`     | ✅  | ✅    |                        |
| `student_skill_level_line` | Student Skill Level | `one2many` |     | ✅    | op.student.skill.level |
| `student_skills_line`      | Student Skills      | `one2many` |     | ✅    | op.student.skill       |
| `write_date`               | Last Updated on     | `datetime` |     | ✅    |                        |
| `write_uid`                | Last Updated by     | `many2one` |     | ✅    | res.users              |
...
| Name                                 | Group           | Perms     |
| ------------------------------------ | --------------- | --------- |
| access_op_student_skill_type         | Skill / Manager | `R/W/C/D` |
| access_op_student_skill_type_faculty | Skill / User    | `R/W/C`   |
