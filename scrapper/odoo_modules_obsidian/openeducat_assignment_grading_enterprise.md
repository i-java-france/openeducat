---
title: "OpenEduCat Assignment Grading Enterprise"
...
# 🟢 OpenEduCat Assignment Grading Enterprise

> **Module:** `openeducat_assignment_grading_enterprise` | **Version:** `19.0.1.0`
...
- `Assignments/Configuration/Assignment Grades`

### Views

- `* INHERIT Assignment Grades (qweb)`
- `* INHERIT op.assign.inherit.form (form)`
- `* INHERIT op.assign.inherit.list (list)`
- `* INHERIT op.assign.sub.line.inherit.form (form)`
- `* INHERIT op.assign.sub.line.inherit.list (list)`
- `op.assign.grade.config.form (form)`
- `op.assign.grade.config.list (list)`
...
### 🗃️ `op.assign.grade.config` — Grade Configuration
...
| Name                                  | Group                | Perms     |
| ------------------------------------- | -------------------- | --------- |
| access_op_assign_grade_config_manager | Assignment / Manager | `R/W/C/D` |
| access_op_assign_grade_config_user    | Assignment / User    | `R`       |

**Record Rules:**

- **Op Assign Grade Config Multi Comp Rule** (Global) `R/W/C/D`
  - Domain:
    ` ['|',('company_id','=',False),'&',('company_id','in',company_ids),'|',('company_id','child_of',[user.company_id.id]),('company_id','in',user.company_ids.ids)]`
