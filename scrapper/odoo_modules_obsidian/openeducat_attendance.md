...
> **Module:** `openeducat_attendance` | **Version:** `19.0.1.0` **Category:** Education
...
![](/openeducat_attendance/static/description/students-icon.svg)
...
![](/openeducat_attendance/static/description/faculties-icon.svg)
...
![](/openeducat_attendance/static/description/courses-icon%201.svg)
...
![](/openeducat_attendance/static/description/openeducat_admission.svg)
...
![](/openeducat_attendance/static/description/openeducat_exam.svg)
...
![](/openeducat_attendance/static/description/openeducat_account_financial_reports.svg)
...
![](/openeducat_attendance/static/description/openeducat_attendance.svg)
...
![](/openeducat_attendance/static/description/openeducat_library.svg)
...
![](/openeducat_attendance/static/description/lms-icon.svg)
...
![](/openeducat_attendance/static/description/openeducat_classroom.svg)
...
![Icon](/openeducat_attendance/static/description/openeducat_assignment.svg)

Assignment Allocation

![Icon](/openeducat_attendance/static/description/openeducat_exam.svg)

Exam Management

![Icon](/openeducat_attendance/static/description/fees.svg)

Fees Management

![](/openeducat_attendance/static/description/inventory.svg)

Inventory Management

![Icon](/openeducat_attendance/static/description/campus-icon.svg)

Campus Management

![Icon](/openeducat_attendance/static/description/notice-board-icon.svg)

Notice Board Enterprise

![Icon](/openeducat_attendance/static/description/grade-book-icon.svg)

Gradebook Management Enterprise

![Icon](/openeducat_attendance/static/description/assignment-annotation-icon.png)

Assignment Annotation Enterprise

![Icon](/openeducat_attendance/static/description/openeducat_alumni_enterprise.svg)

Alumni Management Enterprise

![Icon](/openeducat_attendance/static/description/transportation-icon.svg)

Transpotation Management Enterprise

![Icon](/openeducat_attendance/static/description/kpi-dashboard-icon.svg)

KPI Dashboards Enterprise

![](/openeducat_attendance/static/description/news.svg)
...
![](/openeducat_attendance/static/description/g2-img.svg)

![](/openeducat_attendance/static/description/sourceforge-img.svg)
...
### 🗃️ `op.attendance.type` — Attendance Type
...
| Name                                  | Group                | Perms     |
| ------------------------------------- | -------------------- | --------- |
| access_op_attendance_type_back_office | Attendance / Manager | `R/W/C/D` |
| access_op_attendance_type_faculty     | Attendance / User    | `R`       |

**Record Rules:**

- **attendance type multi comp rule** (Global) `R/W/C/D`
  - Domain:
...
### 🗃️ `report.openeducat_attendance.student_attendance_report` — Attendance Report
...
### 🗃️ `student.attendance` — Student Attendance
...
| Name                    | Group                | Perms     |
| ----------------------- | -------------------- | --------- |
| name_student_attendance | Attendance / Manager | `R/W/C/D` |
