...
> **Module:** `openeducat_core` | **Version:** `19.0.1.0` **Category:** Education |
> **License:** `LGPL-3` **Author:** OpenEduCat Inc **Website:**
> https://www.openeducat.org

## 🔗 Dependencies

[[board]] [[hr]] [[web]] [[website]] [[contacts]]

## 📖 Description

![](/openeducat_core/static/description/students-icon.svg)
...
![](/openeducat_core/static/description/faculties-icon.svg)
...
![](/openeducat_core/static/description/courses-icon%201.svg)
...
![](/openeducat_core/static/description/openeducat_admission.svg)
...
![](/openeducat_core/static/description/openeducat_exam.svg)
...
![](/openeducat_core/static/description/openeducat_account_financial_reports.svg)
...
![](/openeducat_core/static/description/openeducat_attendance.svg)
...
![](/openeducat_core/static/description/openeducat_library.svg)
...
![](/openeducat_core/static/description/lms-icon.svg)
...
![](/openeducat_core/static/description/openeducat_classroom.svg)
...
![Icon](/openeducat_core/static/description/openeducat_assignment.svg)

Assignment Allocation

![Icon](/openeducat_core/static/description/openeducat_exam.svg)

Exam Management

![Icon](/openeducat_core/static/description/fees.svg)

Fees Management

![](/openeducat_core/static/description/inventory.svg)

Inventory Management

![Icon](/openeducat_core/static/description/campus-icon.svg)

Campus Management

![Icon](/openeducat_core/static/description/notice-board-icon.svg)

Notice Board Enterprise

![Icon](/openeducat_core/static/description/grade-book-icon.svg)

Gradebook Management Enterprise

![Icon](/openeducat_core/static/description/assignment-annotation-icon.png)

Assignment Annotation Enterprise

![Icon](/openeducat_core/static/description/openeducat_alumni_enterprise.svg)

Alumni Management Enterprise

![Icon](/openeducat_core/static/description/transportation-icon.svg)

Transpotation Management Enterprise

![Icon](/openeducat_core/static/description/kpi-dashboard-icon.svg)

KPI Dashboards Enterprise

![](/openeducat_core/static/description/news.svg)
...
![](/openeducat_core/static/description/g2-img.svg)

![](/openeducat_core/static/description/sourceforge-img.svg)
...
- `SIS/Configuration/Program Management`
- `SIS/Configuration/Program Management/Program Level`
- `SIS/Configuration/Program Management/Programs`
...
- `Students/Configuration/Settings`
- `Students/General`
...
- `* INHERIT User portal (form)`
- `* INHERIT hr.employee.form.address.inherit (form)`
- `* INHERIT res.company.form.openeducat.core (form)`
- `* INHERIT res.config.settings.view.form.core (form)`
- `* INHERIT res.partner.form.inherit.title (form)`
- `* INHERIT res.user.form.openeducat.core (form)`
- `Faculty Kanban (kanban)`
- `Student Kanban (kanban)`
- `bonafide.certificate.wizard.form (form)`
- `op.academic.term.form (form)`
- `op.academic.term.list (list)`
- `op.academic.term.search (search)`
- `op.academic.year.form (form)`
- `op.academic.year.list (list)`
...
- `op.department.list (list)`
- `op.department.search (search)`
- `op.faculty.activity (activity)`
- `op.faculty.form (form)`
- `op.faculty.list (list)`
- `op.faculty.search (search)`
- `op.program.form (form)`
- `op.program.level,form (form)`
- `op.program.level.list (list)`
- `op.program.list (list)`
- `op.program.pivot (pivot)`
- `op.program.search (search)`
- `op.student.course.form (form)`
- `op.student.course.list (list)`
- `op.student.course.pivot (pivot)`
- `op.student.course.search (search)`
- `op.student.form (form)`
- `op.student.list (list)`
- `op.student.search (search)`
- `op.students.activity (activity)`
- `op.subject.form (form)`
- `op.subject.list (list)`
- `op.subject.registration.form (form)`
- `op.subject.registration.graph (graph)`
- `op.subject.registration.list (list)`
...
**25 model(s) defined by this module:**
...
### 🗃️ `op.program.level` — OpenEduCat Program level
...
| Name                                      | Group                | Perms     |
| ----------------------------------------- | -------------------- | --------- |
| access_op_program_level_back_office_admin | OpenEduCat / Manager | `R/W/C/D` |
| access_op_program_level_faculty           | OpenEduCat / User    | `R`       |
...
### 🗃️ `op.subject.registration` — Subject Registration Details
...
| `academic_plan_id`           | Academic Plan                  | `many2one`  |     | ✅    | op.academic.plan |
| `batch_id`                   | Batch                          | `many2one`  |     | ✅    | op.batch         |
| `cl_subject_ids`             | Cl Subject                     | `many2many` |     |       | op.subject       |
| `company_id`                 | Company                        | `many2one`  |     | ✅    | res.company      |
| `compulsory_subject_ids`     | Compulsory Subjects            | `many2many` |     | ✅    | op.subject       |
| `course_id`                  | Course                         | `many2one`  | ✅  | ✅    | op.course        |
| `create_date`                | Created on                     | `datetime`  |     | ✅    |                  |
| `create_uid`                 | Created by                     | `many2one`  |     | ✅    | res.users        |
| `display_name`               | Display Name                   | `char`      |     |       |                  |
| `elective_subject_ids`       | Elective Subjects              | `many2many` |     | ✅    | op.subject       |
| `el_subject_ids`             | El Subject                     | `many2many` |     |       | op.subject       |
| `has_message`                | Has Message                    | `boolean`   |     |       |                  |
| `id`                         | ID                             | `integer`   |     | ✅    |                  |
| `is_elective_select`         | Is Elective subject submitted? | `boolean`   |     | ✅    |                  |
...
| Name                                             | Group                | Perms     |
| ------------------------------------------------ | -------------------- | --------- |
| access_op_subject_registration_back_office_admin | OpenEduCat / Manager | `R/W/C/D` |
| access_op_subject_registration_faculty           | OpenEduCat / User    | `R/W/C`   |

**Record Rules:**

- **Student Subject Registration Rule** (93) `R/W/C/D`
  - Domain:
    `['|', ('student_id.user_id','=',user.id), ('student_id.user_id','in',             user.child_ids.ids)]         `
- **View Students Registration** (92) `R/W/C/D`
  - Domain: `[(1,'=',1)]`
- **Subject Registration Multi Company** (Global) `R/W/C/D`
  - Domain:
...
### 🗃️ `op.academic.term` — Academic Term
...
| `id`               | ID              | `integer`  |     | ✅    |                  |
| `name`             | Name            | `char`     | ✅  | ✅    |                  |
| `parent_term`      | Parent Term     | `many2one` |     | ✅    | op.academic.term |
| `term_end_date`    | End Date        | `date`     | ✅  | ✅    |                  |
| `term_start_date`  | Start Date      | `date`     | ✅  | ✅    |                  |
| `write_date`       | Last Updated on | `datetime` |     | ✅    |                  |
| `write_uid`        | Last Updated by | `many2one` |     | ✅    | res.users        |
...
| Name                                      | Group                | Perms     |
| ----------------------------------------- | -------------------- | --------- |
| access_op_academic_term_back_office_admin | OpenEduCat / Manager | `R/W/C/D` |
| access_op_academic_term_faculty           | OpenEduCat / User    | `R`       |

**Record Rules:**

- **Academic Term multi company** (Global) `R/W/C/D`
  - Domain:
    `             ['|','|',('company_id','=',False),('company_id','child_of',[user.company_id.id]),('company_id','in',user.company_ids.ids),('company_id',             'in', company_ids)]         `

### 🗃️ `op.academic.year` — Academic Year
...
| Field               | Label           | Type        | Req | Store | Relation         |
| ------------------- | --------------- | ----------- | --- | ----- | ---------------- |
| `academic_term_ids` | Academic Terms  | `one2many`  |     | ✅    | op.academic.term |
| `company_id`        | Company         | `many2one`  |     | ✅    | res.company      |
| `create_boolean`    | Create Boolean  | `boolean`   |     | ✅    |                  |
| `create_date`       | Created on      | `datetime`  |     | ✅    |                  |
| `create_uid`        | Created by      | `many2one`  |     | ✅    | res.users        |
| `display_name`      | Display Name    | `char`      |     |       |                  |
| `end_date`          | End Date        | `date`      | ✅  | ✅    |                  |
...
| `name`              | Name            | `char`      | ✅  | ✅    |                  |
| `start_date`        | Start Date      | `date`      | ✅  | ✅    |                  |
| `term_structure`    | Term Structure  | `selection` | ✅  | ✅    |                  |
| `write_date`        | Last Updated on | `datetime`  |     | ✅    |                  |
| `write_uid`         | Last Updated by | `many2one`  |     | ✅    | res.users        |
...
| Name                                      | Group                | Perms     |
| ----------------------------------------- | -------------------- | --------- |
| access_op_academic_year_back_office_admin | OpenEduCat / Manager | `R/W/C/D` |
| access_op_academic_year_faculty           | OpenEduCat / User    | `R`       |
| op_academic_year                          | Role / Portal        | `R`       |

**Record Rules:**

- **Academic Year multi company** (Global) `R/W/C/D`
  - Domain:
    `             ['|','|',('company_id','=',False),('company_id','child_of',[user.company_id.id]),('company_id','in',user.company_ids.ids),('company_id',             'in', company_ids)]         `

### 🗃️ `report.openeducat_core.report_student_bonafide` — Bonafide Certificate Report
...
### 🗃️ `bonafide.certificate.wizard` — Bonafide Certificate Wizard
...
| Field                 | Label               | Type        | Req | Store | Relation   |
| --------------------- | ------------------- | ----------- | --- | ----- | ---------- |
| `certificate_purpose` | Certificate Purpose | `selection` | ✅  | ✅    |            |
| `create_date`         | Created on          | `datetime`  |     | ✅    |            |
| `create_uid`          | Created by          | `many2one`  |     | ✅    | res.users  |
| `display_name`        | Display Name        | `char`      |     |       |            |
| `id`                  | ID                  | `integer`   |     | ✅    |            |
| `other_purpose`       | Other Purpose       | `char`      |     | ✅    |            |
...
| Name                                                 | Group                | Perms     |
| ---------------------------------------------------- | -------------------- | --------- |
| access_bonafide_certificate_wizard_back_office_admin | OpenEduCat / Manager | `R/W/C/D` |
| access_bonafide_certificate_wizard_faculty           | OpenEduCat / User    | `R/W/C`   |
...
### 🗃️ `wizard.op.faculty.employee` — Create Employee and User of Faculty
...
| `display_name` | Display Name              | `char`     |     |       |           |
| `id`           | ID                        | `integer`  |     | ✅    |           |
| `user_boolean` | Want to create user too ? | `boolean`  |     | ✅    |           |
| `write_date`   | Last Updated on           | `datetime` |     | ✅    |           |
| `write_uid`    | Last Updated by           | `many2one` |     | ✅    | res.users |
...
| Name                            | Group                | Perms     |
| ------------------------------- | -------------------- | --------- |
| name_wizard_op_faculty_employee | OpenEduCat / Manager | `R/W/C/D` |

### 🗃️ `wizard.op.faculty` — Create User for selected Faculty(s)
...
| Name                   | Group                | Perms     |
| ---------------------- | -------------------- | --------- |
| name_wizard_op_faculty | OpenEduCat / Manager | `R/W/C/D` |

### 🗃️ `wizard.op.student` — Create User for selected Student(s)
...
| Name                   | Group                | Perms     |
| ---------------------- | -------------------- | --------- |
| name_wizard_op_student | OpenEduCat / Manager | `R/W/C/D` |

### 🗃️ `op.category` — OpenEduCat Category
...
| Name                               | Group                | Perms     |
| ---------------------------------- | -------------------- | --------- |
| name_op_category_back_office_admin | OpenEduCat / Manager | `R/W/C/D` |
| name_op_category_faculty           | OpenEduCat / User    | `R/W/C`   |

**Record Rules:**

- **Category Multi Company** (Global) `R/W/C/D`
  - Domain:
    `             ['|','|',('company_id','=',False),('company_id','child_of',[user.company_id.id]),('company_id','in',user.company_ids.ids),('company_id',             'in', company_ids)]         `
...
### 🗃️ `res.partner.title` — Partner Title
...
| Name                      | Group                | Perms     |
| ------------------------- | -------------------- | --------- |
| res_partner_title_admin   | OpenEduCat / Manager | `R/W/C/D` |
| res_partner_title_faculty | OpenEduCat / User    | `R`       |
