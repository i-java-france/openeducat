---
title: "OpenEduCat Student Attendance Kiosk"
module: "openeducat_student_attendance_enterprise"
state: "installed"
version: "19.0.1.0"
...
> **Module:** `openeducat_student_attendance_enterprise` | **Version:** `19.0.1.0`
> **Category:** Tools | **License:** `Other proprietary` **Author:** OpenEduCat Inc
> **Website:** https://www.openeducat.org

## 🔗 Dependencies

[[openeducat_core]] [[openeducat_attendance_enterprise]] [[barcodes]]
...
[![](/openeducat_student_attendance_enterprise/static/description/openeducat_logo.png)](https://www.openeducat.org/demo)

Online Demo

This module aims to manage student's attendances.Keeps account of the attendances of the
students via kiosk mode and barcode scanner.

[Contact Us](https://www.openeducat.org/contactus/)

## Student Attendance via Kiosk Mode and Barcode Scanner

Students can sign-in in the attendance sheets via kiosk mode and barcode reader from
this interface directly.

![](/openeducat_student_attendance_enterprise/static/description/barcode_kiosk.png)

## Kiosk Mode

![](/openeducat_student_attendance_enterprise/static/description/kiosk.png)

Student can sign-in in the selected attendance sheet via kiosk mode.

## Barcode Scanner

Student can sign-in in the selected attendance sheet via barcode scanner.

![](/openeducat_student_attendance_enterprise/static/description/barcode.png)

## Attendance Sheet Line

![](/openeducat_student_attendance_enterprise/static/description/op_attendance_line.png)

Attendance sheet shows the list of students with present status taken via barcode
scanner and kiosk mode. You can find details for number of present and absent students
...
- `Class Attendances/Kiosk Mode`
- `Student Attendances`

### Views

- `* INHERIT op.attendance.sheet.inherited.form.kiosk (form)`
- `* INHERIT op.student (form)`
- `* INHERIT op.student.progression.form (form)`
- `* INHERIT student.attendance.form (form)`
- `* INHERIT student.attendance.list (list)`
- `* INHERIT student_attendance_badge (qweb)`
- `* INHERIT student_attendance_timesheet_portal (qweb)`
- `* INHERIT student_attendance_timesheet_progression_report (qweb)`
- `* INHERIT student_progression_timesheet_portal (qweb)`
- `op.student.kanban (kanban)`
- `report_student_attendance_summary (qweb)`
- `student.attendance.kanban (kanban)`
