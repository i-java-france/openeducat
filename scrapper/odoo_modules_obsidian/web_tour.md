...
> **Module:** `web_tour` | **Version:** `19.0.1.0` **Category:** Technical |
...
- `Settings/Technical/User Interface/Tours`

### Views

- `tour.search (search)`
- `web_tour.tour form (form)`
- `web_tour.tour list (list)`
...
| `id`                  | ID                  | `integer`   |     | ✅    |                    |
| `name`                | Name                | `char`      | ✅  | ✅    |                    |
| `rainbow_man_message` | Rainbow Man Message | `html`      |     | ✅    |                    |
| `sequence`            | Sequence            | `integer`   |     | ✅    |                    |
| `sharing_url`         | Sharing URL         | `char`      |     |       |                    |
| `step_ids`            | Step                | `one2many`  |     | ✅    | web_tour.tour.step |
| `url`                 | Starting URL        | `char`      |     | ✅    |                    |
| `user_consumed_ids`   | User Consumed       | `many2many` |     | ✅    | res.users          |
...
| Name                          | Group                | Perms     |
| ----------------------------- | -------------------- | --------- |
| access_web_tour_tour_admin    | Role / Administrator | `R/W/C/D` |
| access_web_tour_tour_readonly | Role / User          | `R`       |

### 🗃️ `web_tour.tour.step` — Tour's step
...
| `run`              | Run              | `char`      |     | ✅    |               |
| `sequence`         | Sequence         | `integer`   |     | ✅    |               |
| `tooltip_position` | Tooltip Position | `selection` |     | ✅    |               |
| `tour_id`          | Tour             | `many2one`  | ✅  | ✅    | web_tour.tour |
...
| Name                               | Group                | Perms     |
| ---------------------------------- | -------------------- | --------- |
| access_web_tour_tour_step_admin    | Role / Administrator | `R/W/C/D` |
| access_web_tour_tour_step_readonly | Role / User          | `R`       |
