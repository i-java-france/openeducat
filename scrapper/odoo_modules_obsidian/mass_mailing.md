...
application: true
auto_install: false
tags: [odoo/module, odoo/state/installed, odoo/category/_______________, odoo/app]
---

# 🟢 Email Marketing

> **Module:** `mass_mailing` | **Version:** `19.0.2.7` **Category:** Email Marketing |
> **License:** `LGPL-3` **Author:** Odoo S.A. **Website:**
> https://www.odoo.com/app/email-marketing

## 🔗 Dependencies

[[contacts]] [[mail]] [[html_builder]] [[utm]] [[link_tracker]] [[social_media]]
[[web_tour]] [[digest]]
...
Easily send mass mailing to your leads, opportunities or customers with Odoo
<a href="<https://www.odoo.com/app/email-marketing>">Email Marketing</a>. Track
marketing campaigns performance to improve conversion rates. Design professional emails
and reuse templates in a few clicks.

# Send Professional Emails

Import database of prospects or filter on existing leads, opportunities and customers in
just a few clicks.

Define email templates to reuse content or specific design for your newsletter. Setup
several email servers with their own IP/domain to optimise opening rates.

# Organize Marketing Campaigns

Design, Send, Track by Campaigns with our
<a href="<https://www.odoo.com/app/email-marketing>">Lead Automation</a> app.

Get real time statistics on campaigns performance to improve your conversion rate. Track
mails sent, received, opened and answered.

Easily manage your marketing campaigns, discussion groups, leads and opportunities in
one simple and powerful platform.

# Integrated with Odoo Apps

Get access to mass mailing features from every Odoo app to improve the way your users
communicate.

Send template of emails from Odoo
<a href="<https://www.odoo.com/app/email-marketing>">CRM opportunities</a>, select leads
based on marketing segments, send <a href="<https://www.odoo.com/app/recruitment>">job
offers</a> and automate answers to applicants, reuse email template in the lead
...
Get a clean lead database that improves over the time using the performance of your
mails. Odoo handle bounce mails efficiently, flag erroneous leads accordingly and gives
you statistics on the quality of your leads.

# One click emails send

The marketing department will love working on campaigns. But you can also give a one
click mass mailing facility to all others users on their own prospects or documents.

Select a few documents (e.g. leads, support tickets, suppliers, applicants, ...) and
send emails to their contacts in one click, reusing existing emails templates.

# Follow-up On Answers

The chatter feature enables you to communicate faster and more efficiently with your
customer. Get documents created automatically (leads, opportunities, tasks, ...) based
on answers to your mass mailing campaigns Follow the discussion directly on the business
documents within Odoo or via email.

Get all the negotiations and discussions attached to the right document and relevent
managers notified on specific events.

# Campaigns Dashboard

Get the insights you need to make smarter marketing campaign. Track statistics per
campaign: bounce rates, sent mails, best content, etc. The clear dashboards gives you a
direct overview of your campaign performance.
...
Manage your <a href="<https://www.odoo.com/app/crm>">sales funnel</a> with no effort.
Attract leads, follow-up on phone calls and meetings. Analyse the quality of your leads
to make informed decisions and save time by integrating emails directly into the
application.
...
- `Email Marketing/Reporting/Opt-Out Report`
- `Settings/Technical/Mass Mailing`
- `Settings/Technical/Mass Mailing/Mailing Traces`
...
- `Button (qweb)`
- `CTA Badge (qweb)`
- `Call To Action Card (qweb)`
- `Call To Action with Centered Text (qweb)`
- `Call To Action with Text (qweb)`
- `Call to Action (qweb)`
- `Card with Text (qweb)`
- `Centered Logo (qweb)`
- `Columns (qweb)`
- `Company Logo with Dates and Issues (qweb)`
- `Company Name and Log In Button (qweb)`
- `Company Name and Menu (qweb)`
- `Comparisons (qweb)`
- `Contact and Schedule (qweb)`
- `Content card (qweb)`
- `Content card (qweb)`
- `Content card (qweb)`
- `Content card (qweb)`
...
- `Cover (qweb)`
- `Customer Quote (qweb)`
- `Customers Testimonials (qweb)`
- `Event (qweb)`
- `Feature Showcase with Image (qweb)`
- `Features Column (qweb)`
- `Features Grid (qweb)`
- `Horizontal Attributes (qweb)`
- `Icon (qweb)`
- `Image (qweb)`
- `Image - Text (qweb)`
- `Items (qweb)`
...
- `Left Text (qweb)`
- `Link List (qweb)`
- `Logo + Inline Menu (qweb)`
- `Logo + Stacked Menu (qweb)`
...
- `Media List (qweb)`
- `Membership Advertisement (qweb)`
- `Need Help? (qweb)`
- `Numbers (qweb)`
- `Picture (qweb)`
- `Pricelist Boxed (qweb)`
- `Product Description (qweb)`
- `Product Showcase (qweb)`
- `Promo Code (qweb)`
- `Rating (qweb)`
- `References (qweb)`
...
- `Schedule (qweb)`
- `Separator (qweb)`
- `Separator Title (qweb)`
- `Showcase (qweb)`
- `Snippet Group (qweb)`
- `Social + Footer (qweb)`
- `Social + Footer (qweb)`
- `Social + Footer + Separator (qweb)`
- `Social + Logo (qweb)`
- `Special Offer CTA (qweb)`
- `Subtitle (qweb)`
- `Team (qweb)`
- `Team Shapes (qweb)`
- `Text (qweb)`
...
- `Text Highlight (qweb)`
- `Title (qweb)`
- `Title with Side Text (qweb)`
- `Unsubscribe (qweb)`
- `Video (qweb)`
- `View Online (qweb)`
- `View in Browser (qweb)`
- `email_designer_snippets (qweb)`
- `email_designer_themes (qweb)`
...
- `mailing.subscription.optout.view.list (list)`
- `mailing.subscription.optout.view.search (search)`
- `mailing.subscription.view.form (form)`
- `mailing.subscription.view.graph (graph)`
- `mailing.subscription.view.list (list)`
- `mailing.subscription.view.pivot (pivot)`
- `mailing.subscription.view.search (search)`
- `mailing.trace.report.view.graph (graph)`
- `mailing.trace.report.view.list (list)`
- `mailing.trace.report.view.pivot (pivot)`
- `mailing.trace.report.view.search (search)`
- `mailing.trace.view.form (form)`
- `mailing.trace.view.list (list)`
- `mailing.trace.view.list.mail (list)`
- `mailing.trace.view.search (search)`
- `mass_mailing.preview_content_mobile (qweb)`
- `mass_mailing_mail_layout (qweb)`
- `page_mailing_confirm_unsubscribe (qweb)`
- `page_mailing_has_unsubscribed (qweb)`
- `s_mail_block_header_logo_and_button (qweb)`
- `s_mail_block_header_menu (qweb)`
...
**30 model(s) defined by this module:**
...
### 🗃️ `mailing.contact` — Mailing Contact

> 📧 Mail Thread

Model of a contact. This model is different from the partner model because it holds only
some basic information: name, email. The purpose is to be able to deal with large
contact list to email without bloating the partner base.
...
| `list_ids`                      | Mailing Lists              | `many2many`  |     | ✅    | mailing.list               |
| `message_attachment_count`      | Attachment Count           | `integer`    |     |       |                            |
| `message_bounce`                | Bounce                     | `integer`    |     | ✅    |                            |
| `message_follower_ids`          | Followers                  | `one2many`   |     | ✅    | mail.followers             |
| `message_has_error`             | Message Delivery error     | `boolean`    |     |       |                            |
...
| `message_partner_ids`           | Followers (Partners)       | `many2many`  |     |       | res.partner                |
| `name`                          | Name                       | `char`       |     | ✅    |                            |
| `opt_out`                       | Opt Out                    | `boolean`    |     |       |                            |
| `properties`                    | Properties                 | `properties` |     | ✅    |                            |
| `properties_base_definition_id` | Properties Base Definition | `many2one`   |     |       | properties.base.definition |
| `rating_ids`                    | Ratings                    | `one2many`   |     | ✅    | rating.rating              |
| `subscription_ids`              | Subscription Information   | `one2many`   |     | ✅    | mailing.subscription       |
...
| Name                           | Group                  | Perms     |
| ------------------------------ | ---------------------- | --------- |
| access.mailing.contact.mm.user | Email Marketing / User | `R/W/C/D` |
...
### 🗃️ `mailing.contact.to.list` — Add Contacts to Mailing List
...
| Field             | Label           | Type        | Req | Store | Relation        |
| ----------------- | --------------- | ----------- | --- | ----- | --------------- |
| `contact_ids`     | Contacts        | `many2many` |     | ✅    | mailing.contact |
| `create_date`     | Created on      | `datetime`  |     | ✅    |                 |
| `create_uid`      | Created by      | `many2one`  |     | ✅    | res.users       |
| `display_name`    | Display Name    | `char`      |     |       |                 |
| `id`              | ID              | `integer`   |     | ✅    |                 |
| `mailing_list_id` | Mailing List    | `many2one`  | ✅  | ✅    | mailing.list    |
| `write_date`      | Last Updated on | `datetime`  |     | ✅    |                 |
| `write_uid`       | Last Updated by | `many2one`  |     | ✅    | res.users       |
...
| Name                           | Group                  | Perms     |
| ------------------------------ | ---------------------- | --------- |
| access.mailing.contact.to.list | Email Marketing / User | `R/W/C/D` |
...
### 🗃️ `mailing.contact.import` — Mailing Contact Import
...
| Field              | Label           | Type        | Req | Store | Relation     |
| ------------------ | --------------- | ----------- | --- | ----- | ------------ |
| `contact_list`     | Contact List    | `text`      |     | ✅    |              |
| `create_date`      | Created on      | `datetime`  |     | ✅    |              |
| `create_uid`       | Created by      | `many2one`  |     | ✅    | res.users    |
| `display_name`     | Display Name    | `char`      |     |       |              |
| `id`               | ID              | `integer`   |     | ✅    |              |
| `mailing_list_ids` | Lists           | `many2many` |     | ✅    | mailing.list |
| `write_date`       | Last Updated on | `datetime`  |     | ✅    |              |
| `write_uid`        | Last Updated by | `many2one`  |     | ✅    | res.users    |
...
| Name                                       | Group                  | Perms     |
| ------------------------------------------ | ---------------------- | --------- |
| access.mailing.contact.import.mailing.user | Email Marketing / User | `R/W/C/D` |

### 🗃️ `mailing.filter` — Mailing Favorite Filters

This model stores mass mailing or marketing campaign domain as filters (quite similar to
'ir.filters' but dedicated to mailing apps). Frequently used domains can be reused
easily.
...
| -------------------- | --------------------- | ---------- | --- | ----- | --------- |
| `create_date`        | Created on            | `datetime` |     | ✅    |           |
| `create_uid`         | Saved by              | `many2one` |     | ✅    | res.users |
| `display_name`       | Display Name          | `char`     |     |       |           |
| `id`                 | ID                    | `integer`  |     | ✅    |           |
| `mailing_domain`     | Filter Domain         | `char`     | ✅  | ✅    |           |
| `mailing_model_id`   | Recipients Model      | `many2one` | ✅  | ✅    | ir.model  |
| `mailing_model_name` | Recipients Model Name | `char`     |     |       |           |
| `name`               | Filter Name           | `char`     | ✅  | ✅    |           |
| `write_date`         | Last Updated on       | `datetime` |     | ✅    |           |
| `write_uid`          | Last Updated by       | `many2one` |     | ✅    | res.users |
...
| Name                               | Group                  | Perms     |
| ---------------------------------- | ---------------------- | --------- |
| access.mailing.filter.mailing.user | Email Marketing / User | `R/W/C/D` |

### 🗃️ `mailing.list` — Mailing List
...
| --------------------------- | ------------------------- | ----------- | --- | ----- | -------------------- |
| `active`                    | Active                    | `boolean`   |     | ✅    |                      |
| `contact_count`             | Number of Contacts        | `integer`   |     |       |                      |
| `contact_count_blacklisted` | Number of Blacklisted     | `integer`   |     |       |                      |
| `contact_count_email`       | Number of Emails          | `integer`   |     |       |                      |
| `contact_count_opt_out`     | Number of Opted-out       | `integer`   |     |       |                      |
| `contact_ids`               | Mailing Lists             | `many2many` |     | ✅    | mailing.contact      |
| `contact_pct_blacklisted`   | Percentage of Blacklisted | `float`     |     |       |                      |
| `contact_pct_bounce`        | Percentage of Bouncing    | `float`     |     |       |                      |
| `contact_pct_opt_out`       | Percentage of Opted-out   | `float`     |     |       |                      |
| `create_date`               | Created on                | `datetime`  |     | ✅    |                      |
| `create_uid`                | Created by                | `many2one`  |     | ✅    | res.users            |
| `display_name`              | Display Name              | `char`      |     |       |                      |
| `id`                        | ID                        | `integer`   |     | ✅    |                      |
| `is_public`                 | Show In Preferences       | `boolean`   |     | ✅    |                      |
| `mailing_count`             | Number of Mailing         | `integer`   |     |       |                      |
| `mailing_ids`               | Mass Mailings             | `many2many` |     | ✅    | mailing.mailing      |
| `name`                      | Mailing List              | `char`      | ✅  | ✅    |                      |
| `subscription_ids`          | Subscription Information  | `one2many`  |     | ✅    | mailing.subscription |
| `write_date`                | Last Updated on           | `datetime`  |     | ✅    |                      |
| `write_uid`                 | Last Updated by           | `many2one`  |     | ✅    | res.users            |
...
| Name                                 | Group                         | Perms     |
| ------------------------------------ | ----------------------------- | --------- |
| access.mailing.list.mm.user          | Email Marketing / User        | `R/W/C/D` |
| access_mailing_list_website_designer | Website / Editor and Designer | `R`       |

### 🗃️ `mailing.subscription` — Mailing List Subscription

Intermediate model between mass mailing list and mass mailing contact Indicates if a
contact is opted out for a particular list

**Fields:**

| Field               | Label               | Type       | Req | Store | Relation                    |
| ------------------- | ------------------- | ---------- | --- | ----- | --------------------------- |
| `contact_id`        | Contact             | `many2one` | ✅  | ✅    | mailing.contact             |
| `create_date`       | Created on          | `datetime` |     | ✅    |                             |
| `create_uid`        | Created by          | `many2one` |     | ✅    | res.users                   |
| `display_name`      | Display Name        | `char`     |     |       |                             |
| `id`                | ID                  | `integer`  |     | ✅    |                             |
| `is_blacklisted`    | Blacklist           | `boolean`  |     |       |                             |
| `list_id`           | Mailing List        | `many2one` | ✅  | ✅    | mailing.list                |
| `message_bounce`    | Bounce              | `integer`  |     |       |                             |
| `opt_out`           | Opt Out             | `boolean`  |     | ✅    |                             |
| `opt_out_datetime`  | Unsubscription Date | `datetime` |     | ✅    |                             |
| `opt_out_reason_id` | Reason              | `many2one` |     | ✅    | mailing.subscription.optout |
| `write_date`        | Last Updated on     | `datetime` |     | ✅    |                             |
| `write_uid`         | Last Updated by     | `many2one` |     | ✅    | res.users                   |
...
| Name                                | Group                  | Perms     |
| ----------------------------------- | ---------------------- | --------- |
| access.mailing.subscription.mm.user | Email Marketing / User | `R/W/C/D` |
...
### 🗃️ `mailing.subscription.optout` — Mailing Subscription Reason
...
| Name                                       | Group                  | Perms     |
| ------------------------------------------ | ---------------------- | --------- |
| access.mailing.subscription.optout.mm.user | Email Marketing / User | `R/W/C/D` |
...
### 🗃️ `mailing.trace.report` — Mass Mailing Statistics
...
| ---------------- | ---------------- | ----------- | --- | ----- | -------- |
| `bounced`        | Bounced          | `integer`   |     | ✅    |          |
| `campaign`       | Mailing Campaign | `char`      |     | ✅    |          |
| `canceled`       | Canceled         | `integer`   |     | ✅    |          |
| `clicked`        | Clicked          | `integer`   |     | ✅    |          |
| `delivered`      | Delivered        | `integer`   |     | ✅    |          |
| `display_name`   | Display Name     | `char`      |     |       |          |
...
| `error`          | Error            | `integer`   |     | ✅    |          |
| `id`             | ID               | `integer`   |     | ✅    |          |
| `mailing_type`   | Type             | `selection` | ✅  | ✅    |          |
| `name`           | Mass Mail        | `char`      |     | ✅    |          |
| `opened`         | Opened           | `integer`   |     | ✅    |          |
| `pending`        | Pending          | `integer`   |     | ✅    |          |
| `processing`     | Processing       | `integer`   |     | ✅    |          |
| `replied`        | Replied          | `integer`   |     | ✅    |          |
| `scheduled`      | Scheduled        | `integer`   |     | ✅    |          |
...
| Name                                | Group                  | Perms |
| ----------------------------------- | ---------------------- | ----- |
| access.mailing.trace.report.mm.user | Email Marketing / User | `R`   |

### 🗃️ `mailing.list.merge` — Merge Mass Mailing List
...
| Field               | Label                        | Type        | Req | Store | Relation     |
| ------------------- | ---------------------------- | ----------- | --- | ----- | ------------ |
| `archive_src_lists` | Archive source mailing lists | `boolean`   |     | ✅    |              |
| `create_date`       | Created on                   | `datetime`  |     | ✅    |              |
| `create_uid`        | Created by                   | `many2one`  |     | ✅    | res.users    |
| `dest_list_id`      | Destination Mailing List     | `many2one`  |     | ✅    | mailing.list |
| `display_name`      | Display Name                 | `char`      |     |       |              |
| `id`                | ID                           | `integer`   |     | ✅    |              |
| `merge_options`     | Merge Option                 | `selection` | ✅  | ✅    |              |
| `new_list_name`     | New Mailing List Name        | `char`      |     | ✅    |              |
| `src_list_ids`      | Mailing Lists                | `many2many` |     | ✅    | mailing.list |
| `write_date`        | Last Updated on              | `datetime`  |     | ✅    |              |
| `write_uid`         | Last Updated by              | `many2one`  |     | ✅    | res.users    |
...
| Name                      | Group                  | Perms   |
| ------------------------- | ---------------------- | ------- |
| access.mailing.list.merge | Email Marketing / User | `R/W/C` |
...
### 🗃️ `mailing.mailing.test` — Sample Mail Wizard
...
| Name                        | Group                  | Perms   |
| --------------------------- | ---------------------- | ------- |
| access.mailing.mailing.test | Email Marketing / User | `R/W/C` |

### 🗃️ `mailing.mailing.schedule.date` — schedule a mailing
...
| Name                         | Group                  | Perms     |
| ---------------------------- | ---------------------- | --------- |
| access.mailing.schedule.date | Email Marketing / User | `R/W/C/D` |
