---
title: "OpenEduCat Discipline"
module: "openeducat_discipline"
state: "installed"
version: "19.0.1.0"
...
# 🟢 OpenEduCat Discipline

> **Module:** `openeducat_discipline` | **Version:** `19.0.1.0` **Category:** Education
> | **License:** `Other proprietary` **Author:** OpenEduCat Inc **Website:**
> https://www.openeducat.org

## 🔗 Dependencies

[[account]] [[product]] [[openeducat_core_enterprise]]
...
[![](/openeducat_discipline/static/description/openeducat_logo.png)](https://www.openeducat.org/demo)
...
## Discipline Record Information At Your Click

![](/openeducat_discipline/static/description/discipline_record.png)

Openeducat provides the facility of discipline records in which all the records of the
student misbehaviour are listed and the action can be taken against the student
misbehaviour by either suspending the student or by taking fine from them.

## Suspended Students Information At Your Click

Openeducat provides the facility of Suspended Students Record in which all the records
of the Suspended student are listed and you can create new record for Suspending
Student.

![](/openeducat_discipline/static/description/suspended_students_record.png)
...
- `SIS/Configuration/Discipline`
- `SIS/Configuration/Discipline/Elearning Rules`
- `SIS/Configuration/Discipline/Misbehaviour Categories`
- `SIS/Configuration/Discipline/School Offences`
- `SIS/General/Discipline`
- `SIS/General/Discipline/Discipline Records`
- `SIS/General/Discipline/Suspended Students`
- `SIS/Reporting/Discipline`
- `SIS/Reporting/Discipline/Misbehaviour Type Wise`
- `SIS/Reporting/Discipline/Student Wise`

### Views

- `* INHERIT Forum Layout (qweb)`
- `* INHERIT Portal layout : Student apology form (qweb)`
- `* INHERIT Student Progression Discipline Form (form)`
- `* INHERIT Student Progression discipline list (list)`
- `* INHERIT op.student.form (form)`
- `* INHERIT student_descipline_progression_report (qweb)`
- `* INHERIT student_portal_discipline (qweb)`
- `* INHERIT student_progression_discipline_portal_inherit (qweb)`
- `Discipline Progress Wizard (form)`
- `elearning.rules.form (form)`
- `elearning.rules.list (list)`
- `elearning.rules.search (search)`
- `misbehaviour.type.form (form)`
- `misbehaviour_type_report (qweb)`
- `op.discipline.form (form)`
- `op.discipline.graph (graph)`
- `op.discipline.list (list)`
- `op.discipline.pivot (pivot)`
- `op.discipline.record.calendar.view (calendar)`
- `op.discipline.search (search)`
- `op.misbehaviour.category.form (form)`
- `op.misbehaviour.category.list (list)`
- `op.misbehaviour.category.search (search)`
- `portal_student_submit_letter (qweb)`
- `school.offences.form (form)`
- `school.offences.list (list)`
- `school.offences.search (search)`
- `student.wise.form (form)`
- `student_wise_report (qweb)`
- `suspended.student.form (form)`
- `suspended.student.list (list)`
...
### 🗃️ `op.discipline` — Discipline Record Details
...
| `date`                       | Date                                                | `date`      |     | ✅    |                          |
| `demerit_points`             | Demerit Points                                      | `float`     |     | ✅    |                          |
| `discipline_master`          | Created By                                          | `many2one`  |     | ✅    | res.users                |
| `display_name`               | Display Name                                        | `char`      |     |       |                          |
| `has_message`                | Has Message                                         | `boolean`   |     |       |                          |
| `id`                         | ID                                                  | `integer`   |     | ✅    |                          |
| `is_submit`                  | Is Submit                                           | `boolean`   |     | ✅    |                          |
| `master_comment`             | Comment By Discipline Master                        | `text`      |     | ✅    |                          |
| `meeting_datetime`           | Meeting Date Time                                   | `datetime`  | ✅  | ✅    |                          |
| `meeting_remark`             | Remark For Meeting                                  | `text`      |     | ✅    |                          |
| `merit_points`               | Merit Points                                        | `float`     |     | ✅    |                          |
...
| `misbehaviour_action`        | Action To Be Taken                                  | `char`      | ✅  | ✅    |                          |
| `misbehaviour_category_id`   | Misbehaviour Category                               | `many2one`  | ✅  | ✅    | op.misbehaviour.category |
| `misbehaviour_type`          | Misbehaviour Type                                   | `selection` | ✅  | ✅    |                          |
| `note`                       | Note                                                | `text`      |     | ✅    |                          |
| `parent_comment`             | Comment By Discipline Master (Meeting With Parents) | `text`      |     | ✅    |                          |
| `priority`                   | Priority                                            | `selection` |     | ✅    |                          |
| `progression_id`             | Progression No                                      | `many2one`  |     | ✅    | op.student.progression   |
| `rating_ids`                 | Ratings                                             | `one2many`  |     | ✅    | rating.rating            |
| `recipients_ids`             | Recipients                                          | `many2many` | ✅  | ✅    | res.partner              |
...
| Name                                 | Group                | Perms     |
| ------------------------------------ | -------------------- | --------- |
| access_op_discipline_backofficeadmin | Discipline / Manager | `R/W/C/D` |
| access_op_discipline_faculty         | Discipline / User    | `R/W/C`   |

**Record Rules:**

- **discipline record multi-company** (Global) `R/W/C/D`
  - Domain:
...
### 🗃️ `discipline.progress.wizard` — Discipline Progress Wizard
...
| `create_date`    | Created on      | `datetime`  |     | ✅    |               |
| `create_uid`     | Created by      | `many2one`  |     | ✅    | res.users     |
| `discipline_ids` | Discipline      | `many2many` |     | ✅    | op.discipline |
| `display_name`   | Display Name    | `char`      |     |       |               |
| `id`             | ID              | `integer`   |     | ✅    |               |
...
| Name                                      | Group                | Perms     |
| ----------------------------------------- | -------------------- | --------- |
| access_discipline_progress_wizard         | Discipline / Manager | `R/W/C/D` |
| access_discipline_progress_wizard_faculty | Discipline / User    | `R/W/C`   |

### 🗃️ `elearning.rules` — Elearning Rules Details
...
| `id`           | ID                 | `integer`  |     | ✅    |             |
| `name`         | Rules              | `text`     | ✅  | ✅    |             |
| `rules_action` | Action To Be Taken | `text`     | ✅  | ✅    |             |
| `write_date`   | Last Updated on    | `datetime` |     | ✅    |             |
| `write_uid`    | Last Updated by    | `many2one` |     | ✅    | res.users   |
...
| Name                                   | Group                | Perms     |
| -------------------------------------- | -------------------- | --------- |
| access_elearning_rules_backofficeadmin | Discipline / Manager | `R/W/C/D` |
| access_elearning_rules_student         | Discipline / Manager | `R/W/C/D` |

**Record Rules:**

- **elearning rule multi-company** (Global) `R/W/C/D`
  - Domain:
    `             ['|',('company_id','=',False),'&',('company_id','in',company_ids),'|',('company_id','child_of',[user.company_id.id]),('company_id','in',user.company_ids.ids)]         `
...
### 🗃️ `op.misbehaviour.category` — Misbehaviour Category Details
...
| -------------------------- | --------------------- | ----------- | --- | ----- | ------------------------ |
| `active`                   | Active                | `boolean`   |     | ✅    |                          |
| `child_id`                 | Child Categories      | `one2many`  |     | ✅    | op.misbehaviour.category |
| `company_id`               | Company               | `many2one`  | ✅  | ✅    | res.company              |
| `complete_name`            | Complete Name         | `char`      |     | ✅    |                          |
| `create_date`              | Created on            | `datetime`  |     | ✅    |                          |
| `create_uid`               | Created by            | `many2one`  |     | ✅    | res.users                |
| `display_name`             | Display Name          | `char`      |     |       |                          |
| `id`                       | ID                    | `integer`   |     | ✅    |                          |
| `misbehaviour_template_id` | Misbehaviour Template | `many2one`  | ✅  | ✅    | mail.template            |
| `misbehaviour_type`        | Category Type         | `selection` | ✅  | ✅    |                          |
| `name`                     | Name                  | `char`      | ✅  | ✅    |                          |
| `parent_id`                | Parent Category       | `many2one`  |     | ✅    | op.misbehaviour.category |
...
| Name                                            | Group                | Perms     |
| ----------------------------------------------- | -------------------- | --------- |
| access_op_misbehaviour_category_backofficeadmin | Discipline / Manager | `R/W/C/D` |
| access_op_misbehaviour_category_faculty         | Discipline / User    | `R/W/C`   |

**Record Rules:**

- **misbehaviour category multi-company** (Global) `R/W/C/D`
  - Domain:
    `             ['|',('company_id','=',False),'&',('company_id','in',company_ids),'|',('company_id','child_of',[user.company_id.id]),('company_id','in',user.company_ids.ids)]         `

### 🗃️ `misbehaviour.type` — Misbehaviour Type
...
| Name                          | Group                | Perms     |
| ----------------------------- | -------------------- | --------- |
| access_misbehaviour_type      | Discipline / Manager | `R/W/C/D` |
| access_misbehaviour_type_user | Discipline / User    | `R/W/C`   |

### 🗃️ `report.openeducat_discipline.misbehaviour_type_report` — Misbehaviour Type Report
...
### 🗃️ `school.offences` — School Offences Details
...
| `id`            | ID              | `integer`   |     | ✅    |             |
| `name`          | Name            | `text`      | ✅  | ✅    |             |
| `offences_type` | Offences Type   | `selection` | ✅  | ✅    |             |
| `write_date`    | Last Updated on | `datetime`  |     | ✅    |             |
| `write_uid`     | Last Updated by | `many2one`  |     | ✅    | res.users   |
...
| Name                                   | Group                | Perms     |
| -------------------------------------- | -------------------- | --------- |
| access_school_offences_backofficeadmin | Discipline / Manager | `R/W/C/D` |
| access_school_offences_student         | Discipline / Manager | `R/W/C/D` |

**Record Rules:**

- **school offences multi-company** (Global) `R/W/C/D`
  - Domain:
    `             ['|',('company_id','=',False),'&',('company_id','in',company_ids),'|',('company_id','child_of',[user.company_id.id]),('company_id','in',user.company_ids.ids)]         `

### 🗃️ `student.wise` — Student Wise
...
| Name                     | Group                | Perms     |
| ------------------------ | -------------------- | --------- |
| access_student_wise      | Discipline / Manager | `R/W/C/D` |
| access_student_wise_user | Discipline / User    | `R/W/C`   |

### 🗃️ `report.openeducat_discipline.student_wise_report` — Student Wise Report
...
### 🗃️ `suspended.student` — Suspended Student Details
...
| `create_date`              | Created on            | `datetime` |     | ✅    |                          |
| `create_uid`               | Created by            | `many2one` |     | ✅    | res.users                |
| `discipline_id`            | Discipline Id         | `many2one` |     | ✅    | op.discipline            |
| `display_name`             | Display Name          | `char`     |     |       |                          |
| `id`                       | ID                    | `integer`  |     | ✅    |                          |
| `misbehaviour_category_id` | Misbehaviour Category | `many2one` | ✅  | ✅    | op.misbehaviour.category |
| `student_id`               | Student Name          | `many2one` | ✅  | ✅    | op.student               |
| `suspend_from_date`        | Suspend From Date     | `date`     | ✅  | ✅    |                          |
| `suspend_to_date`          | Suspend To Date       | `date`     | ✅  | ✅    |                          |
| `write_date`               | Last Updated on       | `datetime` |     | ✅    |                          |
| `write_uid`                | Last Updated by       | `many2one` |     | ✅    | res.users                |
...
| Name                                     | Group                | Perms     |
| ---------------------------------------- | -------------------- | --------- |
| access_suspended_student_backofficeadmin | Discipline / Manager | `R/W/C/D` |
| access_suspended_student_backofficeuser  | Discipline / User    | `R/W/C`   |

**Record Rules:**

- **suspended student record multi-company** (Global) `R/W/C/D`
  - Domain:
    `             ['|',('company_id','=',False),'&',('company_id','in',company_ids),'|',('company_id','child_of',[user.company_id.id]),('company_id','in',user.company_ids.ids)]         `

### 🗃️ `take.action` — Take Action Based on Misbehaviour
...
| Field               | Label             | Type       | Req | Store | Relation      |
| ------------------- | ----------------- | ---------- | --- | ----- | ------------- |
| `action_remark`     | Remark            | `text`     |     | ✅    |               |
| `create_date`       | Created on        | `datetime` |     | ✅    |               |
| `create_uid`        | Created by        | `many2one` |     | ✅    | res.users     |
| `discipline_id`     | Discipline Record | `many2one` |     | ✅    | op.discipline |
| `display_name`      | Display Name      | `char`     |     |       |               |
| `fine`              | Fine              | `boolean`  |     | ✅    |               |
| `fine_amount`       | Fine Amount       | `integer`  |     | ✅    |               |
| `id`                | ID                | `integer`  |     | ✅    |               |
...
| Name               | Group                | Perms     |
| ------------------ | -------------------- | --------- |
| access_take_action | Discipline / Manager | `R/W/C/D` |
