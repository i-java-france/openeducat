...
> **Module:** `hr_recruitment` | **Version:** `19.0.1.1` **Category:** Recruitment |
> **License:** `LGPL-3` **Author:** Odoo S.A. **Website:**
> https://www.odoo.com/app/recruitment

## 🔗 Dependencies

[[hr]] [[calendar]] [[utm]] [[attachment_indexation]] [[web_tour]] [[digest]]
...
Organize your job board, promote your job announces and keep track of application
submissions easily. Follow every applicant and build up a database of skills and
profiles with indexed documents.

# Post Your Jobs on Best Job Boards

Connect automatically to most famous job board websites; linkedIn, Monster, Craigslist,
... Every job position has a new email address automatically assigned to route
applications automatically to the right job position.

Whether applicants contact you by email or using an online form, you get all the data
indexed automatically (resumes, motivation letter) and you can answer in just a click,
reusing templates of answers.
...
Get accurate statistics on your recruitment pipeline. Get reports to compare the
performance of your different investments on external job boards.

# Streamline Your Recruitment Process

Follow applicants in your recruitment process with the smart kanban view. Save time by
automating some communications with email templates.

Documents like resumes and motivation letters are indexed automatically, allowing you to
easily find for specific skills and build up a database of profiles.
...
- `Recruitment/Applications/By Job Positions`
- `Recruitment/Applications/By Job Positions`
- `Recruitment/Applications/By Talent Pools`
- `Recruitment/Configuration`
- `Recruitment/Configuration/Activities`
- `Recruitment/Configuration/Activities/Activity Plans`
- `Recruitment/Configuration/Activities/Activity Types`
- `Recruitment/Configuration/Applications`
- `Recruitment/Configuration/Applications/Degrees`
- `Recruitment/Configuration/Applications/Refuse Reasons`
- `Recruitment/Configuration/Applications/Tags`
- `Recruitment/Configuration/Employees`
- `Recruitment/Configuration/Employees/Departments`
- `Recruitment/Configuration/Job Boards`
- `Recruitment/Configuration/Job Boards/Emails`
- `Recruitment/Configuration/Job Positions`
- `Recruitment/Configuration/Job Positions/Employment Types`
- `Recruitment/Configuration/Job Positions/Stages`
- `Recruitment/Configuration/Settings`
- `Recruitment/Configuration/UTMs`
- `Recruitment/Configuration/UTMs/Mediums`
- `Recruitment/Configuration/UTMs/Sources`
...
- `* INHERIT Job (search)`
- `* INHERIT digest.digest.view.form.inherit.hr.recruitment (form)`
- `* INHERIT hr.applicant form (form)`
- `* INHERIT hr.applicant kanban (kanban)`
- `* INHERIT hr.department.kanban.inherit (kanban)`
- `* INHERIT hr.job list (list)`
- `* INHERIT hr.job.form1 (form)`
- `* INHERIT hr.job.search (search)`
- `* INHERIT ir.attachment.search.inherit.recruitment (search)`
- `* INHERIT mail_notification_light_without_background (qweb)`
- `* INHERIT res.config.settings.view.form.inherit.hr.recruitment (form)`
- `Applicant refuse reason form (form)`
- `Applicant refuse reason list (list)`
- `Applicants (list)`
- `Hr Applicants Calendar (calendar)`
- `Hr Applicants kanban (kanban)`
- `Jobs - Recruitment (pivot)`
- `Jobs - Recruitment Form (form)`
- `Jobs - Recruitment Graph (graph)`
- `applicant.get.refuse.reason.form (form)`
- `applicant.send.mail form (form)`
- `applicant_hired_template (qweb)`
- `hr.applicant.activity (activity)`
- `hr.applicant.category.form (form)`
- `hr.applicant.category.list (list)`
- `hr.applicant.form.quick_create (form)`
- `hr.applicant.graph (graph)`
- `hr.applicant.pivot (pivot)`
- `hr.applicant.search (search)`
- `hr.applicant.view.list.activity (list)`
- `hr.applicant.view.search (search)`
- `hr.job.kanban (kanban)`
- `hr.job.platform.form (form)`
- `hr.job.platform.list (list)`
- `hr.job.simple.form (form)`
- `hr.recruitment.degree.form (form)`
- `hr.recruitment.degree.list (list)`
- `hr.recruitment.source.list (list)`
- `hr.recruitment.source.view.search (search)`
- `hr.recruitment.stage.form (form)`
- `hr.recruitment.stage.kanban (kanban)`
- `hr.recruitment.stage.list (list)`
- `hr.talent.pool.view.form (form)`
- `hr.talent.pool.view.kanban (kanban)`
- `hr.talent.pool.view.list (list)`
- `ir.attachment list (list)`
- `job.add.applicants.view.form (form)`
- `talent.pool.add.applicants.view.form (form)`
...
| `create_date`                | Created on              | `datetime`  |     | ✅    |                       |
| `create_uid`                 | Created by              | `many2one`  |     | ✅    | res.users             |
| `description`                | Talent Pool Description | `html`      |     | ✅    |                       |
| `display_name`               | Display Name            | `char`      |     |       |                       |
| `has_message`                | Has Message             | `boolean`   |     |       |                       |
| `id`                         | ID                      | `integer`   |     | ✅    |                       |
| `message_attachment_count`   | Attachment Count        | `integer`   |     |       |                       |
...
| `message_partner_ids`        | Followers (Partners)    | `many2many` |     |       | res.partner           |
| `name`                       | Title                   | `char`      | ✅  | ✅    |                       |
| `no_of_talents`              | # Talents               | `integer`   |     |       |                       |
| `pool_manager`               | Pool Manager            | `many2one`  |     | ✅    | res.users             |
| `rating_ids`                 | Ratings                 | `one2many`  |     | ✅    | rating.rating         |
| `talent_ids`                 | Talent                  | `many2many` |     | ✅    | hr.applicant          |
| `website_message_ids`        | Website Messages        | `one2many`  |     | ✅    | mail.message          |
| `write_date`                 | Last Updated on         | `datetime`  |     | ✅    |                       |
| `write_uid`                  | Last Updated by         | `many2one`  |     | ✅    | res.users             |
...
| Name                       | Group                                        | Perms     |
| -------------------------- | -------------------------------------------- | --------- |
| hr.talent.pool.interviewer | Recruitment / Interviewer                    | `R`       |
| hr.talent.pool.user        | Recruitment / Officer: Manage all applicants | `R/W/C/D` |

**Record Rules:**

- **User: All Talent Pools** (83) `R/W/C/D`
  - Domain: `[(1, '=', 1)]`
...
### 🗃️ `job.add.applicants` — Add applicants to a job
...
| Field           | Label           | Type        | Req | Store | Relation     |
| --------------- | --------------- | ----------- | --- | ----- | ------------ |
| `applicant_ids` | Applications    | `many2many` | ✅  | ✅    | hr.applicant |
| `create_date`   | Created on      | `datetime`  |     | ✅    |              |
| `create_uid`    | Created by      | `many2one`  |     | ✅    | res.users    |
| `display_name`  | Display Name    | `char`      |     |       |              |
| `id`            | ID              | `integer`   |     | ✅    |              |
| `job_ids`       | Job Positions   | `many2many` | ✅  | ✅    | hr.job       |
| `write_date`    | Last Updated on | `datetime`  |     | ✅    |              |
| `write_uid`     | Last Updated by | `many2one`  |     | ✅    | res.users    |
...
| Name                                  | Group                                        | Perms     |
| ------------------------------------- | -------------------------------------------- | --------- |
| access.job.add.applicants.interviewer | Recruitment / Interviewer                    | `-`       |
| access.job.add.applicants             | Recruitment / Officer: Manage all applicants | `R/W/C/D` |

### 🗃️ `talent.pool.add.applicants` — Add applicants to talent pool
...
| Field             | Label           | Type        | Req | Store | Relation              |
| ----------------- | --------------- | ----------- | --- | ----- | --------------------- |
| `applicant_ids`   | Applicants      | `many2many` | ✅  | ✅    | hr.applicant          |
| `categ_ids`       | Tags            | `many2many` |     | ✅    | hr.applicant.category |
| `create_date`     | Created on      | `datetime`  |     | ✅    |                       |
| `create_uid`      | Created by      | `many2one`  |     | ✅    | res.users             |
| `display_name`    | Display Name    | `char`      |     |       |                       |
| `id`              | ID              | `integer`   |     | ✅    |                       |
| `talent_pool_ids` | Talent Pool     | `many2many` |     | ✅    | hr.talent.pool        |
| `write_date`      | Last Updated on | `datetime`  |     | ✅    |                       |
| `write_uid`       | Last Updated by | `many2one`  |     | ✅    | res.users             |
...
| Name                                          | Group                                        | Perms     |
| --------------------------------------------- | -------------------------------------------- | --------- |
| access.talent.pool.add.applicants.interviewer | Recruitment / Interviewer                    | `-`       |
| access.talent.pool.add.applicants             | Recruitment / Officer: Manage all applicants | `R/W/C/D` |

### 🗃️ `hr.recruitment.degree` — Applicant Degree
...
| Name                  | Group                                        | Perms     |
| --------------------- | -------------------------------------------- | --------- |
| hr.recruitment.degree | Recruitment / Officer: Manage all applicants | `R/W/C/D` |
...
### 🗃️ `hr.applicant.category` — Category of applicant
...
| Name                  | Group                                        | Perms     |
| --------------------- | -------------------------------------------- | --------- |
| hr.applicant_category | Recruitment / Officer: Manage all applicants | `R/W/C/D` |
| hr.applicant_category | Role / User                                  | `R/W/C`   |
...
### 🗃️ `applicant.get.refuse.reason` — Get Refuse Reason
...
| Field                            | Label                                    | Type        | Req | Store | Relation                   |
| -------------------------------- | ---------------------------------------- | ----------- | --- | ----- | -------------------------- |
| `applicant_ids`                  | Applicant                                | `many2many` |     | ✅    | hr.applicant               |
| `applicant_without_email`        | Applicant(s) not having email            | `text`      |     |       |                            |
...
| `create_uid`                     | Created by                               | `many2one`  |     | ✅    | res.users                  |
| `display_name`                   | Display Name                             | `char`      |     |       |                            |
| `duplicate_applicant_ids`        | Duplicate Applications                   | `many2many` |     | ✅    | hr.applicant               |
| `duplicate_applicant_ids_domain` | Duplicate Applicant Ids Domain           | `binary`    |     |       |                            |
| `duplicates`                     | Refuse Duplicate Applications            | `boolean`   |     | ✅    |                            |
| `duplicates_count`               | Duplicates Count                         | `integer`   |     |       |                            |
| `id`                             | ID                                       | `integer`   |     | ✅    |                            |
...
| Name                                           | Group                                        | Perms   |
| ---------------------------------------------- | -------------------------------------------- | ------- |
| access.applicant.get.refuse.reason.interviewer | Recruitment / Interviewer                    | `R/W/C` |
| access.applicant.get.refuse.reason             | Recruitment / Officer: Manage all applicants | `R/W/C` |

### 🗃️ `hr.job.platform` — Job Platforms
...
| Name                   | Group                       | Perms     |
| ---------------------- | --------------------------- | --------- |
| access.hr.job.platform | Recruitment / Administrator | `R/W/C/D` |
...
### 🗃️ `hr.recruitment.stage` — Recruitment Stages
...
| `hired_stage`            | Hired Stage         | `boolean`   |     | ✅    |               |
| `id`                     | ID                  | `integer`   |     | ✅    |               |
| `is_warning_visible`     | Is Warning Visible  | `boolean`   |     |       |               |
| `job_ids`                | Job Specific        | `many2many` |     | ✅    | hr.job        |
| `legend_blocked`         | Red Kanban Label    | `char`      | ✅  | ✅    |               |
| `legend_done`            | Green Kanban Label  | `char`      | ✅  | ✅    |               |
| `legend_normal`          | Grey Kanban Label   | `char`      | ✅  | ✅    |               |
| `legend_waiting`         | Orange Kanban Label | `char`      | ✅  | ✅    |               |
...
| Name                             | Group                                        | Perms     |
| -------------------------------- | -------------------------------------------- | --------- |
| hr.recruitment.stage.interviewer | Recruitment / Interviewer                    | `R`       |
| hr.recruitment.stage.user        | Recruitment / Officer: Manage all applicants | `R`       |
| hr.recruitment.stage.manager     | Recruitment / Administrator                  | `R/W/C/D` |

### 🗃️ `hr.applicant.refuse.reason` — Refuse Reason of Applicant
...
| Name                                   | Group                                        | Perms     |
| -------------------------------------- | -------------------------------------------- | --------- |
| hr.applicant.refuse.reason.interviewer | Recruitment / Interviewer                    | `R`       |
| hr.applicant.refuse.reason             | Recruitment / Officer: Manage all applicants | `R/W/C/D` |

### 🗃️ `applicant.send.mail` — Send mails to applicants
...
| Name                                   | Group                                        | Perms   |
| -------------------------------------- | -------------------------------------------- | ------- |
| access.applicant.send.mail.interviewer | Recruitment / Interviewer                    | `R/W/C` |
| access.applicant.send.mail             | Recruitment / Officer: Manage all applicants | `R/W/C` |
