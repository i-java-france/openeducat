...
> **Module:** `dms` | **Version:** `19.0.1.0` **Category:** Education | **License:**
> `Other proprietary` **Author:** OpenEduCat Inc **Website:** https://www.openeducat.org

## 🔗 Dependencies

[[mail]] [[http_routing]] [[portal]] [[onboarding]]
...
- `Documents/Configuration/General Settings`
- `Documents/Configuration/Organizing`
- `Documents/Configuration/Organizing/Categories`
- `Documents/Configuration/Organizing/Tags`
- `Documents/Configuration/System`
- `Documents/Configuration/System/Access Groups`
- `Documents/Configuration/System/Migration`
- `Documents/Configuration/System/Storages`
- `Documents/Directories`
- `Documents/Files`

### Views

- `* INHERIT My DMS: Breadcrumbs (qweb)`
- `* INHERIT Show DMS (qweb)`
- `* INHERIT dms_directory.form (form)`
- `* INHERIT dms_directory.form (form)`
- `* INHERIT dms_file.form (form)`
- `* INHERIT dms_file.form (form)`
- `* INHERIT dms_storage.form (form)`
- `* INHERIT ir.attachment form (form)`
- `* INHERIT res.config.settings.view.form.inherit.dms (form)`
- `My DMS (qweb)`
- `dms_access.group.form (form)`
- `dms_access_groups.tree (list)`
- `dms_category.form (form)`
- `dms_category.search (search)`
- `dms_category.tree (list)`
- `dms_directory.form (form)`
- `dms_directory.kanban (kanban)`
- `dms_directory.search (search)`
- `dms_directory.tree (list)`
- `dms_file.form (form)`
- `dms_file.graph (graph)`
- `dms_file.kanban (kanban)`
- `dms_file.pivot (pivot)`
- `dms_file.search (search)`
- `dms_file.search (search)`
- `dms_file.tree (list)`
- `dms_file.tree (list)`
- `dms_storage.form (form)`
- `dms_storage.search (search)`
- `dms_storage.tree (list)`
- `dms_tag.form (form)`
- `dms_tag.kanban (kanban)`
- `dms_tag.search (search)`
- `dms_tag.tree (list)`
...
| `alias_process`                                | Unpack Emails as                        | `selection` | ✅  | ✅    |                    |
| `alias_status`                                 | Alias Status                            | `selection` |     |       |                    |
| `allowed_model_ids`                            | Linked Models                           | `many2many` |     |       | ir.model           |
| `category_id`                                  | Category                                | `many2one`  |     | ✅    | dms.category       |
| `child_directory_ids`                          | Subdirectories                          | `one2many`  |     | ✅    | dms.directory      |
| `color`                                        | Color                                   | `integer`   |     | ✅    |                    |
| `company_id`                                   | Company                                 | `many2one`  |     | ✅    | res.company        |
| `complete_group_ids`                           | Complete Groups                         | `many2many` |     | ✅    | dms.access.group   |
| `complete_name`                                | Complete Name                           | `char`      |     | ✅    |                    |
| `count_directories`                            | Count Subdirectories Title              | `integer`   |     |       |                    |
| `count_directories_title`                      | Count Subdirectories                    | `char`      |     |       |                    |
| `count_elements`                               | Count Elements                          | `integer`   |     |       |                    |
| `count_files`                                  | Count Files Title                       | `integer`   |     |       |                    |
| `count_files_title`                            | Count Files                             | `char`      |     |       |                    |
| `count_total_directories`                      | Total Subdirectories                    | `integer`   |     |       |                    |
| `count_total_elements`                         | Total Elements                          | `integer`   |     |       |                    |
| `count_total_files`                            | Total Files                             | `integer`   |     |       |                    |
| `create_date`                                  | Created on                              | `datetime`  |     | ✅    |                    |
| `create_uid`                                   | Created by                              | `many2one`  |     | ✅    | res.users          |
| `display_name`                                 | Display Name                            | `char`      |     |       |                    |
| `field_id`                                     | Folder Name                             | `many2one`  |     | ✅    | ir.model.fields    |
| `file_ids`                                     | Files                                   | `one2many`  |     | ✅    | dms.file           |
| `group_ids`                                    | Groups                                  | `many2many` |     | ✅    | dms.access.group   |
| `has_message`                                  | Has Message                             | `boolean`   |     |       |                    |
| `icon_url`                                     | Icon URL                                | `char`      |     |       |                    |
| `id`                                           | ID                                      | `integer`   |     | ✅    |                    |
...
| `inherit_group_ids`                            | Inherit Groups                          | `boolean`   |     | ✅    |                    |
| `is_hidden`                                    | Storage is Hidden                       | `boolean`   |     | ✅    |                    |
| `is_root_directory`                            | Is Root Directory                       | `boolean`   |     | ✅    |                    |
...
| `name`                                         | Name                                    | `char`      | ✅  | ✅    |                    |
| `parent_id`                                    | Parent Directory                        | `many2one`  |     | ✅    | dms.directory      |
| `parent_path`                                  | Parent Path                             | `char`      |     | ✅    |                    |
| `permission_create`                            | Create Access                           | `boolean`   |     |       |                    |
| `permission_read`                              | Read Access                             | `boolean`   |     |       |                    |
| `permission_unlink`                            | Delete Access                           | `boolean`   |     |       |                    |
| `permission_write`                             | Write Access                            | `boolean`   |     |       |                    |
| `rating_ids`                                   | Ratings                                 | `one2many`  |     | ✅    | rating.rating      |
| `record_ref`                                   | Record Referenced                       | `reference` |     |       |                    |
| `res_id`                                       | Linked attachments record ID            | `integer`   |     | ✅    |                    |
| `res_model`                                    | Linked attachments model                | `char`      |     | ✅    |                    |
| `size`                                         | Size                                    | `float`     |     |       |                    |
| `starred`                                      | Starred                                 | `boolean`   |     |       |                    |
| `storage_id`                                   | Storage                                 | `many2one`  |     | ✅    | dms.storage        |
| `storage_id_inherit_access_from_parent_record` | Inherit permissions from related record | `boolean`   |     | ✅    |                    |
| `storage_id_save_type`                         | Save Type                               | `selection` |     |       |                    |
| `tag_ids`                                      | Tags                                    | `many2many` |     | ✅    | dms.tag            |
| `user_id`                                      | Assigned to                             | `many2one`  |     | ✅    | res.users          |
| `user_star_ids`                                | Stars                                   | `many2many` |     | ✅    | res.users          |
...
| Name                    | Group                | Perms     |
| ----------------------- | -------------------- | --------- |
| dms_directory_user      | DMS Privilege / User | `R/W/C/D` |
| dms_directory_portal    | Role / Portal        | `R`       |
| dms_directory_public    | Role / Public        | `R`       |
| dms_directory_base_user | Role / User          | `R`       |

**Record Rules:**

- **DMS Directory multi-company** (Global) `R/W/C/D`
  - Domain: `['|',('company_id','=',False),('company_id','in',company_ids)]     `
- **Apply computed create permissions.** (30) `C`
  - Domain: `[('permission_create', '=', True)]`
- **Apply computed read permissions.** (30) `R`
  - Domain: `[('permission_read', '=', True)]`
- **Apply computed unlink permissions.** (30) `D`
  - Domain: `[('permission_unlink', '=', True)]`
- **Apply computed write permissions.** (30) `W`
  - Domain: `[('permission_write', '=', True)]`
- **Directory group restriction** (Global) `R/W/C/D`
  - Domain:
    `[         '|',         ('group_ids.users', 'in', user.id),         ('group_ids', '=', False),         ]`
...
| `activity_type_id`              | Next Activity Type            | `many2one`  |     |       | mail.activity.type |
| `activity_user_id`              | Responsible User              | `many2one`  |     |       | res.users          |
| `attachment_id`                 | Attachment File               | `many2one`  |     | ✅    | ir.attachment      |
| `category_id`                   | Category                      | `many2one`  |     | ✅    | dms.category       |
| `checksum`                      | Checksum/SHA1                 | `char`      |     | ✅    |                    |
| `color`                         | Color                         | `integer`   |     | ✅    |                    |
| `company_id`                    | Company                       | `many2one`  |     | ✅    | res.company        |
| `content`                       | Content                       | `binary`    | ✅  |       |                    |
| `content_binary`                | Content Binary                | `binary`    |     | ✅    |                    |
| `content_file`                  | Content File                  | `binary`    |     | ✅    |                    |
| `create_date`                   | Created on                    | `datetime`  |     | ✅    |                    |
| `create_uid`                    | Created by                    | `many2one`  |     | ✅    | res.users          |
| `directory_id`                  | Directory                     | `many2one`  | ✅  | ✅    | dms.directory      |
| `display_name`                  | Display Name                  | `char`      |     |       |                    |
...
| `image_512`                     | Image 512                     | `binary`    |     | ✅    |                    |
| `is_hidden`                     | Storage is Hidden             | `boolean`   |     | ✅    |                    |
| `is_locked`                     | Locked                        | `boolean`   |     |       |                    |
| `is_lock_editor`                | Editor                        | `boolean`   |     |       |                    |
| `locked_by`                     | Locked By                     | `many2one`  |     | ✅    | res.users          |
| `message_attachment_count`      | Attachment Count              | `integer`   |     |       |                    |
| `message_follower_ids`          | Followers                     | `one2many`  |     | ✅    | mail.followers     |
| `message_has_error`             | Message Delivery error        | `boolean`   |     |       |                    |
| `message_has_error_counter`     | Number of errors              | `integer`   |     |       |                    |
...
| `message_needaction_counter`    | Number of Actions             | `integer`   |     |       |                    |
| `message_partner_ids`           | Followers (Partners)          | `many2many` |     |       | res.partner        |
| `migration`                     | Migration Status              | `char`      |     |       |                    |
| `mimetype`                      | Type                          | `char`      |     | ✅    |                    |
| `my_activity_date_deadline`     | My Activity Deadline          | `date`      |     |       |                    |
| `name`                          | Name                          | `char`      | ✅  | ✅    |                    |
| `path_json`                     | Path Json                     | `text`      |     |       |                    |
| `path_names`                    | Path Names                    | `char`      |     |       |                    |
| `permission_create`             | Create Access                 | `boolean`   |     |       |                    |
| `permission_read`               | Read Access                   | `boolean`   |     |       |                    |
| `permission_unlink`             | Delete Access                 | `boolean`   |     |       |                    |
| `permission_write`              | Write Access                  | `boolean`   |     |       |                    |
| `rating_ids`                    | Ratings                       | `one2many`  |     | ✅    | rating.rating      |
| `record_ref`                    | Record Referenced             | `reference` |     |       |                    |
| `require_migration`             | Require Migration             | `boolean`   |     | ✅    |                    |
| `res_id`                        | Linked attachments record ID  | `integer`   |     | ✅    |                    |
| `res_model`                     | Linked attachments model      | `char`      |     | ✅    |                    |
| `save_type`                     | Current Save Type             | `char`      |     |       |                    |
| `size`                          | Size                          | `float`     |     | ✅    |                    |
| `storage_id`                    | Storage                       | `many2one`  |     | ✅    | dms.storage        |
| `storage_id_save_type`          | Save Type                     | `selection` |     |       |                    |
| `tag_ids`                       | Tags                          | `many2many` |     | ✅    | dms.tag            |
...
| Name               | Group                | Perms     |
| ------------------ | -------------------- | --------- |
| dms_file_user      | DMS Privilege / User | `R/W/C/D` |
| dms_file_portal    | Role / Portal        | `R`       |
| dms_file_public    | Role / Public        | `R`       |
| dms_file_base_user | Role / User          | `R`       |

**Record Rules:**

- **File multi-company** (Global) `R/W/C/D`
  - Domain: `['|',('company_id','=',False),('company_id','in',company_ids)]     `
- **Locked files are only modified by locker user.** (1) `W/C/D`
  - Domain: `['|', ('locked_by', '=', False), ('locked_by', '=', user.id)]     `
- **Apply computed create permissions.** (30) `C`
  - Domain: `[('permission_create', '=', True)]`
- **Apply computed read permissions.** (30) `R`
  - Domain: `[('permission_read', '=', True)]`
...
- **Apply computed write permissions.** (30) `W`
  - Domain: `[('permission_write', '=', True)]`
- **Restrict files by directory group** (Global) `R/W/C/D`
  - Domain:
    `[         '|',         ('directory_id.group_ids.users', 'in', [user.id]),         ('directory_id.group_ids', '=', False),     ]`

### 🗃️ `abstract.dms.mixin` — Abstract Dms Mixin
...
### 🗃️ `dms.security.mixin` — DMS Security Mixin
...
### 🗃️ `dms.mixins.thumbnail` — DMS thumbnail and icon mixin
...
### 🗃️ `dms.category` — Document Category
...
| `child_category_ids` | Child Categories    | `one2many` |     | ✅    | dms.category  |
| `complete_name`      | Complete Name       | `char`     |     | ✅    |               |
| `count_categories`   | Count Subcategories | `integer`  |     |       |               |
| `count_directories`  | Count Directories   | `integer`  |     |       |               |
| `count_files`        | Count Files         | `integer`  |     |       |               |
| `count_tags`         | Count Tags          | `integer`  |     |       |               |
| `create_date`        | Created on          | `datetime` |     | ✅    |               |
| `create_uid`         | Created by          | `many2one` |     | ✅    | res.users     |
| `directory_ids`      | Directories         | `one2many` |     | ✅    | dms.directory |
| `display_name`       | Display Name        | `char`     |     |       |               |
| `file_ids`           | Files               | `one2many` |     | ✅    | dms.file      |
| `id`                 | ID                  | `integer`  |     | ✅    |               |
| `name`               | Name                | `char`     | ✅  | ✅    |               |
| `parent_id`          | Parent Category     | `many2one` |     | ✅    | dms.category  |
| `parent_path`        | Parent Path         | `char`     |     | ✅    |               |
| `tag_ids`            | Tags                | `one2many` |     | ✅    | dms.tag       |
| `write_date`         | Last Updated on     | `datetime` |     | ✅    |               |
| `write_uid`          | Last Updated by     | `many2one` |     | ✅    | res.users     |
...
| Name              | Group                | Perms     |
| ----------------- | -------------------- | --------- |
| dms_category_user | DMS Privilege / User | `R/W/C/D` |

### 🗃️ `dms.tag` — Document Tag
...
| `create_date`       | Created on        | `datetime`  |     | ✅    |               |
| `create_uid`        | Created by        | `many2one`  |     | ✅    | res.users     |
| `directory_ids`     | Directories       | `many2many` |     | ✅    | dms.directory |
| `display_name`      | Display Name      | `char`      |     |       |               |
| `file_ids`          | Files             | `many2many` |     | ✅    | dms.file      |
| `id`                | ID                | `integer`   |     | ✅    |               |
| `name`              | Name              | `char`      | ✅  | ✅    |               |
| `write_date`        | Last Updated on   | `datetime`  |     | ✅    |               |
| `write_uid`         | Last Updated by   | `many2one`  |     | ✅    | res.users     |
...
| Name         | Group                | Perms     |
| ------------ | -------------------- | --------- |
| dms_tag_user | DMS Privilege / User | `R/W/C/D` |
...
### 🗃️ `dms.access.group` — Record Access Groups
...
| Field                    | Label                   | Type        | Req | Store | Relation         |
| ------------------------ | ----------------------- | ----------- | --- | ----- | ---------------- |
| `child_group_ids`        | Child Groups            | `one2many`  |     | ✅    | dms.access.group |
| `complete_directory_ids` | Complete directories    | `many2many` |     | ✅    | dms.directory    |
| `count_directories`      | Count Directories       | `integer`   |     |       |                  |
| `count_users`            | Count Users             | `integer`   |     | ✅    |                  |
| `create_date`            | Created on              | `datetime`  |     | ✅    |                  |
| `create_uid`             | Created by              | `many2one`  |     | ✅    | res.users        |
| `directory_ids`          | Directories             | `many2many` |     | ✅    | dms.directory    |
| `display_name`           | Display Name            | `char`      |     |       |                  |
| `explicit_user_ids`      | Explicit Users          | `many2many` |     | ✅    | res.users        |
| `group_ids`              | Groups                  | `many2many` |     | ✅    | res.groups       |
| `id`                     | ID                      | `integer`   |     | ✅    |                  |
| `name`                   | Group Name              | `char`      | ✅  | ✅    |                  |
| `parent_group_id`        | Parent Group            | `many2one`  |     | ✅    | dms.access.group |
| `parent_path`            | Parent Path             | `char`      |     | ✅    |                  |
| `perm_create`            | Create Access           | `boolean`   |     | ✅    |                  |
| `perm_inclusive_create`  | Inherited Create Access | `boolean`   |     | ✅    |                  |
| `perm_inclusive_unlink`  | Inherited Unlink Access | `boolean`   |     | ✅    |                  |
| `perm_inclusive_write`   | Inherited Write Access  | `boolean`   |     | ✅    |                  |
| `perm_unlink`            | Unlink Access           | `boolean`   |     | ✅    |                  |
| `perm_write`             | Write Access            | `boolean`   |     | ✅    |                  |
| `users`                  | Group Users             | `many2many` |     | ✅    | res.users        |
| `write_date`             | Last Updated on         | `datetime`  |     | ✅    |                  |
| `write_uid`              | Last Updated by         | `many2one`  |     | ✅    | res.users        |
...
| Name                               | Group         | Perms     |
| ---------------------------------- | ------------- | --------- |
| access_dms_access_group_portal     | Role / Portal | `R`       |
| access_dms_access_group_public     | Role / Public | `R`       |
| access_security_access_groups_user | Role / User   | `R/W/C/D` |

**Record Rules:**

- **User can only edit and delete their own groups.** (1) `W/D`
  - Domain: `[('create_uid','=',user.id)]`
- **Admins can edit and delete all groups.** (2) `W/D`
  - Domain: `[(1 ,'=', 1)]`

### 🗃️ `dms.storage` — Storage
...
| ----------------------------------- | --------------------------------------- | ----------- | --- | ----- | ------------- |
| `company_id`                        | Company                                 | `many2one`  |     | ✅    | res.company   |
| `count_storage_directories`         | Count Directories                       | `integer`   |     |       |               |
| `count_storage_files`               | Count Files                             | `integer`   |     |       |               |
| `create_date`                       | Created on                              | `datetime`  |     | ✅    |               |
| `create_uid`                        | Created by                              | `many2one`  |     | ✅    | res.users     |
| `display_name`                      | Display Name                            | `char`      |     |       |               |
| `id`                                | ID                                      | `integer`   |     | ✅    |               |
| `include_message_attachments`       | Create files from message attachments   | `boolean`   |     | ✅    |               |
| `inherit_access_from_parent_record` | Inherit permissions from related record | `boolean`   |     | ✅    |               |
| `is_hidden`                         | Storage is Hidden                       | `boolean`   |     | ✅    |               |
| `model_ids`                         | Linked Models                           | `many2many` |     | ✅    | ir.model      |
| `name`                              | Name                                    | `char`      | ✅  | ✅    |               |
| `root_directory_ids`                | Root Directories                        | `one2many`  |     | ✅    | dms.directory |
| `save_type`                         | Save Type                               | `selection` | ✅  | ✅    |               |
| `storage_directory_ids`             | Directories                             | `one2many`  |     | ✅    | dms.directory |
| `storage_file_ids`                  | Files                                   | `one2many`  |     | ✅    | dms.file      |
| `write_date`                        | Last Updated on                         | `datetime`  |     | ✅    |               |
| `write_uid`                         | Last Updated by                         | `many2one`  |     | ✅    | res.users     |
...
| Name                | Group                   | Perms     |
| ------------------- | ----------------------- | --------- |
| dms_storage_manager | DMS Privilege / Manager | `R/W/C/D` |
| dms_storage_user    | DMS Privilege / User    | `R`       |
| dms_storage_portal  | Role / Portal           | `R`       |

**Record Rules:**

- **DMS Storage multi-company** (Global) `R/W/C/D`
  - Domain: `['|',('company_id','=',False),('company_id','in',company_ids)]     `
- **Basic users cannot access hidden storage** (30, 10) `R/W/C/D`
  - Domain: `[('is_hidden', '=', False)]`
- **Managers can access hidden storage** (31) `R/W/C/D`
  - Domain: `[('is_hidden', '=', True)]`
