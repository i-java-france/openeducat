...
> **Module:** `openeducat_parent` | **Version:** `19.0.1.0` **Category:** Education |
...
![](/openeducat_parent/static/description/students-icon.svg)
...
![](/openeducat_parent/static/description/faculties-icon.svg)
...
![](/openeducat_parent/static/description/courses-icon%201.svg)
...
![](/openeducat_parent/static/description/openeducat_admission.svg)
...
![](/openeducat_parent/static/description/openeducat_exam.svg)
...
![](/openeducat_parent/static/description/openeducat_account_financial_reports.svg)
...
![](/openeducat_parent/static/description/openeducat_attendance.svg)
...
![](/openeducat_parent/static/description/openeducat_library.svg)
...
![](/openeducat_parent/static/description/lms-icon.svg)
...
![](/openeducat_parent/static/description/openeducat_classroom.svg)
...
![Icon](/openeducat_parent/static/description/openeducat_assignment.svg)

Assignment Allocation

![Icon](/openeducat_parent/static/description/openeducat_exam.svg)

Exam Management

![Icon](/openeducat_parent/static/description/fees.svg)

Fees Management

![](/openeducat_parent/static/description/inventory.svg)

Inventory Management

![Icon](/openeducat_parent/static/description/campus-icon.svg)

Campus Management

![Icon](/openeducat_parent/static/description/notice-board-icon.svg)

Notice Board Enterprise

![Icon](/openeducat_parent/static/description/grade-book-icon.svg)

Gradebook Management Enterprise

![Icon](/openeducat_parent/static/description/assignment-annotation-icon.png)

Assignment Annotation Enterprise

![Icon](/openeducat_parent/static/description/openeducat_alumni_enterprise.svg)

Alumni Management Enterprise

![Icon](/openeducat_parent/static/description/transportation-icon.svg)

Transpotation Management Enterprise

![Icon](/openeducat_parent/static/description/kpi-dashboard-icon.svg)

KPI Dashboards Enterprise

![](/openeducat_parent/static/description/news.svg)
...
![](/openeducat_parent/static/description/g2-img.svg)

![](/openeducat_parent/static/description/sourceforge-img.svg)
...
- `SIS/Configuration/Parents`
- `SIS/Configuration/Parents/Relationships`
- `SIS/Parents`

### Views

- `* INHERIT op.student.form (form)`
- `* INHERIT report_student_bonafide_parent (qweb)`
- `op.parent.form (form)`
- `op.parent.list (list)`
- `op.parent.relationship.form (form)`
- `op.parent.relationship.list (list)`
...
### 🗃️ `op.parent.relationship` — Relationships
...
| Name                                          | Group            | Perms     |
| --------------------------------------------- | ---------------- | --------- |
| name_op_parent_relationship_back_office_admin | Parent / Manager | `R/W/C/D` |
