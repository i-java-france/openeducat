---
title: "Phone Numbers Validation"
...
> **Module:** `phone_validation` | **Version:** `19.0.2.1` **Category:** Technical |
...
This module adds the feature of validation and formatting phone numbers according to a
destination country.

It also adds phone blacklist management through a specific model storing blacklisted
phone numbers.

It adds mail.thread.phone mixin that handles sanitation and blacklist of records
numbers.
...
- `Settings/Technical/Phone / SMS`
- `Settings/Technical/Phone / SMS/Phone Blacklist`

### Views

- `* INHERIT res.partner.view.search.inherit.phone.validation (search)`
- `phone.blacklist.remove.form (form)`
- `phone.blacklist.view.form (form)`
- `phone.blacklist.view.list (list)`
...
### 🗃️ `phone.blacklist` — Phone Blacklist
...
| Name                          | Group                | Perms     |
| ----------------------------- | -------------------- | --------- |
| access.phone.blacklist.system | Role / Administrator | `R/W/C/D` |
| access.phone.blacklist.all    | Everyone             | `-`       |

### 🗃️ `mail.thread.phone` — Phone Blacklist Mixin
...
### 🗃️ `phone.blacklist.remove` — Remove phone from blacklist
...
| Name                                 | Group                | Perms     |
| ------------------------------------ | -------------------- | --------- |
| acesss.phone.blacklist.remove.system | Role / Administrator | `R/W/C/D` |
