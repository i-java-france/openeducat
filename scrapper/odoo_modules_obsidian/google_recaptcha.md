...
> **Module:** `google_recaptcha` | **Version:** `19.0.1.0` **Category:** Technical |
...
This module implements reCaptchaV3 so that you can prevent bot spam on your public
modules.
...
- `* INHERIT res.config.settings.view.form.inherit.web.recaptcha (form)`
