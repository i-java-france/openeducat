...
> **Module:** `digest` | **Version:** `19.0.1.1` **Category:** Marketing | **License:**
...
| `create_uid`      | Created by       | `many2one`  |     | ✅    | res.users  |
| `display_name`    | Display Name     | `char`      |     |       |            |
| `group_id`        | Authorized Group | `many2one`  |     | ✅    | res.groups |
| `id`              | ID               | `integer`   |     | ✅    |            |
| `name`            | Name             | `char`      |     | ✅    |            |
| `sequence`        | Sequence         | `integer`   |     | ✅    |            |
| `tip_description` | Tip description  | `html`      |     | ✅    |            |
| `user_ids`        | Recipients       | `many2many` |     | ✅    | res.users  |
| `write_date`      | Last Updated on  | `datetime`  |     | ✅    |            |
| `write_uid`       | Last Updated by  | `many2one`  |     | ✅    | res.users  |
...
| Name                      | Group         | Perms     |
| ------------------------- | ------------- | --------- |
| digest.tip.administration | Access Rights | `R/W/C/D` |
| digest.tip.user           | Role / User   | `R`       |
