...
> **Module:** `payment_demo` | **Version:** `19.0.2.0` **Category:** Accounting |
...
- `* INHERIT Demo Provider Form (form)`
- `* INHERIT Demo Token Form (form)`
- `* INHERIT Demo Transaction Form (form)`
- `express_checkout_form (qweb)`
- `express_inline_form (qweb)`
- `inline_form (qweb)`
- `payment_details (qweb)`
- `token_inline_form (qweb)`
