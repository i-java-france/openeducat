...
application: false
auto_install: false
tags: [odoo/module, odoo/state/installed, odoo/category/________________]
---

# 🟢 Social Media

> **Module:** `social_media` | **Version:** `19.0.0.1` **Category:** Social Marketing |
...
The purpose of this technical module is to provide a front for social media
configuration for any other module that might need it.
...
- `* INHERIT res.company.form.inherit.social.media (form)`
