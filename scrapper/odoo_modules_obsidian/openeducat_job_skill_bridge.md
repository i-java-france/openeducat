---
title: "OpenEduCat Job Skill Bridge"
module: "openeducat_job_skill_bridge"
state: "installed"
version: "19.0.1.0"
...
# 🟢 OpenEduCat Job Skill Bridge

> **Module:** `openeducat_job_skill_bridge` | **Version:** `19.0.1.0` **Category:**
> Education | **License:** `Other proprietary` **Author:** OpenEduCat Inc **Website:**
> https://www.openeducat.org

## 🔗 Dependencies

[[openeducat_core_enterprise]] [[openeducat_placement_job_enterprise]]
...
- `* INHERIT Portal layout : Add Student Skill (qweb)`
- `* INHERIT op.form.jobpost.form (form)`
- `* INHERIT op.form.jobpost.list (list)`
- `* INHERIT skill.smart.buttons (form)`
- `* INHERIT student_portal_student_skill_bridge (qweb)`
- `enterprise_add_student_skill_portal (qweb)`
- `op.skill.line.form (form)`
- `op.skill.line.list (list)`
...
### 🗃️ `op.skill.line` — Skill Lines Creation Creation
...
| `display_name`  | Display Name    | `char`     |     |       |                             |
| `id`            | ID              | `integer`  |     | ✅    |                             |
| `level_id`      | Level           | `many2one` |     | ✅    | op.student.skill.level.name |
| `progress`      | Progress        | `integer`  |     |       |                             |
| `skill_type_id` | Skill           | `many2one` | ✅  | ✅    | op.student.skill.name       |
...
| Name                         | Group           | Perms     |
| ---------------------------- | --------------- | --------- |
| access_op_skill_line_manager | Skill / Manager | `R/W/C/D` |
| access_op_skill_line_user    | Skill / User    | `R/W/C`   |
